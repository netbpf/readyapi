...
* 📝 Update includes in `docs/en/docs/advanced/additional-status-codes.md`. PR [#12577](https://github.com/readyapi/readyapi/pull/12577) by [@krishnamadhavan](https://github.com/krishnamadhavan).
...
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/header-param-models.md`. PR [#12437](https://github.com/readyapi/readyapi/pull/12437) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
...
* ⬆ [pre-commit.ci] pre-commit autoupdate. PR [#12253](https://github.com/readyapi/readyapi/pull/12253) by [@pre-commit-ci[bot]](https://github.com/apps/pre-commit-ci).
...
Read the new docs: [Query Parameter Models](https://readyapi.github.io/tutorial/query-param-models/).
...
Read the new docs: [Header Parameter Models](https://readyapi.github.io/tutorial/header-param-models/).
...
Read the new docs: [Cookie Parameter Models](https://readyapi.github.io/tutorial/cookie-param-models/).
...
* [Forbid Extra Query Parameters](https://readyapi.github.io/tutorial/query-param-models/#forbid-extra-query-parameters)
* [Forbid Extra Headers](https://readyapi.github.io/tutorial/header-param-models/#forbid-extra-headers)
* [Forbid Extra Cookies](https://readyapi.github.io/tutorial/cookie-param-models/#forbid-extra-cookies)
...
Read the new docs: [Form Models - Forbid Extra Form Fields](https://readyapi.github.io/tutorial/request-form-models/#forbid-extra-form-fields).
...
Read the new docs: [Form Models](https://readyapi.github.io/tutorial/request-form-models/).
...
* ⬆ Bump pypa/gh-action-pypi-publish from 1.9.0 to 1.10.0. PR [#12112](https://github.com/readyapi/readyapi/pull/12112) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 🔧 Update sponsors link: Coherence. PR [#12097](https://github.com/readyapi/readyapi/pull/12097) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update labeler config to handle sponsorships data. PR [#12096](https://github.com/readyapi/readyapi/pull/12096) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, remove Kong. PR [#12085](https://github.com/readyapi/readyapi/pull/12085) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆ [pre-commit.ci] pre-commit autoupdate. PR [#12076](https://github.com/readyapi/readyapi/pull/12076) by [@pre-commit-ci[bot]](https://github.com/apps/pre-commit-ci).
* 👷 Update `latest-changes` GitHub Action. PR [#12073](https://github.com/readyapi/readyapi/pull/12073) by [@khulnasoft](https://github.com/khulnasoft).

## 0.112.2

### Fixes

* 🐛 Fix `allow_inf_nan` option for Param and Body classes. PR [#11867](https://github.com/readyapi/readyapi/pull/11867) by [@giunio-prc](https://github.com/giunio-prc).
* 🐛 Ensure that `app.include_router` merges nested lifespans. PR [#9630](https://github.com/readyapi/readyapi/pull/9630) by [@Lancetnik](https://github.com/Lancetnik).
...
* 📝 Fix a typo in `docs/en/docs/virtual-environments.md`. PR [#12064](https://github.com/readyapi/readyapi/pull/12064) by [@aymenkrifa](https://github.com/aymenkrifa).
* 📝 Add docs about Environment Variables and Virtual Environments. PR [#12054](https://github.com/readyapi/readyapi/pull/12054) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Add Asyncer mention in async docs. PR [#12037](https://github.com/readyapi/readyapi/pull/12037) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Move the Features docs to the top level to improve the main page menu. PR [#12036](https://github.com/readyapi/readyapi/pull/12036) by [@khulnasoft](https://github.com/khulnasoft).
* ✏️ Fix import typo in reference example for `Security`. PR [#11168](https://github.com/readyapi/readyapi/pull/11168) by [@0shah0](https://github.com/0shah0).
* 📝 Highlight correct line in tutorial `docs/en/docs/tutorial/body-multiple-params.md`. PR [#11978](https://github.com/readyapi/readyapi/pull/11978) by [@svlandeg](https://github.com/svlandeg).
* 🔥 Remove Sentry link from Advanced Middleware docs. PR [#12031](https://github.com/readyapi/readyapi/pull/12031) by [@alejsdev](https://github.com/alejsdev).
* 📝 Clarify management tasks for translations, multiples files in one PR. PR [#12030](https://github.com/readyapi/readyapi/pull/12030) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Edit the link to the OpenAPI "Responses Object" and "Response Object" sections in the "Additional Responses in OpenAPI" section. PR [#11996](https://github.com/readyapi/readyapi/pull/11996) by [@VaitoSoi](https://github.com/VaitoSoi).
* 🔨 Specify `email-validator` dependency with dash. PR [#11515](https://github.com/readyapi/readyapi/pull/11515) by [@jirikuncar](https://github.com/jirikuncar).
* 🌐 Add Spanish translation for `docs/es/docs/project-generation.md`. PR [#11947](https://github.com/readyapi/readyapi/pull/11947) by [@alejsdev](https://github.com/alejsdev).
* 📝 Fix minor typo. PR [#12026](https://github.com/readyapi/readyapi/pull/12026) by [@MicaelJarniac](https://github.com/MicaelJarniac).
* 📝 Several docs improvements, tweaks, and clarifications. PR [#11390](https://github.com/readyapi/readyapi/pull/11390) by [@nilslindemann](https://github.com/nilslindemann).
* 📝 Add missing `compresslevel` parameter on docs for `GZipMiddleware`. PR [#11350](https://github.com/readyapi/readyapi/pull/11350) by [@junah201](https://github.com/junah201).
* 📝 Fix inconsistent response code when item already exists in docs for testing. PR [#11818](https://github.com/readyapi/readyapi/pull/11818) by [@lokomilo](https://github.com/lokomilo).
* 📝 Update `docs/en/docs/tutorial/body.md` with Python 3.10 union type example. PR [#11415](https://github.com/readyapi/readyapi/pull/11415) by [@rangzen](https://github.com/rangzen).

### Translations

* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/request_file.md`. PR [#12018](https://github.com/readyapi/readyapi/pull/12018) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
...
* ⬆ [pre-commit.ci] pre-commit autoupdate. PR [#12046](https://github.com/readyapi/readyapi/pull/12046) by [@pre-commit-ci[bot]](https://github.com/apps/pre-commit-ci).
* 🔧 Update coverage config files. PR [#12035](https://github.com/readyapi/readyapi/pull/12035) by [@khulnasoft](https://github.com/khulnasoft).
* 🔨 Standardize shebang across shell scripts. PR [#11942](https://github.com/readyapi/readyapi/pull/11942) by [@gitworkflows](https://github.com/gitworkflows).
* ⬆ Update sqlalchemy requirement from <1.4.43,>=1.3.18 to >=1.3.18,<2.0.33. PR [#11979](https://github.com/readyapi/readyapi/pull/11979) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 🔊 Remove old ignore warnings. PR [#11950](https://github.com/readyapi/readyapi/pull/11950) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Upgrade griffe-typingdoc for the docs. PR [#12029](https://github.com/readyapi/readyapi/pull/12029) by [@khulnasoft](https://github.com/khulnasoft).
* 🙈 Add .coverage* to `.gitignore`. PR [#11940](https://github.com/readyapi/readyapi/pull/11940) by [@gitworkflows](https://github.com/gitworkflows).
* ⚙️ Record and show test coverage contexts (what test covers which line). PR [#11518](https://github.com/readyapi/readyapi/pull/11518) by [@slafs](https://github.com/slafs).

## 0.112.1

### Upgrades

* ⬆️ Allow Starlette 0.38.x, update the pin to `>=0.37.2,<0.39.0`. PR [#11876](https://github.com/readyapi/readyapi/pull/11876) by [@musicinmybrain](https://github.com/musicinmybrain).

### Docs

* 📝 Update docs section about "Don't Translate these Pages". PR [#12022](https://github.com/readyapi/readyapi/pull/12022) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Add documentation for non-translated pages and scripts to verify them. PR [#12020](https://github.com/readyapi/readyapi/pull/12020) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Update docs about discussions questions. PR [#11985](https://github.com/readyapi/readyapi/pull/11985) by [@khulnasoft](https://github.com/khulnasoft).

### Translations

* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/bigger-applications.md`. PR [#11971](https://github.com/readyapi/readyapi/pull/11971) by [@marcelomarkus](https://github.com/marcelomarkus).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/testing-websockets.md`. PR [#11994](https://github.com/readyapi/readyapi/pull/11994) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/testing-dependencies.md`. PR [#11995](https://github.com/readyapi/readyapi/pull/11995) by [@ceb10n](https://github.com/ceb10n).
...
* 🌐 Add French translation for `docs/fr/docs/tutorial/body-multiple-params.md`. PR [#11796](https://github.com/readyapi/readyapi/pull/11796) by [@pe-brian](https://github.com/pe-brian).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/query-params.md`. PR [#11557](https://github.com/readyapi/readyapi/pull/11557) by [@caomingpei](https://github.com/caomingpei).
* 🌐 Update typo in Chinese translation for `docs/zh/docs/advanced/testing-dependencies.md`. PR [#11944](https://github.com/readyapi/readyapi/pull/11944) by [@bestony](https://github.com/bestony).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/sub-applications.md` and `docs/pt/docs/advanced/behind-a-proxy.md`. PR [#11856](https://github.com/readyapi/readyapi/pull/11856) by [@marcelomarkus](https://github.com/marcelomarkus).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/cors.md` and `docs/pt/docs/tutorial/middleware.md`. PR [#11916](https://github.com/readyapi/readyapi/pull/11916) by [@wesinalves](https://github.com/wesinalves).
* 🌐 Add French translation for `docs/fr/docs/tutorial/path-params-numeric-validations.md`. PR [#11788](https://github.com/readyapi/readyapi/pull/11788) by [@pe-brian](https://github.com/pe-brian).

### Internal

* ⬆ Bump pypa/gh-action-pypi-publish from 1.8.14 to 1.9.0. PR [#11727](https://github.com/readyapi/readyapi/pull/11727) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 🔧 Add changelog URL to `pyproject.toml`, shows in PyPI. PR [#11152](https://github.com/readyapi/readyapi/pull/11152) by [@Pierre-VF](https://github.com/Pierre-VF).
* 👷 Do not sync labels as it overrides manually added labels. PR [#12024](https://github.com/readyapi/readyapi/pull/12024) by [@khulnasoft](https://github.com/khulnasoft).
* 👷🏻 Update Labeler GitHub Actions. PR [#12019](https://github.com/readyapi/readyapi/pull/12019) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update configs for MkDocs for languages and social cards. PR [#12016](https://github.com/readyapi/readyapi/pull/12016) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update permissions and config for labeler GitHub Action. PR [#12008](https://github.com/readyapi/readyapi/pull/12008) by [@khulnasoft](https://github.com/khulnasoft).
* 👷🏻 Add GitHub Action label-checker. PR [#12005](https://github.com/readyapi/readyapi/pull/12005) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add label checker GitHub Action. PR [#12004](https://github.com/readyapi/readyapi/pull/12004) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update GitHub Action add-to-project. PR [#12002](https://github.com/readyapi/readyapi/pull/12002) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update labeler GitHub Action. PR [#12001](https://github.com/readyapi/readyapi/pull/12001) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add GitHub Action labeler. PR [#12000](https://github.com/readyapi/readyapi/pull/12000) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add GitHub Action add-to-project. PR [#11999](https://github.com/readyapi/readyapi/pull/11999) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Update admonitions in docs missing. PR [#11998](https://github.com/readyapi/readyapi/pull/11998) by [@khulnasoft](https://github.com/khulnasoft).
* 🔨 Update docs.py script to enable dirty reload conditionally. PR [#11986](https://github.com/readyapi/readyapi/pull/11986) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update MkDocs instant previews. PR [#11982](https://github.com/readyapi/readyapi/pull/11982) by [@khulnasoft](https://github.com/khulnasoft).
* 🐛 Fix deploy docs previews script to handle mkdocs.yml files. PR [#11984](https://github.com/readyapi/readyapi/pull/11984) by [@khulnasoft](https://github.com/khulnasoft).
* 💡 Add comment about custom Termynal line-height. PR [#11976](https://github.com/readyapi/readyapi/pull/11976) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add alls-green for test-redistribute. PR [#11974](https://github.com/readyapi/readyapi/pull/11974) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update docs-previews to handle no docs changes. PR [#11975](https://github.com/readyapi/readyapi/pull/11975) by [@khulnasoft](https://github.com/khulnasoft).
* 🔨 Refactor script `deploy_docs_status.py` to account for deploy URLs with or without trailing slash. PR [#11965](https://github.com/readyapi/readyapi/pull/11965) by [@khulnasoft](https://github.com/khulnasoft).
* 🔒️ Update permissions for deploy-docs action. PR [#11964](https://github.com/readyapi/readyapi/pull/11964) by [@khulnasoft](https://github.com/khulnasoft).
* 👷🏻 Add deploy docs status and preview links to PRs. PR [#11961](https://github.com/readyapi/readyapi/pull/11961) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update docs setup with latest configs and plugins. PR [#11953](https://github.com/readyapi/readyapi/pull/11953) by [@khulnasoft](https://github.com/khulnasoft).
* 🔇 Ignore warning from attrs in Trio. PR [#11949](https://github.com/readyapi/readyapi/pull/11949) by [@khulnasoft](https://github.com/khulnasoft).

## 0.112.0

### Breaking Changes

* ♻️ Add support for `pip install "readyapi[standard]"` with standard dependencies and `python -m readyapi`. PR [#11935](https://github.com/readyapi/readyapi/pull/11935) by [@khulnasoft](https://github.com/khulnasoft).
...
* And it upgrades `readyapi-cli[standard] >=0.0.5`.

#### Technical Details

Before this, `readyapi` would include the standard dependencies, with Uvicorn and the `readyapi-cli`, etc.

And `readyapi-slim` would not include those standard dependencies.

Now `readyapi` doesn't include those standard dependencies unless you install with `pip install "readyapi[standard]"`.

Before, you would install `pip install readyapi`, now you should include the `standard` optional dependencies (unless you want to exclude one of those): `pip install "readyapi[standard]"`.

This change is because having the standard optional dependencies installed by default was being inconvenient to several users, and having to install instead `readyapi-slim` was not being a feasible solution.

Discussed here: [#11522](https://github.com/readyapi/readyapi/pull/11522) and here: [#11525](https://github.com/readyapi/readyapi/discussions/11525)
...
* 🌐 Update Portuguese translation for `docs/pt/docs/alternatives.md`. PR [#11931](https://github.com/readyapi/readyapi/pull/11931) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/dependencies/sub-dependencies.md`. PR [#10515](https://github.com/khulnasoft/readyapi/pull/10515) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/response-change-status-code.md`. PR [#11863](https://github.com/khulnasoft/readyapi/pull/11863) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Add Portuguese translation for `docs/pt/docs/reference/background.md`. PR [#11849](https://github.com/khulnasoft/readyapi/pull/11849) by [@lucasbalieiro](https://github.com/lucasbalieiro).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/dependencies/dependencies-with-yield.md`. PR [#11848](https://github.com/khulnasoft/readyapi/pull/11848) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
* 🌐 Add Portuguese translation for `docs/pt/docs/reference/apirouter.md`. PR [#11843](https://github.com/khulnasoft/readyapi/pull/11843) by [@lucasbalieiro](https://github.com/lucasbalieiro).

### Internal

* 🔧 Update sponsors: add liblab. PR [#11934](https://github.com/readyapi/readyapi/pull/11934) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update GitHub Action label-approved permissions. PR [#11933](https://github.com/readyapi/readyapi/pull/11933) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Refactor GitHub Action to comment docs deployment URLs and update token. PR [#11925](https://github.com/readyapi/readyapi/pull/11925) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update tokens for GitHub Actions. PR [#11924](https://github.com/readyapi/readyapi/pull/11924) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update token permissions to comment deployment URL in docs. PR [#11917](https://github.com/readyapi/readyapi/pull/11917) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update token permissions for GitHub Actions. PR [#11915](https://github.com/readyapi/readyapi/pull/11915) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update GitHub Actions token usage. PR [#11914](https://github.com/readyapi/readyapi/pull/11914) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update GitHub Action to notify translations with label `approved-1`. PR [#11907](https://github.com/khulnasoft/readyapi/pull/11907) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, remove Reflex. PR [#11875](https://github.com/khulnasoft/readyapi/pull/11875) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors: remove TalkPython. PR [#11861](https://github.com/khulnasoft/readyapi/pull/11861) by [@khulnasoft](https://github.com/khulnasoft).
* 🔨 Update docs Termynal scripts to not include line nums for local dev. PR [#11854](https://github.com/khulnasoft/readyapi/pull/11854) by [@khulnasoft](https://github.com/khulnasoft).

## 0.111.1

### Upgrades

* ➖ Remove `orjson` and `ujson` from default dependencies. PR [#11842](https://github.com/khulnasoft/readyapi/pull/11842) by [@khulnasoft](https://github.com/khulnasoft).
    * These dependencies are still installed when you install with `pip install "readyapi[all]"`. But they are not included in `pip install readyapi`.
* 📝 Restored Swagger-UI links to use the latest version possible. PR [#11459](https://github.com/khulnasoft/readyapi/pull/11459) by [@UltimateLobster](https://github.com/UltimateLobster).
...
* 📝 Tweak intro docs about `Annotated` and `Query()` params. PR [#11664](https://github.com/khulnasoft/readyapi/pull/11664) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Update JWT auth documentation to use PyJWT instead of pyhon-jose. PR [#11589](https://github.com/khulnasoft/readyapi/pull/11589) by [@estebanx64](https://github.com/estebanx64).
* 📝 Update docs. PR [#11603](https://github.com/khulnasoft/readyapi/pull/11603) by [@alejsdev](https://github.com/alejsdev).
* ✏️ Fix typo: convert every 're-use' to 'reuse'.. PR [#11598](https://github.com/khulnasoft/readyapi/pull/11598) by [@hasansezertasan](https://github.com/hasansezertasan).
* ✏️ Fix typo in `readyapi/applications.py`. PR [#11593](https://github.com/khulnasoft/readyapi/pull/11593) by [@petarmaric](https://github.com/petarmaric).
* ✏️ Fix link in `readyapi-cli.md`. PR [#11524](https://github.com/khulnasoft/readyapi/pull/11524) by [@svlandeg](https://github.com/svlandeg).

### Translations

* 🌐 Add Spanish translation for `docs/es/docs/how-to/graphql.md`. PR [#11697](https://github.com/khulnasoft/readyapi/pull/11697) by [@camigomezdev](https://github.com/camigomezdev).
* 🌐 Add Portuguese translation for `docs/pt/docs/reference/index.md`. PR [#11840](https://github.com/khulnasoft/readyapi/pull/11840) by [@lucasbalieiro](https://github.com/lucasbalieiro).
* 🌐 Fix link in German translation. PR [#11836](https://github.com/khulnasoft/readyapi/pull/11836) by [@anitahammer](https://github.com/anitahammer).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/dependencies/sub-dependencies.md`. PR [#11792](https://github.com/khulnasoft/readyapi/pull/11792) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
* 🌐 Add Turkish translation for `docs/tr/docs/tutorial/request-forms.md`. PR [#11553](https://github.com/khulnasoft/readyapi/pull/11553) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Portuguese translation for `docs/pt/docs/reference/exceptions.md`. PR [#11834](https://github.com/khulnasoft/readyapi/pull/11834) by [@lucasbalieiro](https://github.com/lucasbalieiro).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/dependencies/global-dependencies.md`. PR [#11826](https://github.com/khulnasoft/readyapi/pull/11826) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
* 🌐 Add Portuguese translation for `docs/pt/docs/how-to/general.md`. PR [#11825](https://github.com/khulnasoft/readyapi/pull/11825) by [@lucasbalieiro](https://github.com/lucasbalieiro).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/async-tests.md`. PR [#11808](https://github.com/khulnasoft/readyapi/pull/11808) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Add Ukrainian translation for `docs/uk/docs/tutorial/first-steps.md`. PR [#11809](https://github.com/khulnasoft/readyapi/pull/11809) by [@vkhoroshchak](https://github.com/vkhoroshchak).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/dependencies/dependencies-in-path-operation-operators.md`. PR [#11804](https://github.com/khulnasoft/readyapi/pull/11804) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
* 🌐 Add Chinese translation for `docs/zh/docs/readyapi-cli.md`. PR [#11786](https://github.com/khulnasoft/readyapi/pull/11786) by [@logan2d5](https://github.com/logan2d5).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/openapi-webhooks.md`. PR [#11791](https://github.com/khulnasoft/readyapi/pull/11791) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Update Chinese translation for `docs/tutorial/security/oauth2-jwt.md`. PR [#11781](https://github.com/khulnasoft/readyapi/pull/11781) by [@logan2d5](https://github.com/logan2d5).
* 📝 Fix image missing in French translation for `docs/fr/docs/async.md` . PR [#11787](https://github.com/khulnasoft/readyapi/pull/11787) by [@pe-brian](https://github.com/pe-brian).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/advanced-dependencies.md`. PR [#11775](https://github.com/khulnasoft/readyapi/pull/11775) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/dependencies/classes-as-dependencies.md`. PR [#11768](https://github.com/khulnasoft/readyapi/pull/11768) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
* 🌐  Add Portuguese translation for `docs/pt/docs/advanced/additional-status-codes.md`. PR [#11753](https://github.com/khulnasoft/readyapi/pull/11753) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/dependencies/index.md`. PR [#11757](https://github.com/khulnasoft/readyapi/pull/11757) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/settings.md`. PR [#11739](https://github.com/khulnasoft/readyapi/pull/11739) by [@Joao-Pedro-P-Holanda](https://github.com/Joao-Pedro-P-Holanda).
* 🌐 Add French translation for `docs/fr/docs/learn/index.md`. PR [#11712](https://github.com/khulnasoft/readyapi/pull/11712) by [@benjaminvandammeholberton](https://github.com/benjaminvandammeholberton).
* 🌐 Add Portuguese translation for `docs/pt/docs/how-to/index.md`. PR [#11731](https://github.com/khulnasoft/readyapi/pull/11731) by [@vhsenna](https://github.com/vhsenna).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/additional-responses.md`. PR [#11736](https://github.com/khulnasoft/readyapi/pull/11736) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/benchmarks.md`. PR [#11713](https://github.com/khulnasoft/readyapi/pull/11713) by [@ceb10n](https://github.com/ceb10n).
* 🌐 Fix Korean translation for `docs/ko/docs/tutorial/response-status-code.md`. PR [#11718](https://github.com/khulnasoft/readyapi/pull/11718) by [@nayeonkinn](https://github.com/nayeonkinn).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/extra-data-types.md`. PR [#11711](https://github.com/khulnasoft/readyapi/pull/11711) by [@nayeonkinn](https://github.com/nayeonkinn).
* 🌐 Fix Korean translation for `docs/ko/docs/tutorial/body-nested-models.md`. PR [#11710](https://github.com/khulnasoft/readyapi/pull/11710) by [@nayeonkinn](https://github.com/nayeonkinn).
* 🌐 Add Portuguese translation for `docs/pt/docs/advanced/readyapi-cli.md`. PR [#11641](https://github.com/khulnasoft/readyapi/pull/11641) by [@ayr-ton](https://github.com/ayr-ton).
* 🌐 Add Traditional Chinese translation for `docs/zh-hant/docs/readyapi-people.md`. PR [#11639](https://github.com/khulnasoft/readyapi/pull/11639) by [@hsuanchi](https://github.com/hsuanchi).
* 🌐 Add Turkish translation for `docs/tr/docs/advanced/index.md`. PR [#11606](https://github.com/khulnasoft/readyapi/pull/11606) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/deployment/cloud.md`. PR [#11610](https://github.com/khulnasoft/readyapi/pull/11610) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/advanced/security/index.md`. PR [#11609](https://github.com/khulnasoft/readyapi/pull/11609) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/advanced/testing-websockets.md`. PR [#11608](https://github.com/khulnasoft/readyapi/pull/11608) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/how-to/general.md`. PR [#11607](https://github.com/khulnasoft/readyapi/pull/11607) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Update Chinese translation for `docs/zh/docs/advanced/templates.md`. PR [#11620](https://github.com/khulnasoft/readyapi/pull/11620) by [@chaoless](https://github.com/chaoless).
* 🌐 Add Turkish translation for `docs/tr/docs/deployment/index.md`. PR [#11605](https://github.com/khulnasoft/readyapi/pull/11605) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/tutorial/static-files.md`. PR [#11599](https://github.com/khulnasoft/readyapi/pull/11599) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Polish translation for `docs/pl/docs/readyapi-people.md`. PR [#10196](https://github.com/khulnasoft/readyapi/pull/10196) by [@isulim](https://github.com/isulim).
* 🌐 Add Turkish translation for `docs/tr/docs/advanced/wsgi.md`. PR [#11575](https://github.com/khulnasoft/readyapi/pull/11575) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/tutorial/cookie-params.md`. PR [#11561](https://github.com/khulnasoft/readyapi/pull/11561) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Russian translation for `docs/ru/docs/about/index.md`. PR [#10961](https://github.com/khulnasoft/readyapi/pull/10961) by [@s111d](https://github.com/s111d).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/sql-databases.md`. PR [#11539](https://github.com/khulnasoft/readyapi/pull/11539) by [@chaoless](https://github.com/chaoless).
* 🌐 Add Chinese translation for `docs/zh/docs/how-to/configure-swagger-ui.md`. PR [#11501](https://github.com/khulnasoft/readyapi/pull/11501) by [@Lucas-lyh](https://github.com/Lucas-lyh).
* 🌐 Update Chinese translation for `/docs/advanced/security/http-basic-auth.md`. PR [#11512](https://github.com/khulnasoft/readyapi/pull/11512) by [@nick-cjyx9](https://github.com/nick-cjyx9).

### Internal

* ♻️ Simplify internal docs script. PR [#11777](https://github.com/khulnasoft/readyapi/pull/11777) by [@gitworkflows](https://github.com/gitworkflows).
* 🔧 Update sponsors: add Fine. PR [#11784](https://github.com/khulnasoft/readyapi/pull/11784) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Tweak sponsors: Kong URL. PR [#11765](https://github.com/khulnasoft/readyapi/pull/11765) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Tweak sponsors: Kong URL. PR [#11764](https://github.com/khulnasoft/readyapi/pull/11764) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✨ Add ReadyAPI CLI, the new `readyapi` command. PR [#11522](https://github.com/khulnasoft/readyapi/pull/11522) by [@khulnasoft](https://github.com/khulnasoft).
    * New docs: [ReadyAPI CLI](https://readyapi.github.io/readyapi-cli/).

Try it out with:

```console
$ pip install --upgrade readyapi
...
* 🔧 Add configs and setup for `readyapi-slim` including optional extras `readyapi-slim[standard]`, and `readyapi` including by default the same `standard` extras. PR [#11503](https://github.com/khulnasoft/readyapi/pull/11503) by [@khulnasoft](https://github.com/khulnasoft).
...
* 🌐 Add Traditional Chinese translation for `docs/zh-hant/benchmarks.md`. PR [#11484](https://github.com/khulnasoft/readyapi/pull/11484) by [@KNChiu](https://github.com/KNChiu).
* 🌐 Update Chinese translation for `docs/zh/docs/readyapi-people.md`. PR [#11476](https://github.com/khulnasoft/readyapi/pull/11476) by [@billzhong](https://github.com/billzhong).
* 🌐 Add Chinese translation for `docs/zh/docs/how-to/index.md` and `docs/zh/docs/how-to/general.md`. PR [#11443](https://github.com/khulnasoft/readyapi/pull/11443) by [@billzhong](https://github.com/billzhong).
* 🌐 Add Spanish translation for cookie-params `docs/es/docs/tutorial/cookie-params.md`. PR [#11410](https://github.com/khulnasoft/readyapi/pull/11410) by [@fabianfalon](https://github.com/fabianfalon).

### Internal

* ⬆ Bump mkdocstrings[python] from 0.23.0 to 0.24.3. PR [#11469](https://github.com/khulnasoft/readyapi/pull/11469) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 🔨 Update internal scripts and remove unused ones. PR [#11499](https://github.com/khulnasoft/readyapi/pull/11499) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Migrate from Hatch to PDM for the internal build. PR [#11498](https://github.com/khulnasoft/readyapi/pull/11498) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Upgrade MkDocs Material and re-enable cards. PR [#11466](https://github.com/khulnasoft/readyapi/pull/11466) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆ Bump pillow from 10.2.0 to 10.3.0. PR [#11403](https://github.com/khulnasoft/readyapi/pull/11403) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 🔧 Ungroup dependabot updates. PR [#11465](https://github.com/khulnasoft/readyapi/pull/11465) by [@khulnasoft](https://github.com/khulnasoft).
...
* ♻️ Simplify Pydantic configs in OpenAPI models in `readyapi/openapi/models.py`. PR [#10886](https://github.com/khulnasoft/readyapi/pull/10886) by [@JoeTanto2](https://github.com/JoeTanto2).
* ✨ Add support for Pydantic's 2.7 new deprecated Field parameter, remove URL from validation errors response. PR [#11461](https://github.com/khulnasoft/readyapi/pull/11461) by [@khulnasoft](https://github.com/khulnasoft).
...
* 📝 Update OpenAPI client generation docs to use `@hey-api/openapi-ts`. PR [#11339](https://github.com/khulnasoft/readyapi/pull/11339) by [@jordanshatford](https://github.com/jordanshatford).

### Translations

* 🌐 Update Chinese translation for `docs/zh/docs/index.html`. PR [#11430](https://github.com/khulnasoft/readyapi/pull/11430) by [@waketzheng](https://github.com/waketzheng).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/dependencies/dependencies-in-path-operation-decorators.md`. PR [#11411](https://github.com/khulnasoft/readyapi/pull/11411) by [@anton2yakovlev](https://github.com/anton2yakovlev).
* 🌐 Add Portuguese translations for `learn/index.md` `resources/index.md` `help/index.md` `about/index.md`. PR [#10807](https://github.com/khulnasoft/readyapi/pull/10807) by [@nazarepiedady](https://github.com/nazarepiedady).
* 🌐 Update Russian translations for deployments docs. PR [#11271](https://github.com/khulnasoft/readyapi/pull/11271) by [@Lufa1u](https://github.com/Lufa1u).
* 🌐 Add Bengali translations for `docs/bn/docs/python-types.md`. PR [#11376](https://github.com/khulnasoft/readyapi/pull/11376) by [@imtiaz101325](https://github.com/imtiaz101325).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/security/simple-oauth2.md`. PR [#5744](https://github.com/khulnasoft/readyapi/pull/5744) by [@KdHyeon0661](https://github.com/KdHyeon0661).
* 🌐 Add Korean translation for `docs/ko/docs/help-readyapi.md`. PR [#4139](https://github.com/khulnasoft/readyapi/pull/4139) by [@kty4119](https://github.com/kty4119).
* 🌐 Add Korean translation for `docs/ko/docs/advanced/events.md`. PR [#5087](https://github.com/khulnasoft/readyapi/pull/5087) by [@pers0n4](https://github.com/pers0n4).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/path-operation-configuration.md`. PR [#1954](https://github.com/khulnasoft/readyapi/pull/1954) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/request-forms-and-files.md`. PR [#1946](https://github.com/khulnasoft/readyapi/pull/1946) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/dependencies/dependencies-with-yield.md`. PR [#10532](https://github.com/khulnasoft/readyapi/pull/10532) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/debugging.md`. PR [#5695](https://github.com/khulnasoft/readyapi/pull/5695) by [@JungWooGeon](https://github.com/JungWooGeon).

### Internal

* ⬆️ Upgrade version of cligenius for docs. PR [#11393](https://github.com/khulnasoft/readyapi/pull/11393) by [@khulnasoft](https://github.com/khulnasoft).

## 0.110.1

### Fixes

* 🐛 Fix parameterless `Depends()` with generics. PR [#9479](https://github.com/khulnasoft/readyapi/pull/9479) by [@nzig](https://github.com/nzig).

### Refactors

* ♻️ Update mypy. PR [#11049](https://github.com/khulnasoft/readyapi/pull/11049) by [@k0t3n](https://github.com/k0t3n).
* ♻️ Simplify string format with f-strings in `readyapi/applications.py`. PR [#11335](https://github.com/khulnasoft/readyapi/pull/11335) by [@igeni](https://github.com/igeni).

### Upgrades

* ⬆️ Upgrade Starlette to >=0.37.2,<0.38.0, remove Starlette filterwarning for internal tests. PR [#11266](https://github.com/khulnasoft/readyapi/pull/11266) by [@nothielf](https://github.com/nothielf).

### Docs

* 📝 Tweak docs and translations links and remove old docs translations. PR [#11381](https://github.com/khulnasoft/readyapi/pull/11381) by [@khulnasoft](https://github.com/khulnasoft).
* ✏️ Fix typo in `readyapi/security/oauth2.py`. PR [#11368](https://github.com/khulnasoft/readyapi/pull/11368) by [@shandongbinzhou](https://github.com/shandongbinzhou).
* 📝 Update links to Pydantic docs to point to new website. PR [#11328](https://github.com/khulnasoft/readyapi/pull/11328) by [@alejsdev](https://github.com/alejsdev).
* ✏️ Fix typo in `docs/en/docs/tutorial/extra-models.md`. PR [#11329](https://github.com/khulnasoft/readyapi/pull/11329) by [@alejsdev](https://github.com/alejsdev).
* 📝 Update `project-generation.md`. PR [#11326](https://github.com/khulnasoft/readyapi/pull/11326) by [@alejsdev](https://github.com/alejsdev).
* 📝 Update External Links. PR [#11327](https://github.com/khulnasoft/readyapi/pull/11327) by [@alejsdev](https://github.com/alejsdev).
* 🔥 Remove link to Pydantic's benchmark, on other i18n pages.. PR [#11224](https://github.com/khulnasoft/readyapi/pull/11224) by [@hirotoKirimaru](https://github.com/hirotoKirimaru).
* ✏️ Fix typos in docstrings. PR [#11295](https://github.com/khulnasoft/readyapi/pull/11295) by [@davidhuser](https://github.com/davidhuser).
* 🛠️ Improve Node.js script in docs to generate TypeScript clients. PR [#11293](https://github.com/khulnasoft/readyapi/pull/11293) by [@alejsdev](https://github.com/alejsdev).
* 📝 Update examples for tests to replace "inexistent" for "nonexistent". PR [#11220](https://github.com/khulnasoft/readyapi/pull/11220) by [@Homesteady](https://github.com/Homesteady).
* 📝 Update `python-multipart` GitHub link in all docs from `https://andrew-d.github.io/python-multipart/` to `https://github.com/Kludex/python-multipart`. PR [#11239](https://github.com/khulnasoft/readyapi/pull/11239) by [@joshjhans](https://github.com/joshjhans).

### Translations

* 🌐 Add German translation for `docs/de/docs/tutorial/response-status-code.md`. PR [#10357](https://github.com/khulnasoft/readyapi/pull/10357) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/query-params.md`. PR [#3480](https://github.com/khulnasoft/readyapi/pull/3480) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/body.md`. PR [#3481](https://github.com/khulnasoft/readyapi/pull/3481) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/path-params.md`. PR [#3479](https://github.com/khulnasoft/readyapi/pull/3479) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Update Chinese translation for `docs/tutorial/body-fields.md`. PR [#3496](https://github.com/khulnasoft/readyapi/pull/3496) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Update Chinese translation for `docs/tutorial/extra-models.md`. PR [#3497](https://github.com/khulnasoft/readyapi/pull/3497) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/metadata.md`. PR [#2667](https://github.com/khulnasoft/readyapi/pull/2667) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add German translation for `docs/de/docs/contributing.md`. PR [#10487](https://github.com/khulnasoft/readyapi/pull/10487) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update Japanese translation of `docs/ja/docs/tutorial/query-params.md`. PR [#10808](https://github.com/khulnasoft/readyapi/pull/10808) by [@urushio](https://github.com/urushio).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/security/get-current-user.md`. PR [#3842](https://github.com/khulnasoft/readyapi/pull/3842) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/openapi-callbacks.md`. PR [#3825](https://github.com/khulnasoft/readyapi/pull/3825) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/extending-openapi.md`. PR [#3823](https://github.com/khulnasoft/readyapi/pull/3823) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/testing-dependencies.md`. PR [#3819](https://github.com/khulnasoft/readyapi/pull/3819) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/custom-request-and-route.md`. PR [#3816](https://github.com/khulnasoft/readyapi/pull/3816) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/external-links.md`. PR [#3833](https://github.com/khulnasoft/readyapi/pull/3833) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/templates.md`. PR [#3812](https://github.com/khulnasoft/readyapi/pull/3812) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/sub-applications.md`. PR [#3811](https://github.com/khulnasoft/readyapi/pull/3811) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/async-sql-databases.md`. PR [#3805](https://github.com/khulnasoft/readyapi/pull/3805) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/middleware.md`. PR [#3804](https://github.com/khulnasoft/readyapi/pull/3804) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/dataclasses.md`. PR [#3803](https://github.com/khulnasoft/readyapi/pull/3803) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/using-request-directly.md`. PR [#3802](https://github.com/khulnasoft/readyapi/pull/3802) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/security/http-basic-auth.md`. PR [#3801](https://github.com/khulnasoft/readyapi/pull/3801) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/security/oauth2-scopes.md`. PR [#3800](https://github.com/khulnasoft/readyapi/pull/3800) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/cookie-params.md`. PR [#3486](https://github.com/khulnasoft/readyapi/pull/3486) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/header-params.md`. PR [#3487](https://github.com/khulnasoft/readyapi/pull/3487) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Update Chinese translation for `docs/tutorial/response-status-code.md`. PR [#3498](https://github.com/khulnasoft/readyapi/pull/3498) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add German translation for `docs/de/docs/tutorial/security/first-steps.md`. PR [#10432](https://github.com/khulnasoft/readyapi/pull/10432) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/events.md`. PR [#10693](https://github.com/khulnasoft/readyapi/pull/10693) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/cloud.md`. PR [#10746](https://github.com/khulnasoft/readyapi/pull/10746) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/behind-a-proxy.md`. PR [#10675](https://github.com/khulnasoft/readyapi/pull/10675) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/help-readyapi.md`. PR [#10455](https://github.com/khulnasoft/readyapi/pull/10455) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update German translation for `docs/de/docs/python-types.md`. PR [#10287](https://github.com/khulnasoft/readyapi/pull/10287) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/path-params.md`. PR [#10290](https://github.com/khulnasoft/readyapi/pull/10290) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/handling-errors.md`. PR [#10379](https://github.com/khulnasoft/readyapi/pull/10379) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update German translation for `docs/de/docs/index.md`. PR [#10283](https://github.com/khulnasoft/readyapi/pull/10283) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/security/http-basic-auth.md`. PR [#10651](https://github.com/khulnasoft/readyapi/pull/10651) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/bigger-applications.md`. PR [#10554](https://github.com/khulnasoft/readyapi/pull/10554) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/path-operation-advanced-configuration.md`. PR [#10612](https://github.com/khulnasoft/readyapi/pull/10612) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/static-files.md`. PR [#10584](https://github.com/khulnasoft/readyapi/pull/10584) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/security/oauth2-jwt.md`. PR [#10522](https://github.com/khulnasoft/readyapi/pull/10522) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/response-model.md`. PR [#10345](https://github.com/khulnasoft/readyapi/pull/10345) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/extra-models.md`. PR [#10351](https://github.com/khulnasoft/readyapi/pull/10351) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/body-updates.md`. PR [#10396](https://github.com/khulnasoft/readyapi/pull/10396) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/alternatives.md`. PR [#10855](https://github.com/khulnasoft/readyapi/pull/10855) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/templates.md`. PR [#10678](https://github.com/khulnasoft/readyapi/pull/10678) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/security/oauth2-scopes.md`. PR [#10643](https://github.com/khulnasoft/readyapi/pull/10643) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/async-tests.md`. PR [#10708](https://github.com/khulnasoft/readyapi/pull/10708) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/metadata.md`. PR [#10581](https://github.com/khulnasoft/readyapi/pull/10581) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/testing.md`. PR [#10586](https://github.com/khulnasoft/readyapi/pull/10586) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/schema-extra-example.md`. PR [#10597](https://github.com/khulnasoft/readyapi/pull/10597) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/index.md`. PR [#10611](https://github.com/khulnasoft/readyapi/pull/10611) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/response-directly.md`. PR [#10618](https://github.com/khulnasoft/readyapi/pull/10618) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/additional-responses.md`. PR [#10626](https://github.com/khulnasoft/readyapi/pull/10626) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/response-cookies.md`. PR [#10627](https://github.com/khulnasoft/readyapi/pull/10627) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/response-headers.md`. PR [#10628](https://github.com/khulnasoft/readyapi/pull/10628) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/response-change-status-code.md`. PR [#10632](https://github.com/khulnasoft/readyapi/pull/10632) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/advanced-dependencies.md`. PR [#10633](https://github.com/khulnasoft/readyapi/pull/10633) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/security/index.md`. PR [#10635](https://github.com/khulnasoft/readyapi/pull/10635) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/using-request-directly.md`. PR [#10653](https://github.com/khulnasoft/readyapi/pull/10653) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/dataclasses.md`. PR [#10667](https://github.com/khulnasoft/readyapi/pull/10667) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/middleware.md`. PR [#10668](https://github.com/khulnasoft/readyapi/pull/10668) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/sub-applications.md`. PR [#10671](https://github.com/khulnasoft/readyapi/pull/10671) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/websockets.md`. PR [#10687](https://github.com/khulnasoft/readyapi/pull/10687) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/testing-websockets.md`. PR [#10703](https://github.com/khulnasoft/readyapi/pull/10703) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/testing-events.md`. PR [#10704](https://github.com/khulnasoft/readyapi/pull/10704) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/testing-dependencies.md`. PR [#10706](https://github.com/khulnasoft/readyapi/pull/10706) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/openapi-callbacks.md`. PR [#10710](https://github.com/khulnasoft/readyapi/pull/10710) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/settings.md`. PR [#10709](https://github.com/khulnasoft/readyapi/pull/10709) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/wsgi.md`. PR [#10713](https://github.com/khulnasoft/readyapi/pull/10713) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/index.md`. PR [#10733](https://github.com/khulnasoft/readyapi/pull/10733) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/https.md`. PR [#10737](https://github.com/khulnasoft/readyapi/pull/10737) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/manually.md`. PR [#10738](https://github.com/khulnasoft/readyapi/pull/10738) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/concepts.md`. PR [#10744](https://github.com/khulnasoft/readyapi/pull/10744) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update German translation for `docs/de/docs/features.md`. PR [#10284](https://github.com/khulnasoft/readyapi/pull/10284) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/server-workers.md`. PR [#10747](https://github.com/khulnasoft/readyapi/pull/10747) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/docker.md`. PR [#10759](https://github.com/khulnasoft/readyapi/pull/10759) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/index.md`. PR [#10769](https://github.com/khulnasoft/readyapi/pull/10769) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/general.md`. PR [#10770](https://github.com/khulnasoft/readyapi/pull/10770) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/graphql.md`. PR [#10788](https://github.com/khulnasoft/readyapi/pull/10788) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/custom-request-and-route.md`. PR [#10789](https://github.com/khulnasoft/readyapi/pull/10789) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/conditional-openapi.md`. PR [#10790](https://github.com/khulnasoft/readyapi/pull/10790) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/separate-openapi-schemas.md`. PR [#10796](https://github.com/khulnasoft/readyapi/pull/10796) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/configure-swagger-ui.md`. PR [#10804](https://github.com/khulnasoft/readyapi/pull/10804) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/how-to/custom-docs-ui-assets.md`. PR [#10803](https://github.com/khulnasoft/readyapi/pull/10803) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/parameters.md`. PR [#10814](https://github.com/khulnasoft/readyapi/pull/10814) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/status.md`. PR [#10815](https://github.com/khulnasoft/readyapi/pull/10815) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/uploadfile.md`. PR [#10816](https://github.com/khulnasoft/readyapi/pull/10816) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/exceptions.md`. PR [#10817](https://github.com/khulnasoft/readyapi/pull/10817) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/dependencies.md`. PR [#10818](https://github.com/khulnasoft/readyapi/pull/10818) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/apirouter.md`. PR [#10819](https://github.com/khulnasoft/readyapi/pull/10819) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/websockets.md`. PR [#10822](https://github.com/khulnasoft/readyapi/pull/10822) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/httpconnection.md`. PR [#10823](https://github.com/khulnasoft/readyapi/pull/10823) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/response.md`. PR [#10824](https://github.com/khulnasoft/readyapi/pull/10824) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/middleware.md`. PR [#10837](https://github.com/khulnasoft/readyapi/pull/10837) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/openapi/*.md`. PR [#10838](https://github.com/khulnasoft/readyapi/pull/10838) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/security/index.md`. PR [#10839](https://github.com/khulnasoft/readyapi/pull/10839) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/staticfiles.md`. PR [#10841](https://github.com/khulnasoft/readyapi/pull/10841) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/testclient.md`. PR [#10843](https://github.com/khulnasoft/readyapi/pull/10843) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/project-generation.md`. PR [#10851](https://github.com/khulnasoft/readyapi/pull/10851) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/history-design-future.md`. PR [#10865](https://github.com/khulnasoft/readyapi/pull/10865) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/dependencies/dependencies-with-yield.md`. PR [#10422](https://github.com/khulnasoft/readyapi/pull/10422) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/dependencies/global-dependencies.md`. PR [#10420](https://github.com/khulnasoft/readyapi/pull/10420) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update German translation for `docs/de/docs/readyapi-people.md`. PR [#10285](https://github.com/khulnasoft/readyapi/pull/10285) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/dependencies/sub-dependencies.md`. PR [#10409](https://github.com/khulnasoft/readyapi/pull/10409) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/security/index.md`. PR [#10429](https://github.com/khulnasoft/readyapi/pull/10429) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/dependencies/dependencies-in-path-operation-decorators.md`. PR [#10411](https://github.com/khulnasoft/readyapi/pull/10411) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/extra-data-types.md`. PR [#10534](https://github.com/khulnasoft/readyapi/pull/10534) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/security/simple-oauth2.md`. PR [#10504](https://github.com/khulnasoft/readyapi/pull/10504) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/security/get-current-user.md`. PR [#10439](https://github.com/khulnasoft/readyapi/pull/10439) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/request-forms-and-files.md`. PR [#10368](https://github.com/khulnasoft/readyapi/pull/10368) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/encoder.md`. PR [#10385](https://github.com/khulnasoft/readyapi/pull/10385) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/request-forms.md`. PR [#10361](https://github.com/khulnasoft/readyapi/pull/10361) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/deployment/versions.md`. PR [#10491](https://github.com/khulnasoft/readyapi/pull/10491) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/async.md`. PR [#10449](https://github.com/khulnasoft/readyapi/pull/10449) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/cookie-params.md`. PR [#10323](https://github.com/khulnasoft/readyapi/pull/10323) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/dependencies/classes-as-dependencies.md`. PR [#10407](https://github.com/khulnasoft/readyapi/pull/10407) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/dependencies/index.md`. PR [#10399](https://github.com/khulnasoft/readyapi/pull/10399) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/header-params.md`. PR [#10326](https://github.com/khulnasoft/readyapi/pull/10326) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/path-params-numeric-validations.md`. PR [#10307](https://github.com/khulnasoft/readyapi/pull/10307) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/query-params-str-validations.md`. PR [#10304](https://github.com/khulnasoft/readyapi/pull/10304) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/request-files.md`. PR [#10364](https://github.com/khulnasoft/readyapi/pull/10364) by [@nilslindemann](https://github.com/nilslindemann).
* :globe_with_meridians: Add Portuguese translation for `docs/pt/docs/advanced/templates.md`. PR [#11338](https://github.com/khulnasoft/readyapi/pull/11338) by [@SamuelBFavarin](https://github.com/SamuelBFavarin).
* 🌐 Add Bengali translations for `docs/bn/docs/learn/index.md`. PR [#11337](https://github.com/khulnasoft/readyapi/pull/11337) by [@imtiaz101325](https://github.com/imtiaz101325).
* 🌐 Fix Korean translation for `docs/ko/docs/index.md`. PR [#11296](https://github.com/khulnasoft/readyapi/pull/11296) by [@choi-haram](https://github.com/choi-haram).
* 🌐 Add Korean translation for `docs/ko/docs/about/index.md`. PR [#11299](https://github.com/khulnasoft/readyapi/pull/11299) by [@choi-haram](https://github.com/choi-haram).
* 🌐 Add Korean translation for `docs/ko/docs/advanced/index.md`. PR [#9613](https://github.com/khulnasoft/readyapi/pull/9613) by [@ElliottLarsen](https://github.com/ElliottLarsen).
* 🌐 Add German translation for `docs/de/docs/how-to/extending-openapi.md`. PR [#10794](https://github.com/khulnasoft/readyapi/pull/10794) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/metadata.md`. PR [#11286](https://github.com/khulnasoft/readyapi/pull/11286) by [@jackleeio](https://github.com/jackleeio).
* 🌐 Update Chinese translation for `docs/zh/docs/contributing.md`. PR [#10887](https://github.com/khulnasoft/readyapi/pull/10887) by [@Aruelius](https://github.com/Aruelius).
* 🌐 Add Azerbaijani translation for `docs/az/docs/readyapi-people.md`. PR [#11195](https://github.com/khulnasoft/readyapi/pull/11195) by [@vusallyv](https://github.com/vusallyv).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/dependencies/index.md`. PR [#11223](https://github.com/khulnasoft/readyapi/pull/11223) by [@kohiry](https://github.com/kohiry).
* 🌐 Update Chinese translation for `docs/zh/docs/tutorial/query-params.md`. PR [#11242](https://github.com/khulnasoft/readyapi/pull/11242) by [@jackleeio](https://github.com/jackleeio).
* 🌐 Add Azerbaijani translation for `docs/az/learn/index.md`. PR [#11192](https://github.com/khulnasoft/readyapi/pull/11192) by [@vusallyv](https://github.com/vusallyv).
...
* ⬆ Bump black from 23.3.0 to 24.3.0. PR [#11325](https://github.com/khulnasoft/readyapi/pull/11325) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Add cron to run test once a week on monday. PR [#11377](https://github.com/khulnasoft/readyapi/pull/11377) by [@estebanx64](https://github.com/estebanx64).
* ➕ Replace mkdocs-markdownextradata-plugin with mkdocs-macros-plugin. PR [#11383](https://github.com/khulnasoft/readyapi/pull/11383) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Disable MkDocs insiders social plugin while an issue in MkDocs Material is handled. PR [#11373](https://github.com/khulnasoft/readyapi/pull/11373) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Fix logic for when to install and use MkDocs Insiders. PR [#11372](https://github.com/khulnasoft/readyapi/pull/11372) by [@khulnasoft](https://github.com/khulnasoft).
...
* 🐛 Fix unhandled growing memory for internal server errors, refactor dependencies with `yield` and `except` to require raising again as in regular Python. PR [#11191](https://github.com/khulnasoft/readyapi/pull/11191) by [@khulnasoft](https://github.com/khulnasoft).
    ...
    * Read the new docs: [Dependencies with `yield` and `except`](https://readyapi.github.io/tutorial/dependencies/dependencies-with-yield/#dependencies-with-yield-and-except).
...
* ✏️ Fix minor typos in `docs/ko/docs/`. PR [#11126](https://github.com/khulnasoft/readyapi/pull/11126) by [@KaniKim](https://github.com/KaniKim).
* ✏️ Fix minor typo in `readyapi/applications.py`. PR [#11099](https://github.com/khulnasoft/readyapi/pull/11099) by [@JacobHayes](https://github.com/JacobHayes).

### Translations

* 🌐 Add German translation for `docs/de/docs/reference/background.md`. PR [#10820](https://github.com/khulnasoft/readyapi/pull/10820) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/templating.md`. PR [#10842](https://github.com/khulnasoft/readyapi/pull/10842) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/external-links.md`. PR [#10852](https://github.com/khulnasoft/readyapi/pull/10852) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Update Turkish translation for `docs/tr/docs/tutorial/query-params.md`. PR [#11162](https://github.com/khulnasoft/readyapi/pull/11162) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add German translation for `docs/de/docs/reference/encoders.md`. PR [#10840](https://github.com/khulnasoft/readyapi/pull/10840) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/responses.md`. PR [#10825](https://github.com/khulnasoft/readyapi/pull/10825) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/reference/request.md`. PR [#10821](https://github.com/khulnasoft/readyapi/pull/10821) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add Turkish translation for `docs/tr/docs/tutorial/query-params.md`. PR [#11078](https://github.com/khulnasoft/readyapi/pull/11078) by [@emrhnsyts](https://github.com/emrhnsyts).
* 🌐 Add German translation for `docs/de/docs/reference/readyapi.md`. PR [#10813](https://github.com/khulnasoft/readyapi/pull/10813) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/newsletter.md`. PR [#10853](https://github.com/khulnasoft/readyapi/pull/10853) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add Traditional Chinese translation for `docs/zh-hant/docs/learn/index.md`. PR [#11142](https://github.com/khulnasoft/readyapi/pull/11142) by [@hsuanchi](https://github.com/hsuanchi).
* 🌐 Add Korean translation for `/docs/ko/docs/tutorial/dependencies/global-dependencies.md`. PR [#11123](https://github.com/khulnasoft/readyapi/pull/11123) by [@riroan](https://github.com/riroan).
* 🌐 Add Korean translation for `/docs/ko/docs/tutorial/dependencies/dependencies-in-path-operation-decorators.md`. PR [#11124](https://github.com/khulnasoft/readyapi/pull/11124) by [@riroan](https://github.com/riroan).
* 🌐 Add Korean translation for `/docs/ko/docs/tutorial/schema-extra-example.md`. PR [#11121](https://github.com/khulnasoft/readyapi/pull/11121) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Add Korean translation for `/docs/ko/docs/tutorial/body-fields.md`. PR [#11112](https://github.com/khulnasoft/readyapi/pull/11112) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Add Korean translation for `/docs/ko/docs/tutorial/cookie-params.md`. PR [#11118](https://github.com/khulnasoft/readyapi/pull/11118) by [@riroan](https://github.com/riroan).
* 🌐 Update Korean translation for `/docs/ko/docs/dependencies/index.md`. PR [#11114](https://github.com/khulnasoft/readyapi/pull/11114) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Update Korean translation for `/docs/ko/docs/deployment/docker.md`. PR [#11113](https://github.com/khulnasoft/readyapi/pull/11113) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Update Turkish translation for `docs/tr/docs/tutorial/first-steps.md`. PR [#11094](https://github.com/khulnasoft/readyapi/pull/11094) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Spanish translation for `docs/es/docs/advanced/security/index.md`. PR [#2278](https://github.com/khulnasoft/readyapi/pull/2278) by [@Xaraxx](https://github.com/Xaraxx).
* 🌐 Add Spanish translation for `docs/es/docs/advanced/response-headers.md`. PR [#2276](https://github.com/khulnasoft/readyapi/pull/2276) by [@Xaraxx](https://github.com/Xaraxx).
* 🌐 Add Spanish translation for `docs/es/docs/deployment/index.md` and `~/deployment/versions.md`. PR [#9669](https://github.com/khulnasoft/readyapi/pull/9669) by [@pabloperezmoya](https://github.com/pabloperezmoya).
* 🌐 Add Spanish translation for `docs/es/docs/benchmarks.md`. PR [#10928](https://github.com/khulnasoft/readyapi/pull/10928) by [@pablocm83](https://github.com/pablocm83).
* 🌐 Add Spanish translation for `docs/es/docs/advanced/response-change-status-code.md`. PR [#11100](https://github.com/khulnasoft/readyapi/pull/11100) by [@alejsdev](https://github.com/alejsdev).

## 0.109.2

### Upgrades

* ⬆️ Upgrade version of Starlette to `>= 0.36.3`. PR [#11086](https://github.com/khulnasoft/readyapi/pull/11086) by [@khulnasoft](https://github.com/khulnasoft).

### Translations

* 🌐 Update Turkish translation for `docs/tr/docs/readyapi-people.md`. PR [#10547](https://github.com/khulnasoft/readyapi/pull/10547) by [@alperiox](https://github.com/alperiox).
...
Read more in the [advisory: Content-Type Header ReDoS](https://github.com/khulnasoft/readyapi/security/advisories/GHSA-qf9m-vfgh-m389).

### Features

* ✨  Include HTTP 205 in status codes with no body. PR [#10969](https://github.com/khulnasoft/readyapi/pull/10969) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✏️ A few tweaks in `docs/de/docs/tutorial/first-steps.md`. PR [#10959](https://github.com/khulnasoft/readyapi/pull/10959) by [@nilslindemann](https://github.com/nilslindemann).
* ✏️ Fix link in `docs/en/docs/advanced/async-tests.md`. PR [#10960](https://github.com/khulnasoft/readyapi/pull/10960) by [@nilslindemann](https://github.com/nilslindemann).
* ✏️ Fix typos for Spanish documentation. PR [#10957](https://github.com/khulnasoft/readyapi/pull/10957) by [@jlopezlira](https://github.com/jlopezlira).
* 📝 Add warning about lifespan functions and backwards compatibility with events. PR [#10734](https://github.com/khulnasoft/readyapi/pull/10734) by [@jacob-indigo](https://github.com/jacob-indigo).
* ✏️ Fix broken link in `docs/tutorial/sql-databases.md` in several languages. PR [#10716](https://github.com/khulnasoft/readyapi/pull/10716) by [@theoohoho](https://github.com/theoohoho).
* ✏️ Remove broken links from `external_links.yml`. PR [#10943](https://github.com/khulnasoft/readyapi/pull/10943) by [@Torabek](https://github.com/Torabek).
...
* ✏️ Fix Pydantic method name in `docs/en/docs/advanced/path-operation-advanced-configuration.md`. PR [#10826](https://github.com/khulnasoft/readyapi/pull/10826) by [@ahmedabdou14](https://github.com/ahmedabdou14).

### Translations

* 🌐 Add Spanish translation for `docs/es/docs/external-links.md`. PR [#10933](https://github.com/khulnasoft/readyapi/pull/10933) by [@pablocm83](https://github.com/pablocm83).
* 🌐 Update Korean translation for `docs/ko/docs/tutorial/first-steps.md`, `docs/ko/docs/tutorial/index.md`, `docs/ko/docs/tutorial/path-params.md`, and `docs/ko/docs/tutorial/query-params.md`. PR [#4218](https://github.com/khulnasoft/readyapi/pull/4218) by [@SnowSuno](https://github.com/SnowSuno).
* 🌐 Add Chinese translation for `docs/zh/docs/tutorial/dependencies/dependencies-with-yield.md`. PR [#10870](https://github.com/khulnasoft/readyapi/pull/10870) by [@zhiquanchi](https://github.com/zhiquanchi).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/concepts.md`. PR [#10282](https://github.com/khulnasoft/readyapi/pull/10282) by [@xzmeng](https://github.com/xzmeng).
* 🌐 Add Azerbaijani translation for `docs/az/docs/index.md`. PR [#11047](https://github.com/khulnasoft/readyapi/pull/11047) by [@aykhans](https://github.com/aykhans).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/middleware.md`. PR [#2829](https://github.com/khulnasoft/readyapi/pull/2829) by [@JeongHyeongKim](https://github.com/JeongHyeongKim).
* 🌐 Add German translation for `docs/de/docs/tutorial/body-nested-models.md`. PR [#10313](https://github.com/khulnasoft/readyapi/pull/10313) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add Persian translation for `docs/fa/docs/tutorial/middleware.md`. PR [#9695](https://github.com/khulnasoft/readyapi/pull/9695) by [@mojtabapaso](https://github.com/mojtabapaso).
* 🌐 Update Farsi translation for `docs/fa/docs/index.md`. PR [#10216](https://github.com/khulnasoft/readyapi/pull/10216) by [@theonlykingpin](https://github.com/theonlykingpin).
* 🌐 Add German translation for `docs/de/docs/tutorial/body-fields.md`. PR [#10310](https://github.com/khulnasoft/readyapi/pull/10310) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/body.md`. PR [#10295](https://github.com/khulnasoft/readyapi/pull/10295) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/body-multiple-params.md`. PR [#10308](https://github.com/khulnasoft/readyapi/pull/10308) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/security/get-current-user.md`. PR [#2681](https://github.com/khulnasoft/readyapi/pull/2681) by [@sh0nk](https://github.com/sh0nk).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/advanced-dependencies.md`. PR [#3798](https://github.com/khulnasoft/readyapi/pull/3798) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/events.md`. PR [#3815](https://github.com/khulnasoft/readyapi/pull/3815) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/behind-a-proxy.md`. PR [#3820](https://github.com/khulnasoft/readyapi/pull/3820) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/testing-events.md`. PR [#3818](https://github.com/khulnasoft/readyapi/pull/3818) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/testing-websockets.md`. PR [#3817](https://github.com/khulnasoft/readyapi/pull/3817) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/testing-database.md`. PR [#3821](https://github.com/khulnasoft/readyapi/pull/3821) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/deta.md`. PR [#3837](https://github.com/khulnasoft/readyapi/pull/3837) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/history-design-future.md`. PR [#3832](https://github.com/khulnasoft/readyapi/pull/3832) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/project-generation.md`. PR [#3831](https://github.com/khulnasoft/readyapi/pull/3831) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/docker.md`. PR [#10296](https://github.com/khulnasoft/readyapi/pull/10296) by [@xzmeng](https://github.com/xzmeng).
* 🌐 Update Spanish translation for `docs/es/docs/features.md`. PR [#10884](https://github.com/khulnasoft/readyapi/pull/10884) by [@pablocm83](https://github.com/pablocm83).
* 🌐 Add Spanish translation for `docs/es/docs/newsletter.md`. PR [#10922](https://github.com/khulnasoft/readyapi/pull/10922) by [@pablocm83](https://github.com/pablocm83).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/background-tasks.md`. PR [#5910](https://github.com/khulnasoft/readyapi/pull/5910) by [@junah201](https://github.com/junah201).
* :globe_with_meridians: Add Turkish translation for `docs/tr/docs/alternatives.md`. PR [#10502](https://github.com/khulnasoft/readyapi/pull/10502) by [@alperiox](https://github.com/alperiox).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/dependencies/index.md`. PR [#10989](https://github.com/khulnasoft/readyapi/pull/10989) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Add Korean translation for `/docs/ko/docs/tutorial/body.md`. PR [#11000](https://github.com/khulnasoft/readyapi/pull/11000) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/schema-extra-example.md`. PR [#4065](https://github.com/khulnasoft/readyapi/pull/4065) by [@luccasmmg](https://github.com/luccasmmg).
* 🌐 Add Turkish translation for `docs/tr/docs/history-design-future.md`. PR [#11012](https://github.com/khulnasoft/readyapi/pull/11012) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/resources/index.md`. PR [#11020](https://github.com/khulnasoft/readyapi/pull/11020) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/how-to/index.md`. PR [#11021](https://github.com/khulnasoft/readyapi/pull/11021) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add German translation for `docs/de/docs/tutorial/query-params.md`. PR [#10293](https://github.com/khulnasoft/readyapi/pull/10293) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/benchmarks.md`. PR [#10866](https://github.com/khulnasoft/readyapi/pull/10866) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add Turkish translation for `docs/tr/docs/learn/index.md`. PR [#11014](https://github.com/khulnasoft/readyapi/pull/11014) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Persian translation for `docs/fa/docs/tutorial/security/index.md`. PR [#9945](https://github.com/khulnasoft/readyapi/pull/9945) by [@mojtabapaso](https://github.com/mojtabapaso).
* 🌐 Add Turkish translation for `docs/tr/docs/help/index.md`. PR [#11013](https://github.com/khulnasoft/readyapi/pull/11013) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Turkish translation for `docs/tr/docs/about/index.md`. PR [#11006](https://github.com/khulnasoft/readyapi/pull/11006) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Update Turkish translation for `docs/tr/docs/benchmarks.md`. PR [#11005](https://github.com/khulnasoft/readyapi/pull/11005) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Italian translation for `docs/it/docs/index.md`. PR [#5233](https://github.com/khulnasoft/readyapi/pull/5233) by [@matteospanio](https://github.com/matteospanio).
* 🌐 Add Korean translation for `docs/ko/docs/help/index.md`. PR [#10983](https://github.com/khulnasoft/readyapi/pull/10983) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Add Korean translation for `docs/ko/docs/features.md`. PR [#10976](https://github.com/khulnasoft/readyapi/pull/10976) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/security/get-current-user.md`. PR [#5737](https://github.com/khulnasoft/readyapi/pull/5737) by [@KdHyeon0661](https://github.com/KdHyeon0661).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/security/first-steps.md`. PR [#10541](https://github.com/khulnasoft/readyapi/pull/10541) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/handling-errors.md`. PR [#10375](https://github.com/khulnasoft/readyapi/pull/10375) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/encoder.md`. PR [#10374](https://github.com/khulnasoft/readyapi/pull/10374) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/body-updates.md`. PR [#10373](https://github.com/khulnasoft/readyapi/pull/10373) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Russian translation: updated `readyapi-people.md`.. PR [#10255](https://github.com/khulnasoft/readyapi/pull/10255) by [@NiKuma0](https://github.com/NiKuma0).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/security/index.md`. PR [#5798](https://github.com/khulnasoft/readyapi/pull/5798) by [@3w36zj6](https://github.com/3w36zj6).
* 🌐 Add German translation for `docs/de/docs/advanced/generate-clients.md`. PR [#10725](https://github.com/khulnasoft/readyapi/pull/10725) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/openapi-webhooks.md`. PR [#10712](https://github.com/khulnasoft/readyapi/pull/10712) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/custom-response.md`. PR [#10624](https://github.com/khulnasoft/readyapi/pull/10624) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/advanced/additional-status-codes.md`. PR [#10617](https://github.com/khulnasoft/readyapi/pull/10617) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add German translation for `docs/de/docs/tutorial/middleware.md`. PR [#10391](https://github.com/khulnasoft/readyapi/pull/10391) by [@JohannesJungbluth](https://github.com/JohannesJungbluth).
* 🌐 Add German translation for introduction documents. PR [#10497](https://github.com/khulnasoft/readyapi/pull/10497) by [@nilslindemann](https://github.com/nilslindemann).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/encoder.md`. PR [#1955](https://github.com/khulnasoft/readyapi/pull/1955) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/extra-data-types.md`. PR [#1932](https://github.com/khulnasoft/readyapi/pull/1932) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Turkish translation for `docs/tr/docs/async.md`. PR [#5191](https://github.com/khulnasoft/readyapi/pull/5191) by [@BilalAlpaslan](https://github.com/BilalAlpaslan).
* 🌐 Add Turkish translation for `docs/tr/docs/project-generation.md`. PR [#5192](https://github.com/khulnasoft/readyapi/pull/5192) by [@BilalAlpaslan](https://github.com/BilalAlpaslan).
* 🌐 Add Korean translation for `docs/ko/docs/deployment/docker.md`. PR [#5657](https://github.com/khulnasoft/readyapi/pull/5657) by [@nearnear](https://github.com/nearnear).
* 🌐 Add Korean translation for `docs/ko/docs/deployment/server-workers.md`. PR [#4935](https://github.com/khulnasoft/readyapi/pull/4935) by [@jujumilk3](https://github.com/jujumilk3).
* 🌐 Add Korean translation for `docs/ko/docs/deployment/index.md`. PR [#4561](https://github.com/khulnasoft/readyapi/pull/4561) by [@jujumilk3](https://github.com/jujumilk3).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/path-operation-configuration.md`. PR [#3639](https://github.com/khulnasoft/readyapi/pull/3639) by [@jungsu-kwon](https://github.com/jungsu-kwon).
* 🌐 Modify the description of `zh` - Traditional Chinese. PR [#10889](https://github.com/khulnasoft/readyapi/pull/10889) by [@cherinyy](https://github.com/cherinyy).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/static-files.md`. PR [#2957](https://github.com/khulnasoft/readyapi/pull/2957) by [@jeesang7](https://github.com/jeesang7).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/response-model.md`. PR [#2766](https://github.com/khulnasoft/readyapi/pull/2766) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/body-multiple-params.md`. PR [#2461](https://github.com/khulnasoft/readyapi/pull/2461) by [@PandaHun](https://github.com/PandaHun).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/query-params-str-validations.md`. PR [#2415](https://github.com/khulnasoft/readyapi/pull/2415) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Korean translation for `docs/ko/docs/python-types.md`. PR [#2267](https://github.com/khulnasoft/readyapi/pull/2267) by [@jrim](https://github.com/jrim).
* 🌐 Add Korean translation for `docs/ko/docs/tutorial/body-nested-models.md`. PR [#2506](https://github.com/khulnasoft/readyapi/pull/2506) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Korean translation for `docs/ko/docs/learn/index.md`. PR [#10977](https://github.com/khulnasoft/readyapi/pull/10977) by [@KaniKim](https://github.com/KaniKim).
* 🌐 Initialize translations for Traditional Chinese. PR [#10505](https://github.com/khulnasoft/readyapi/pull/10505) by [@hsuanchi](https://github.com/hsuanchi).
* ✏️ Tweak the german translation of `docs/de/docs/tutorial/index.md`. PR [#10962](https://github.com/khulnasoft/readyapi/pull/10962) by [@nilslindemann](https://github.com/nilslindemann).
* ✏️ Fix typo error in `docs/ko/docs/tutorial/path-params.md`. PR [#10758](https://github.com/khulnasoft/readyapi/pull/10758) by [@2chanhaeng](https://github.com/2chanhaeng).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/dependencies/dependencies-with-yield.md`. PR [#1961](https://github.com/khulnasoft/readyapi/pull/1961) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/dependencies/dependencies-in-path-operation-decorators.md`. PR [#1960](https://github.com/khulnasoft/readyapi/pull/1960) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/dependencies/sub-dependencies.md`. PR [#1959](https://github.com/khulnasoft/readyapi/pull/1959) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/background-tasks.md`. PR [#2668](https://github.com/khulnasoft/readyapi/pull/2668) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/dependencies/index.md` and `docs/ja/docs/tutorial/dependencies/classes-as-dependencies.md`. PR [#1958](https://github.com/khulnasoft/readyapi/pull/1958) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/response-model.md`. PR [#1938](https://github.com/khulnasoft/readyapi/pull/1938) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/body-multiple-params.md`. PR [#1903](https://github.com/khulnasoft/readyapi/pull/1903) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/path-params-numeric-validations.md`. PR [#1902](https://github.com/khulnasoft/readyapi/pull/1902) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/python-types.md`. PR [#1899](https://github.com/khulnasoft/readyapi/pull/1899) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/handling-errors.md`. PR [#1953](https://github.com/khulnasoft/readyapi/pull/1953) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/response-status-code.md`. PR [#1942](https://github.com/khulnasoft/readyapi/pull/1942) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/extra-models.md`. PR [#1941](https://github.com/khulnasoft/readyapi/pull/1941) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese tranlsation for `docs/ja/docs/tutorial/schema-extra-example.md`. PR [#1931](https://github.com/khulnasoft/readyapi/pull/1931) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/body-nested-models.md`. PR [#1930](https://github.com/khulnasoft/readyapi/pull/1930) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for `docs/ja/docs/tutorial/body-fields.md`. PR [#1923](https://github.com/khulnasoft/readyapi/pull/1923) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add German translation for `docs/de/docs/tutorial/index.md`. PR [#9502](https://github.com/khulnasoft/readyapi/pull/9502) by [@fhabers21](https://github.com/fhabers21).
* 🌐 Add German translation for `docs/de/docs/tutorial/background-tasks.md`. PR [#10566](https://github.com/khulnasoft/readyapi/pull/10566) by [@nilslindemann](https://github.com/nilslindemann).
* ✏️ Fix typo in `docs/ru/docs/index.md`. PR [#10672](https://github.com/khulnasoft/readyapi/pull/10672) by [@Delitel-WEB](https://github.com/Delitel-WEB).
* ✏️ Fix typos in `docs/zh/docs/tutorial/extra-data-types.md`. PR [#10727](https://github.com/khulnasoft/readyapi/pull/10727) by [@HiemalBeryl](https://github.com/HiemalBeryl).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/dependencies/classes-as-dependencies.md`. PR [#10410](https://github.com/khulnasoft/readyapi/pull/10410) by [@AlertRED](https://github.com/AlertRED).
...
* 🔧 Update sponsors: TalkPython badge image. PR [#11048](https://github.com/khulnasoft/readyapi/pull/11048) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, remove Deta. PR [#11041](https://github.com/khulnasoft/readyapi/pull/11041) by [@khulnasoft](https://github.com/khulnasoft).
* 💄 Fix CSS breaking RTL languages (erroneously introduced by a previous RTL PR). PR [#11039](https://github.com/khulnasoft/readyapi/pull/11039) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Add Italian to `mkdocs.yml`. PR [#11016](https://github.com/khulnasoft/readyapi/pull/11016) by [@alejsdev](https://github.com/alejsdev).
* 🔨 Verify `mkdocs.yml` languages in CI, update `docs.py`. PR [#11009](https://github.com/khulnasoft/readyapi/pull/11009) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update config in `label-approved.yml` to accept translations with 1 reviewer. PR [#11007](https://github.com/khulnasoft/readyapi/pull/11007) by [@alejsdev](https://github.com/alejsdev).
* 👷 Add changes-requested handling in GitHub Action issue manager. PR [#10971](https://github.com/khulnasoft/readyapi/pull/10971) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧  Group dependencies on dependabot updates. PR [#10952](https://github.com/khulnasoft/readyapi/pull/10952) by [@Kludex](https://github.com/Kludex).
* ⬆ Bump actions/setup-python from 4 to 5. PR [#10764](https://github.com/khulnasoft/readyapi/pull/10764) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump pypa/gh-action-pypi-publish from 1.8.10 to 1.8.11. PR [#10731](https://github.com/khulnasoft/readyapi/pull/10731) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump dawidd6/action-download-artifact from 2.28.0 to 3.0.0. PR [#10777](https://github.com/khulnasoft/readyapi/pull/10777) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 🔧  Add support for translations to languages with a longer code name, like `zh-hant`. PR [#10950](https://github.com/khulnasoft/readyapi/pull/10950) by [@khulnasoft](https://github.com/khulnasoft).

## 0.109.0

### Features

* ✨ Add support for Python 3.12. PR [#10666](https://github.com/khulnasoft/readyapi/pull/10666) by [@Jamim](https://github.com/Jamim).

### Upgrades

* ⬆️ Upgrade Starlette to >=0.35.0,<0.36.0. PR [#10938](https://github.com/khulnasoft/readyapi/pull/10938) by [@khulnasoft](https://github.com/khulnasoft).
...
* 🌐 Add Bengali translation for `docs/bn/docs/index.md`. PR [#9177](https://github.com/khulnasoft/readyapi/pull/9177) by [@Fahad-Md-Kamal](https://github.com/Fahad-Md-Kamal).
* ✏️ Update Python version in `index.md` in several languages. PR [#10711](https://github.com/khulnasoft/readyapi/pull/10711) by [@tamago3keran](https://github.com/tamago3keran).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/request-forms-and-files.md`. PR [#10347](https://github.com/khulnasoft/readyapi/pull/10347) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Ukrainian translation for `docs/uk/docs/index.md`. PR [#10362](https://github.com/khulnasoft/readyapi/pull/10362) by [@rostik1410](https://github.com/rostik1410).
* ✏️  Update Python version in `docs/ko/docs/index.md`. PR [#10680](https://github.com/khulnasoft/readyapi/pull/10680) by [@Eeap](https://github.com/Eeap).
* 🌐 Add Persian translation for `docs/fa/docs/features.md`. PR [#5887](https://github.com/khulnasoft/readyapi/pull/5887) by [@amirilf](https://github.com/amirilf).
* 🌐 Add Chinese translation for `docs/zh/docs/advanced/additional-responses.md`. PR [#10325](https://github.com/khulnasoft/readyapi/pull/10325) by [@ShuibeiC](https://github.com/ShuibeiC).
* 🌐 Fix typos in Russian translations for `docs/ru/docs/tutorial/background-tasks.md`, `docs/ru/docs/tutorial/body-nested-models.md`, `docs/ru/docs/tutorial/debugging.md`, `docs/ru/docs/tutorial/testing.md`. PR [#10311](https://github.com/khulnasoft/readyapi/pull/10311) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/request-files.md`. PR [#10332](https://github.com/khulnasoft/readyapi/pull/10332) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/server-workers.md`. PR [#10292](https://github.com/khulnasoft/readyapi/pull/10292) by [@xzmeng](https://github.com/xzmeng).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/cloud.md`. PR [#10291](https://github.com/khulnasoft/readyapi/pull/10291) by [@xzmeng](https://github.com/xzmeng).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/manually.md`. PR [#10279](https://github.com/khulnasoft/readyapi/pull/10279) by [@xzmeng](https://github.com/xzmeng).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/https.md`. PR [#10277](https://github.com/khulnasoft/readyapi/pull/10277) by [@xzmeng](https://github.com/xzmeng).
* 🌐 Add Chinese translation for `docs/zh/docs/deployment/index.md`. PR [#10275](https://github.com/khulnasoft/readyapi/pull/10275) by [@xzmeng](https://github.com/xzmeng).
* 🌐 Add German translation for `docs/de/docs/tutorial/first-steps.md`. PR [#9530](https://github.com/khulnasoft/readyapi/pull/9530) by [@fhabers21](https://github.com/fhabers21).
* 🌐 Update Turkish translation for `docs/tr/docs/index.md`. PR [#10444](https://github.com/khulnasoft/readyapi/pull/10444) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Chinese translation for `docs/zh/docs/learn/index.md`. PR [#10479](https://github.com/khulnasoft/readyapi/pull/10479) by [@KAZAMA-DREAM](https://github.com/KAZAMA-DREAM).
* 🌐 Add Russian translation for `docs/ru/docs/learn/index.md`. PR [#10539](https://github.com/khulnasoft/readyapi/pull/10539) by [@AlertRED](https://github.com/AlertRED).
* 🌐 Update SQLAlchemy instruction in Chinese translation `docs/zh/docs/tutorial/sql-databases.md`. PR [#9712](https://github.com/khulnasoft/readyapi/pull/9712) by [@Royc30ne](https://github.com/Royc30ne).
* 🌐 Add Turkish translation for `docs/tr/docs/external-links.md`. PR [#10549](https://github.com/khulnasoft/readyapi/pull/10549) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Spanish translation for `docs/es/docs/learn/index.md`. PR [#10885](https://github.com/khulnasoft/readyapi/pull/10885) by [@pablocm83](https://github.com/pablocm83).
* 🌐 Add Ukrainian translation for `docs/uk/docs/tutorial/body-fields.md`. PR [#10670](https://github.com/khulnasoft/readyapi/pull/10670) by [@ArtemKhymenko](https://github.com/ArtemKhymenko).
* 🌐 Add Hungarian translation for `/docs/hu/docs/index.md`. PR [#10812](https://github.com/khulnasoft/readyapi/pull/10812) by [@takacs](https://github.com/takacs).
* 🌐 Add Turkish translation for `docs/tr/docs/newsletter.md`. PR [#10550](https://github.com/khulnasoft/readyapi/pull/10550) by [@hasansezertasan](https://github.com/hasansezertasan).
* 🌐 Add Spanish translation for `docs/es/docs/help/index.md`. PR [#10907](https://github.com/khulnasoft/readyapi/pull/10907) by [@pablocm83](https://github.com/pablocm83).
* 🌐 Add Spanish translation for `docs/es/docs/about/index.md`. PR [#10908](https://github.com/khulnasoft/readyapi/pull/10908) by [@pablocm83](https://github.com/pablocm83).
* 🌐 Add Spanish translation for `docs/es/docs/resources/index.md`. PR [#10909](https://github.com/khulnasoft/readyapi/pull/10909) by [@pablocm83](https://github.com/pablocm83).
...
* ⬆️ Upgrade GitHub Action label-approved. PR [#10905](https://github.com/khulnasoft/readyapi/pull/10905) by [@khulnasoft](https://github.com/khulnasoft).

## 0.108.0

### Upgrades

* ⬆️ Upgrade Starlette to `>=0.29.0,<0.33.0`, update docs and usage of templates with new Starlette arguments. Remove pin of AnyIO `>=3.7.1,<4.0.0`, add support for AnyIO 4.x.x. PR [#10846](https://github.com/khulnasoft/readyapi/pull/10846) by [@khulnasoft](https://github.com/khulnasoft).

## 0.107.0

### Upgrades

* ⬆️ Upgrade Starlette to 0.28.0. PR [#9636](https://github.com/khulnasoft/readyapi/pull/9636) by [@adriangb](https://github.com/adriangb).

### Docs

* 📝 Add docs: Node.js script alternative to update OpenAPI for generated clients. PR [#10845](https://github.com/khulnasoft/readyapi/pull/10845) by [@alejsdev](https://github.com/alejsdev).
* 📝 Restructure Docs section in Contributing page. PR [#10844](https://github.com/khulnasoft/readyapi/pull/10844) by [@alejsdev](https://github.com/alejsdev).
...
Read the new docs here: [Dependencies with `yield` and `HTTPException`](https://readyapi.github.io/tutorial/dependencies/dependencies-with-yield/#dependencies-with-yield-and-httpexception).
...
Before ReadyAPI 0.106.0, raising exceptions after `yield` was not possible, the exit code in dependencies with `yield` was executed *after* the response was sent, so [Exception Handlers](https://readyapi.github.io/tutorial/handling-errors/#install-custom-exception-handlers) would have already run.
...
The new execution flow can be found in the docs: [Execution of dependencies with `yield`](https://readyapi.github.io/tutorial/dependencies/dependencies-with-yield/#execution-of-dependencies-with-yield).

### Features

* ✨ Add support for raising exceptions (including `HTTPException`) in dependencies with `yield` in the exit code, do not support them in background tasks. PR [#10831](https://github.com/khulnasoft/readyapi/pull/10831) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✨ Add support for multiple Annotated annotations, e.g. `Annotated[str, Field(), Query()]`. PR [#10773](https://github.com/khulnasoft/readyapi/pull/10773) by [@khulnasoft](https://github.com/khulnasoft).

### Refactors

* 🔥 Remove unused NoneType. PR [#10774](https://github.com/khulnasoft/readyapi/pull/10774) by [@khulnasoft](https://github.com/khulnasoft).

### Docs

* 📝 Tweak default suggested configs for generating clients. PR [#10736](https://github.com/khulnasoft/readyapi/pull/10736) by [@khulnasoft](https://github.com/khulnasoft).

### Internal

* 🔧 Update sponsors, add Scalar. PR [#10728](https://github.com/khulnasoft/readyapi/pull/10728) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, add PropelAuth. PR [#10760](https://github.com/khulnasoft/readyapi/pull/10760) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update build docs, verify README on CI. PR [#10750](https://github.com/khulnasoft/readyapi/pull/10750) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, remove Fern. PR [#10729](https://github.com/khulnasoft/readyapi/pull/10729) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, add Codacy. PR [#10677](https://github.com/khulnasoft/readyapi/pull/10677) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, add Reflex. PR [#10676](https://github.com/khulnasoft/readyapi/pull/10676) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Update release notes, move and check latest-changes. PR [#10588](https://github.com/khulnasoft/readyapi/pull/10588) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Upgrade latest-changes GitHub Action. PR [#10587](https://github.com/khulnasoft/readyapi/pull/10587) by [@khulnasoft](https://github.com/khulnasoft).
...
* 📝 Update data structure and render for external-links. PR [#10495](https://github.com/khulnasoft/readyapi/pull/10495) by [@khulnasoft](https://github.com/khulnasoft).
* ✏️ Fix link to SPDX license identifier in `docs/en/docs/tutorial/metadata.md`. PR [#10433](https://github.com/khulnasoft/readyapi/pull/10433) by [@worldworm](https://github.com/worldworm).
* 📝 Update example validation error from Pydantic v1 to match Pydantic v2 in `docs/en/docs/tutorial/path-params.md`. PR [#10043](https://github.com/khulnasoft/readyapi/pull/10043) by [@giuliowaitforitdavide](https://github.com/giuliowaitforitdavide).
* ✏️ Fix typos in emoji docs and in some source examples. PR [#10438](https://github.com/khulnasoft/readyapi/pull/10438) by [@afuetterer](https://github.com/afuetterer).
* ✏️ Fix typo in `docs/en/docs/reference/dependencies.md`. PR [#10465](https://github.com/khulnasoft/readyapi/pull/10465) by [@suravshresth](https://github.com/suravshresth).
* ✏️ Fix typos and rewordings in `docs/en/docs/tutorial/body-nested-models.md`. PR [#10468](https://github.com/khulnasoft/readyapi/pull/10468) by [@yogabonito](https://github.com/yogabonito).
* 📝 Update docs, remove references to removed `pydantic.Required` in `docs/en/docs/tutorial/query-params-str-validations.md`. PR [#10469](https://github.com/khulnasoft/readyapi/pull/10469) by [@yogabonito](https://github.com/yogabonito).
* ✏️ Fix typo in `docs/en/docs/reference/index.md`. PR [#10467](https://github.com/khulnasoft/readyapi/pull/10467) by [@tarsil](https://github.com/tarsil).
* 🔥 Remove unnecessary duplicated docstrings. PR [#10484](https://github.com/khulnasoft/readyapi/pull/10484) by [@khulnasoft](https://github.com/khulnasoft).

### Internal

* ✏️ Update Pydantic links to dotenv support. PR [#10511](https://github.com/khulnasoft/readyapi/pull/10511) by [@White-Mask](https://github.com/White-Mask).
* ✏️ Update links in `docs/en/docs/async.md` and `docs/zh/docs/async.md` to make them relative. PR [#10498](https://github.com/khulnasoft/readyapi/pull/10498) by [@hasnatsajid](https://github.com/hasnatsajid).
* ✏️ Fix links in `docs/em/docs/async.md`. PR [#10507](https://github.com/khulnasoft/readyapi/pull/10507) by [@hasnatsajid](https://github.com/hasnatsajid).
* ✏️ Fix typo in `docs/em/docs/index.md`, Python 3.8. PR [#10521](https://github.com/khulnasoft/readyapi/pull/10521) by [@kerriop](https://github.com/kerriop).
* ⬆ Bump pillow from 9.5.0 to 10.1.0. PR [#10446](https://github.com/khulnasoft/readyapi/pull/10446) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Update mkdocs-material requirement from <9.0.0,>=8.1.4 to >=8.1.4,<10.0.0. PR [#5862](https://github.com/khulnasoft/readyapi/pull/5862) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump mkdocs-material from 9.1.21 to 9.4.7. PR [#10545](https://github.com/khulnasoft/readyapi/pull/10545) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Install MkDocs Material Insiders only when secrets are available, for Dependabot. PR [#10544](https://github.com/khulnasoft/readyapi/pull/10544) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors badges, Databento. PR [#10519](https://github.com/khulnasoft/readyapi/pull/10519) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Adopt Ruff format. PR [#10517](https://github.com/khulnasoft/readyapi/pull/10517) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Add `CITATION.cff` file for academic citations. PR [#10496](https://github.com/khulnasoft/readyapi/pull/10496) by [@khulnasoft](https://github.com/khulnasoft).
* 🐛 Fix overriding MKDocs theme lang in hook. PR [#10490](https://github.com/khulnasoft/readyapi/pull/10490) by [@khulnasoft](https://github.com/khulnasoft).
* 🔥 Drop/close Gitter chat. Questions should go to GitHub Discussions, free conversations to Discord.. PR [#10485](https://github.com/khulnasoft/readyapi/pull/10485) by [@khulnasoft](https://github.com/khulnasoft).

## 0.104.0

## Features

* ✨ Add reference (code API) docs with PEP 727, add subclass with custom docstrings for `BackgroundTasks`, refactor docs structure. PR [#10392](https://github.com/khulnasoft/readyapi/pull/10392) by [@khulnasoft](https://github.com/khulnasoft). New docs at [ReadyAPI Reference - Code API](https://readyapi.github.io/reference/).

## Upgrades

* ⬆️ Drop support for Python 3.7, require Python 3.8 or above. PR [#10442](https://github.com/khulnasoft/readyapi/pull/10442) by [@khulnasoft](https://github.com/khulnasoft).

### Internal

* ⬆ Bump dawidd6/action-download-artifact from 2.27.0 to 2.28.0. PR [#10268](https://github.com/khulnasoft/readyapi/pull/10268) by [@dependabot[bot]](https://github.com/apps/dependabot).
...
* ✨ Add support for `openapi_examples` in all ReadyAPI parameters. PR [#10152](https://github.com/khulnasoft/readyapi/pull/10152) by [@khulnasoft](https://github.com/khulnasoft).
    * New docs: [OpenAPI-specific examples](https://readyapi.github.io/tutorial/schema-extra-example/#openapi-specific-examples).
...
* ✨ Add support for disabling the separation of input and output JSON Schemas in OpenAPI with Pydantic v2 with `separate_input_output_schemas=False`. PR [#10145](https://github.com/khulnasoft/readyapi/pull/10145) by [@khulnasoft](https://github.com/khulnasoft).
    * New docs [Separate OpenAPI Schemas for Input and Output or Not](https://readyapi.github.io/how-to/separate-openapi-schemas/).
...
* 🔧 Update sponsors, add Speakeasy. PR [#10098](https://github.com/khulnasoft/readyapi/pull/10098) by [@khulnasoft](https://github.com/khulnasoft).
...
* 👷 Update CI debug mode with Tmate. PR [#9977](https://github.com/khulnasoft/readyapi/pull/9977) by [@khulnasoft](https://github.com/khulnasoft).
...
* The parameter `regex` has been deprecated and replaced by `pattern`.
    * You can read more about it in the docs for [Query Parameters and String Validations: Add regular expressions](https://readyapi.github.io/tutorial/query-params-str-validations/#add-regular-expressions).
* New Pydantic models use an improved and simplified attribute `model_config` that takes a simple dict instead of an internal class `Config` for their configuration.
    * You can read more about it in the docs for [Declare Request Example Data](https://readyapi.github.io/tutorial/schema-extra-example/).
...
* Now Pydantic Settings is an additional optional package (included in `"readyapi[all]"`). To use settings you should now import `from pydantic_settings import BaseSettings` instead of importing from `pydantic` directly.
    * You can read more about it in the docs for [Settings and Environment Variables](https://readyapi.github.io/advanced/settings/).
...
* ✨ Add support for OpenAPI 3.1.0. PR [#9770](https://github.com/khulnasoft/readyapi/pull/9770) by [@khulnasoft](https://github.com/khulnasoft).
    * New support for documenting **webhooks**, read the new docs here: <a href="https://readyapi.github.io/advanced/openapi-webhooks/" class="external-link" target="_blank">Advanced User Guide: OpenAPI Webhooks</a>.
    * Upgrade OpenAPI 3.1.0, this uses JSON Schema 2020-12.
    * Upgrade Swagger UI to version 5.x.x, that supports OpenAPI 3.1.0.
    * Updated `examples` field in `Query()`, `Cookie()`, `Body()`, etc. based on the latest JSON Schema and OpenAPI. Now it takes a list of examples and they are included directly in the JSON Schema, not outside. Read more about it (including the historical technical details) in the updated docs: <a href="https://readyapi.github.io/tutorial/schema-extra-example/" class="external-link" target="_blank">Tutorial: Declare Request Example Data</a>.
...
* ⬆️ Upgrade MkDocs and MkDocs Material. PR [#9729](https://github.com/khulnasoft/readyapi/pull/9729) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✏ Fix typo/bug in inline code example in `docs/en/docs/tutorial/query-params-str-validations.md`. PR [#9273](https://github.com/khulnasoft/readyapi/pull/9273) by [@tim-habitat](https://github.com/tim-habitat).
...
* Python Types Intro:
    * [Type Hints with Metadata Annotations](https://readyapi.github.io/python-types/#type-hints-with-metadata-annotations).
* Tutorial:
    * [Query Parameters and String Validations - Additional validation](https://readyapi.github.io/tutorial/query-params-str-validations/#additional-validation)
        * [Advantages of `Annotated`](https://readyapi.github.io/tutorial/query-params-str-validations/#advantages-of-annotated)
    * [Path Parameters and Numeric Validations - Order the parameters as you need, tricks](https://readyapi.github.io/tutorial/path-params-numeric-validations/#order-the-parameters-as-you-need-tricks)
        * [Better with `Annotated`](https://readyapi.github.io/tutorial/path-params-numeric-validations/#better-with-annotated)
    * [Dependencies - First Steps - Share `Annotated` dependencies](https://readyapi.github.io/tutorial/dependencies/#share-annotated-dependencies)
...
Read more about it in the new docs: [Advanced User Guide: Lifespan Events](https://readyapi.github.io/advanced/events/).
...
* 📝 Update docs and examples for Response Model with Return Type Annotations, and update runtime error. PR [#5873](https://github.com/khulnasoft/readyapi/pull/5873) by [@khulnasoft](https://github.com/khulnasoft). New docs at [Response Model - Return Type: Other Return Type Annotations](https://readyapi.github.io/tutorial/response-model/#other-return-type-annotations).
...
Read more about it in the new docs: [Response Model - Return Type](https://readyapi.github.io/tutorial/response-model/).
...
* New [WebSocketException (and docs)](https://readyapi.github.io/advanced/websockets/#using-depends-and-others), re-exported from Starlette.
* Upgraded and relaxed dependencies for package extras `all` (including new Uvicorn version), when you install `"readyapi[all]"`.
* New docs about how to [**Help Maintain ReadyAPI**](https://readyapi.github.io/help-readyapi/#help-maintain-readyapi).
...
* 🌐 Add French translation for `docs/fr/docs/help-readyapi.md`. PR [#2233](https://github.com/khulnasoft/readyapi/pull/2233) by [@JulianMaurin](https://github.com/JulianMaurin).
...
* ⬆️ Upgrade Cligenius to include Rich in scripts for docs. PR [#5502](https://github.com/khulnasoft/readyapi/pull/5502) by [@khulnasoft](https://github.com/khulnasoft).
...
* ⬆️ Upgrade dependencies for doc and dev internal extras: Cligenius, Uvicorn. PR [#5400](https://github.com/khulnasoft/readyapi/pull/5400) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✨ Preserve `json.JSONDecodeError` information when handling invalid JSON in request body, to support custom exception handlers that use its information. PR [#4057](https://github.com/khulnasoft/readyapi/pull/4057) by [@UKnowWhoIm](https://github.com/UKnowWhoIm).

### Fixes

* 🐛 Fix `jsonable_encoder` for dataclasses with pydantic-compatible fields. PR [#3607](https://github.com/khulnasoft/readyapi/pull/3607) by [@himbeles](https://github.com/himbeles).
* 🐛 Fix support for extending `openapi_extras` with parameter lists. PR [#4267](https://github.com/khulnasoft/readyapi/pull/4267) by [@orilevari](https://github.com/orilevari).

### Docs

* ✏ Fix a simple typo in `docs/en/docs/python-types.md`. PR [#5193](https://github.com/khulnasoft/readyapi/pull/5193) by [@GlitchingCore](https://github.com/GlitchingCore).
* ✏ Fix typos in `tests/test_schema_extra_examples.py`. PR [#5126](https://github.com/khulnasoft/readyapi/pull/5126) by [@supraaxdd](https://github.com/supraaxdd).
* ✏ Fix typos in `docs/en/docs/tutorial/path-params-numeric-validations.md`. PR [#5142](https://github.com/khulnasoft/readyapi/pull/5142) by [@invisibleroads](https://github.com/invisibleroads).
* 📝 Add step about upgrading pip in the venv to avoid errors when installing dependencies `docs/en/docs/contributing.md`. PR [#5181](https://github.com/khulnasoft/readyapi/pull/5181) by [@edisnake](https://github.com/edisnake).
...
* 🎨 Fix syntax highlighting in docs for OpenAPI Callbacks. PR [#4368](https://github.com/khulnasoft/readyapi/pull/4368) by [@xncbf](https://github.com/xncbf).
* ✏ Reword confusing sentence in docs file `typo-fix-path-params-numeric-validations.md`. PR [#3219](https://github.com/khulnasoft/readyapi/pull/3219) by [@ccrenfroe](https://github.com/ccrenfroe).
* 📝 Update docs for handling HTTP Basic Auth with `secrets.compare_digest()` to account for non-ASCII characters. PR [#3536](https://github.com/khulnasoft/readyapi/pull/3536) by [@lewoudar](https://github.com/lewoudar).
* 📝 Update docs for testing, fix examples with relative imports. PR [#5302](https://github.com/khulnasoft/readyapi/pull/5302) by [@khulnasoft](https://github.com/khulnasoft).

### Translations

* 🌐 Add Russian translation for `docs/ru/docs/index.md`. PR [#5289](https://github.com/khulnasoft/readyapi/pull/5289) by [@impocode](https://github.com/impocode).
* 🌐 Add Russian translation for `docs/ru/docs/deployment/versions.md`. PR [#4985](https://github.com/khulnasoft/readyapi/pull/4985) by [@emp7yhead](https://github.com/emp7yhead).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/header-params.md`. PR [#4921](https://github.com/khulnasoft/readyapi/pull/4921) by [@batlopes](https://github.com/batlopes).
* 🌐 Update `ko/mkdocs.yml` for a missing link. PR [#5020](https://github.com/khulnasoft/readyapi/pull/5020) by [@dalinaum](https://github.com/dalinaum).

### Internal

* ⬆ Bump dawidd6/action-download-artifact from 2.21.1 to 2.22.0. PR [#5258](https://github.com/khulnasoft/readyapi/pull/5258) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ [pre-commit.ci] pre-commit autoupdate. PR [#5196](https://github.com/khulnasoft/readyapi/pull/5196) by [@pre-commit-ci[bot]](https://github.com/apps/pre-commit-ci).
* 🔥 Delete duplicated tests in `tests/test_tutorial/test_sql_databases/test_sql_databases.py`. PR [#5040](https://github.com/khulnasoft/readyapi/pull/5040) by [@raccoonyy](https://github.com/raccoonyy).
* ♻ Simplify internal RegEx in `readyapi/utils.py`. PR [#5057](https://github.com/khulnasoft/readyapi/pull/5057) by [@pylounge](https://github.com/pylounge).
* 🔧 Fix Type hint of `auto_error` which does not need to be `Optional[bool]`. PR [#4933](https://github.com/khulnasoft/readyapi/pull/4933) by [@DavidKimDY](https://github.com/DavidKimDY).
* 🔧 Update mypy config, use `strict = true` instead of manual configs. PR [#4605](https://github.com/khulnasoft/readyapi/pull/4605) by [@michaeloliverx](https://github.com/michaeloliverx).
* ♻ Change a `dict()` for `{}` in `readyapi/utils.py`. PR [#3138](https://github.com/khulnasoft/readyapi/pull/3138) by [@ShahriyarR](https://github.com/ShahriyarR).
* ♻ Move internal variable for errors in `jsonable_encoder` to put related code closer. PR [#4560](https://github.com/khulnasoft/readyapi/pull/4560) by [@GuilleQP](https://github.com/GuilleQP).
* ♻ Simplify conditional assignment in `readyapi/dependencies/utils.py`. PR [#4597](https://github.com/khulnasoft/readyapi/pull/4597) by [@cikay](https://github.com/cikay).
* ⬆ Upgrade version pin accepted for Flake8, for internal code, to `flake8 >=3.8.3,<6.0.0`. PR [#4097](https://github.com/khulnasoft/readyapi/pull/4097) by [@jamescurtin](https://github.com/jamescurtin).
* 🍱 Update Jina banner, fix typo. PR [#5301](https://github.com/khulnasoft/readyapi/pull/5301) by [@khulnasoft](https://github.com/khulnasoft).

## 0.80.0

### Breaking Changes - Fixes

* 🐛 Fix `response_model` not invalidating `None`. PR [#2725](https://github.com/khulnasoft/readyapi/pull/2725) by [@hukkin](https://github.com/hukkin).
...
* ⬆ Upgrade Swagger UI copy of `oauth2-redirect.html` to include fixes for flavors of authorization code flows in Swagger UI. PR [#3439](https://github.com/khulnasoft/readyapi/pull/3439) initial PR by [@koonpeng](https://github.com/koonpeng).
* ♻ Strip empty whitespace from description extracted from docstrings. PR [#2821](https://github.com/khulnasoft/readyapi/pull/2821) by [@and-semakin](https://github.com/and-semakin).
* 🐛 Fix cached dependencies when using a dependency in `Security()` and other places (e.g. `Depends()`) with different OAuth2 scopes. PR [#2945](https://github.com/khulnasoft/readyapi/pull/2945) by [@laggardkernel](https://github.com/laggardkernel).
* 🎨 Update type annotations for `response_model`, allow things like `Union[str, None]`. PR [#5294](https://github.com/khulnasoft/readyapi/pull/5294) by [@khulnasoft](https://github.com/khulnasoft).

### Translations

* 🌐 Fix typos in German translation for `docs/de/docs/features.md`. PR [#4533](https://github.com/khulnasoft/readyapi/pull/4533) by [@0xflotus](https://github.com/0xflotus).
* 🌐 Add missing navigator for `encoder.md` in Korean translation. PR [#5238](https://github.com/khulnasoft/readyapi/pull/5238) by [@joonas-yoon](https://github.com/joonas-yoon).
* (Empty PR merge by accident) [#4913](https://github.com/khulnasoft/readyapi/pull/4913).

## 0.79.1

### Fixes

* 🐛 Fix `jsonable_encoder` using `include` and `exclude` parameters for non-Pydantic objects. PR [#2606](https://github.com/khulnasoft/readyapi/pull/2606) by [@xaviml](https://github.com/xaviml).
* 🐛 Fix edge case with repeated aliases names not shown in OpenAPI. PR [#2351](https://github.com/khulnasoft/readyapi/pull/2351) by [@klaa97](https://github.com/klaa97).
* 📝 Add misc dependency installs to tutorial docs. PR [#2126](https://github.com/khulnasoft/readyapi/pull/2126) by [@TeoZosa](https://github.com/TeoZosa).

### Docs

* 📝 Add note giving credit for illustrations to [Ketrina Thompson](https://www.instagram.com/ketrinadrawsalot/). PR [#5284](https://github.com/khulnasoft/readyapi/pull/5284) by [@khulnasoft](https://github.com/khulnasoft).
* ✏ Fix typo in `python-types.md`. PR [#5116](https://github.com/khulnasoft/readyapi/pull/5116) by [@Kludex](https://github.com/Kludex).
* ✏ Fix typo in `docs/en/docs/python-types.md`. PR [#5007](https://github.com/khulnasoft/readyapi/pull/5007) by [@atiabbz](https://github.com/atiabbz).
* 📝 Remove unneeded Django/Flask references from async topic intro. PR [#5280](https://github.com/khulnasoft/readyapi/pull/5280) by [@carltongibson](https://github.com/carltongibson).
* ✨ Add illustrations for Concurrent burgers and Parallel burgers. PR [#5277](https://github.com/khulnasoft/readyapi/pull/5277) by [@khulnasoft](https://github.com/khulnasoft). Updated docs at: [Concurrency and Burgers](https://readyapi.github.io/async/#concurrency-and-burgers).

### Translations

* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/query-params.md`. PR [#4775](https://github.com/khulnasoft/readyapi/pull/4775) by [@batlopes](https://github.com/batlopes).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/security/first-steps.md`. PR [#4954](https://github.com/khulnasoft/readyapi/pull/4954) by [@FLAIR7](https://github.com/FLAIR7).
* 🌐 Add translation for `docs/zh/docs/advanced/response-cookies.md`. PR [#4638](https://github.com/khulnasoft/readyapi/pull/4638) by [@zhangbo2012](https://github.com/zhangbo2012).
* 🌐  Add French translation for `docs/fr/docs/deployment/index.md`. PR [#3689](https://github.com/khulnasoft/readyapi/pull/3689) by [@rjNemo](https://github.com/rjNemo).
* 🌐 Add Portuguese translation for `tutorial/handling-errors.md`. PR [#4769](https://github.com/khulnasoft/readyapi/pull/4769) by [@frnsimoes](https://github.com/frnsimoes).
* 🌐 Add French translation for `docs/fr/docs/history-design-future.md`. PR [#3451](https://github.com/khulnasoft/readyapi/pull/3451) by [@rjNemo](https://github.com/rjNemo).
* 🌐 Add Russian translation for `docs/ru/docs/tutorial/background-tasks.md`. PR [#4854](https://github.com/khulnasoft/readyapi/pull/4854) by [@AdmiralDesu](https://github.com/AdmiralDesu).
* 🌐 Add Chinese translation for `docs/tutorial/security/first-steps.md`. PR [#3841](https://github.com/khulnasoft/readyapi/pull/3841) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Japanese translation for `docs/ja/docs/advanced/nosql-databases.md`. PR [#4205](https://github.com/khulnasoft/readyapi/pull/4205) by [@sUeharaE4](https://github.com/sUeharaE4).
* 🌐 Add Indonesian translation for `docs/id/docs/tutorial/index.md`. PR [#4705](https://github.com/khulnasoft/readyapi/pull/4705) by [@bas-baskara](https://github.com/bas-baskara).
* 🌐 Add Persian translation for `docs/fa/docs/index.md` and tweak right-to-left CSS. PR [#2395](https://github.com/khulnasoft/readyapi/pull/2395) by [@mohsen-mahmoodi](https://github.com/mohsen-mahmoodi).

### Internal

* 🔧 Update Jina sponsorship. PR [#5283](https://github.com/khulnasoft/readyapi/pull/5283) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update Jina sponsorship. PR [#5272](https://github.com/khulnasoft/readyapi/pull/5272) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, Striveworks badge. PR [#5179](https://github.com/khulnasoft/readyapi/pull/5179) by [@khulnasoft](https://github.com/khulnasoft).

## 0.79.0

### Fixes - Breaking Changes

* 🐛 Fix removing body from status codes that do not support it. PR [#5145](https://github.com/khulnasoft/readyapi/pull/5145) by [@khulnasoft](https://github.com/khulnasoft).
    ...
    * This removes `readyapi.openapi.constants.STATUS_CODES_WITH_NO_BODY`, it is replaced by a function in utils.

### Translations

* 🌐 Start of Hebrew translation. PR [#5050](https://github.com/khulnasoft/readyapi/pull/5050) by [@itay-raveh](https://github.com/itay-raveh).
* 🔧 Add config for Swedish translations notification. PR [#5147](https://github.com/khulnasoft/readyapi/pull/5147) by [@khulnasoft](https://github.com/khulnasoft).
* 🌐 Start of Swedish translation. PR [#5062](https://github.com/khulnasoft/readyapi/pull/5062) by [@MrRawbin](https://github.com/MrRawbin).
* 🌐 Add Japanese translation for `docs/ja/docs/advanced/index.md`. PR [#5043](https://github.com/khulnasoft/readyapi/pull/5043) by [@wakabame](https://github.com/wakabame).
* 🌐🇵🇱 Add Polish translation for `docs/pl/docs/tutorial/first-steps.md`. PR [#5024](https://github.com/khulnasoft/readyapi/pull/5024) by [@Valaraucoo](https://github.com/Valaraucoo).

### Internal

* 🔧 Update translations notification for Hebrew. PR [#5158](https://github.com/khulnasoft/readyapi/pull/5158) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update Dependabot commit message. PR [#5156](https://github.com/khulnasoft/readyapi/pull/5156) by [@khulnasoft](https://github.com/khulnasoft).
...
* ⬆ Bump nwtgck/actions-netlify from 1.1.5 to 1.2.3. PR [#5132](https://github.com/khulnasoft/readyapi/pull/5132) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump codecov/codecov-action from 2 to 3. PR [#5131](https://github.com/khulnasoft/readyapi/pull/5131) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump dawidd6/action-download-artifact from 2.9.0 to 2.21.1. PR [#5130](https://github.com/khulnasoft/readyapi/pull/5130) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump actions/setup-python from 2 to 4. PR [#5129](https://github.com/khulnasoft/readyapi/pull/5129) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Add Dependabot. PR [#5128](https://github.com/khulnasoft/readyapi/pull/5128) by [@khulnasoft](https://github.com/khulnasoft).
* ♻️ Move from `Optional[X]` to `Union[X, None]` for internal utils. PR [#5124](https://github.com/khulnasoft/readyapi/pull/5124) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, remove Dropbase, add Doist. PR [#5096](https://github.com/khulnasoft/readyapi/pull/5096) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update sponsors, remove Classiq, add ImgWhale. PR [#5079](https://github.com/khulnasoft/readyapi/pull/5079) by [@khulnasoft](https://github.com/khulnasoft).
...
New docs at [Tutorial - Query Parameters and String Validations - Make it required](https://readyapi.github.io/tutorial/query-params-str-validations/#make-it-required). PR [#4906](https://github.com/khulnasoft/readyapi/pull/4906) by [@khulnasoft](https://github.com/khulnasoft).
...
* 📝 Add docs recommending `Union` over `Optional` and migrate source examples. New docs at [Python Types Intro - Using `Union` or `Optional`](https://readyapi.github.io/python-types/#using-union-or-optional). PR [#4908](https://github.com/khulnasoft/readyapi/pull/4908) by [@khulnasoft](https://github.com/khulnasoft).
* 🎨 Fix default value as set in tutorial for Path Operations Advanced Configurations. PR [#4899](https://github.com/khulnasoft/readyapi/pull/4899) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Add documentation for redefined path operations. PR [#4864](https://github.com/khulnasoft/readyapi/pull/4864) by [@madkinsz](https://github.com/madkinsz).
* 📝 Updates links for Celery documentation. PR [#4736](https://github.com/khulnasoft/readyapi/pull/4736) by [@sammyzord](https://github.com/sammyzord).
...
* 🌐 Fix code examples in Japanese translation for `docs/ja/docs/tutorial/testing.md`. PR [#4623](https://github.com/khulnasoft/readyapi/pull/4623) by [@hirotoKirimaru](https://github.com/hirotoKirimaru).

### Internal

* ♻ Refactor dict value extraction to minimize key lookups `readyapi/utils.py`. PR [#3139](https://github.com/khulnasoft/readyapi/pull/3139) by [@ShahriyarR](https://github.com/ShahriyarR).
* ✅ Add tests for required nonable parameters and body fields. PR [#4907](https://github.com/khulnasoft/readyapi/pull/4907) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Fix installing Material for MkDocs Insiders in CI. PR [#4897](https://github.com/khulnasoft/readyapi/pull/4897) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add pre-commit CI instead of custom GitHub Action. PR [#4896](https://github.com/khulnasoft/readyapi/pull/4896) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add pre-commit GitHub Action workflow. PR [#4895](https://github.com/khulnasoft/readyapi/pull/4895) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Add dark mode auto switch to docs based on OS preference. PR [#4869](https://github.com/khulnasoft/readyapi/pull/4869) by [@ComicShrimp](https://github.com/ComicShrimp).
* 🔥 Remove un-used old pending tests, already covered in other places. PR [#4891](https://github.com/khulnasoft/readyapi/pull/4891) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Add Python formatting hooks to pre-commit. PR [#4890](https://github.com/khulnasoft/readyapi/pull/4890) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Add pre-commit with first config and first formatting pass. PR [#4888](https://github.com/khulnasoft/readyapi/pull/4888) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Disable CI installing Material for MkDocs in forks. PR [#4410](https://github.com/khulnasoft/readyapi/pull/4410) by [@dolfinus](https://github.com/dolfinus).

## 0.77.1

### Upgrades

* ⬆ Upgrade Starlette from 0.19.0 to 0.19.1. PR [#4819](https://github.com/khulnasoft/readyapi/pull/4819) by [@Kludex](https://github.com/Kludex).
...
* 🌐 Add Polish translation for `docs/pl/docs/tutorial/index.md`. PR [#4516](https://github.com/khulnasoft/readyapi/pull/4516) by [@MKaczkow](https://github.com/MKaczkow).
* ✏ Fix typo in deployment. PR [#4629](https://github.com/khulnasoft/readyapi/pull/4629) by [@raisulislam541](https://github.com/raisulislam541).
* 🌐 Add Portuguese translation for `docs/pt/docs/help-readyapi.md`. PR [#4583](https://github.com/khulnasoft/readyapi/pull/4583) by [@mateusjs](https://github.com/mateusjs).

### Internal

* 🔧 Add notifications in issue for Uzbek translations. PR [#4884](https://github.com/khulnasoft/readyapi/pull/4884) by [@khulnasoft](https://github.com/khulnasoft).

## 0.77.0

### Upgrades

* ⬆ Upgrade Starlette from 0.18.0 to 0.19.0. PR [#4488](https://github.com/khulnasoft/readyapi/pull/4488) by [@Kludex](https://github.com/Kludex).
...
* 🌐 Update source example highlights for `docs/zh/docs/tutorial/query-params-str-validations.md`. PR [#4237](https://github.com/khulnasoft/readyapi/pull/4237) by [@caimaoy](https://github.com/caimaoy).
* 🌐 Remove translation docs references to aiofiles as it's no longer needed since AnyIO. PR [#3594](https://github.com/khulnasoft/readyapi/pull/3594) by [@alonme](https://github.com/alonme).
* ✏ 🌐 Fix typo in Portuguese translation for `docs/pt/docs/tutorial/path-params.md`. PR [#4722](https://github.com/khulnasoft/readyapi/pull/4722) by [@CleoMenezesJr](https://github.com/CleoMenezesJr).
* 🌐 Fix live docs server for translations for some languages. PR [#4729](https://github.com/khulnasoft/readyapi/pull/4729) by [@wakabame](https://github.com/wakabame).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/cookie-params.md`. PR [#4112](https://github.com/khulnasoft/readyapi/pull/4112) by [@lbmendes](https://github.com/lbmendes).
* 🌐 Fix French translation for `docs/tutorial/body.md`. PR [#4332](https://github.com/khulnasoft/readyapi/pull/4332) by [@Smlep](https://github.com/Smlep).
* 🌐 Add Japanese translation for `docs/ja/docs/advanced/conditional-openapi.md`. PR [#2631](https://github.com/khulnasoft/readyapi/pull/2631) by [@sh0nk](https://github.com/sh0nk).
* 🌐 Fix Japanese translation of `docs/ja/docs/tutorial/body.md`. PR [#3062](https://github.com/khulnasoft/readyapi/pull/3062) by [@a-takahashi223](https://github.com/a-takahashi223).
* 🌐 Add Portuguese translation for `docs/pt/docs/tutorial/background-tasks.md`. PR [#2170](https://github.com/khulnasoft/readyapi/pull/2170) by [@izaguerreiro](https://github.com/izaguerreiro).
* 🌐 Add Portuguese translation for `docs/deployment/deta.md`. PR [#4442](https://github.com/khulnasoft/readyapi/pull/4442) by [@lsglucas](https://github.com/lsglucas).
* 🌐 Add Russian translation for `docs/async.md`. PR [#4036](https://github.com/khulnasoft/readyapi/pull/4036) by [@Winand](https://github.com/Winand).
* 🌐 Add Portuguese translation for `docs/tutorial/body.md`. PR [#3960](https://github.com/khulnasoft/readyapi/pull/3960) by [@leandrodesouzadev](https://github.com/leandrodesouzadev).
* 🌐 Add Portuguese translation of `tutorial/extra-data-types.md`. PR [#4077](https://github.com/khulnasoft/readyapi/pull/4077) by [@luccasmmg](https://github.com/luccasmmg).
* 🌐 Update German translation for `docs/features.md`. PR [#3905](https://github.com/khulnasoft/readyapi/pull/3905) by [@jomue](https://github.com/jomue).

## 0.76.0

### Upgrades

* ⬆ Upgrade Starlette from 0.17.1 to 0.18.0. PR [#4483](https://github.com/khulnasoft/readyapi/pull/4483) by [@Kludex](https://github.com/Kludex).
...
* ✅ Fix new/recent tests with new fixed `ValidationError` JSON Schema. PR [#4806](https://github.com/khulnasoft/readyapi/pull/4806) by [@khulnasoft](https://github.com/khulnasoft).
* 🐛 Fix JSON Schema for `ValidationError` at field `loc`. PR [#3810](https://github.com/khulnasoft/readyapi/pull/3810) by [@dconathan](https://github.com/dconathan).
* 🐛 Fix support for prefix on APIRouter WebSockets. PR [#2640](https://github.com/khulnasoft/readyapi/pull/2640) by [@Kludex](https://github.com/Kludex).

### Upgrades

* ⬆️ Update ujson ranges for CVE-2021-45958. PR [#4804](https://github.com/khulnasoft/readyapi/pull/4804) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Upgrade dependencies upper range for extras "all". PR [#4803](https://github.com/khulnasoft/readyapi/pull/4803) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆ Upgrade Swagger UI - swagger-ui-dist@4. This handles a security issue in Swagger UI itself where it could be possible to inject HTML into Swagger UI. Please upgrade as soon as you can, in particular if you expose your Swagger UI (`/docs`) publicly to non-expert users. PR [#4347](https://github.com/khulnasoft/readyapi/pull/4347) by [@RAlanWright](https://github.com/RAlanWright).

### Internal

* 🔧 Update sponsors, add: ExoFlare, Ines Course; remove: Dropbase, Vim.so, Calmcode; update: Striveworks, TalkPython and TestDriven.io. PR [#4805](https://github.com/khulnasoft/readyapi/pull/4805) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Upgrade Codecov GitHub Action. PR [#4801](https://github.com/khulnasoft/readyapi/pull/4801) by [@khulnasoft](https://github.com/khulnasoft).

## 0.75.1

### Translations

* 🌐 Start Dutch translations. PR [#4703](https://github.com/khulnasoft/readyapi/pull/4703) by [@khulnasoft](https://github.com/khulnasoft).
* 🌐 Start Persian/Farsi translations. PR [#4243](https://github.com/khulnasoft/readyapi/pull/4243) by [@aminalaee](https://github.com/aminalaee).
* ✏ Reword sentence about handling errors. PR [#1993](https://github.com/khulnasoft/readyapi/pull/1993) by [@khuhroproeza](https://github.com/khuhroproeza).
...
* ✨ Add support for custom `generate_unique_id_function` and docs for generating clients. New docs: [Advanced - Generate Clients](https://readyapi.github.io/advanced/generate-clients/). PR [#4650](https://github.com/khulnasoft/readyapi/pull/4650) by [@khulnasoft](https://github.com/khulnasoft).

## 0.74.1

### Features

* ✨ Include route in scope to allow middleware and other tools to extract its information. PR [#4603](https://github.com/khulnasoft/readyapi/pull/4603) by [@khulnasoft](https://github.com/khulnasoft).

## 0.74.0

### Breaking Changes

* ✨ Update internal `AsyncExitStack` to fix context for dependencies with `yield`. PR [#4575](https://github.com/khulnasoft/readyapi/pull/4575) by [@khulnasoft](https://github.com/khulnasoft).
...
* The same PR [#4575](https://github.com/khulnasoft/readyapi/pull/4575) from above also fixes the `contextvars` context for the code before and after `yield`. This was the main objective of that PR.
...
**Technical Details**: If you want to know more of the technical details you can check out the PR description [#4575](https://github.com/khulnasoft/readyapi/pull/4575).
...
* ✨ Add support for declaring `UploadFile` parameters without explicit `File()`. PR [#4469](https://github.com/khulnasoft/readyapi/pull/4469) by [@khulnasoft](https://github.com/khulnasoft). New docs: [Request Files - File Parameters with UploadFile](https://readyapi.github.io/tutorial/request-files/#file-parameters-with-uploadfile).
* ✨ Add support for tags with Enums. PR [#4468](https://github.com/khulnasoft/readyapi/pull/4468) by [@khulnasoft](https://github.com/khulnasoft). New docs: [Path Operation Configuration - Tags with Enums](https://readyapi.github.io/tutorial/path-operation-configuration/#tags-with-enums).
* ✨ Allow hiding from OpenAPI (and Swagger UI) `Query`, `Cookie`, `Header`, and `Path` parameters. PR [#3144](https://github.com/khulnasoft/readyapi/pull/3144) by [@astraldawn](https://github.com/astraldawn). New docs: [Query Parameters and String Validations - Exclude from OpenAPI](https://readyapi.github.io/tutorial/query-params-str-validations/#exclude-from-openapi).

### Docs

* 📝 Tweak and improve docs for Request Files. PR [#4470](https://github.com/khulnasoft/readyapi/pull/4470) by [@khulnasoft](https://github.com/khulnasoft).

### Fixes

* 🐛 Fix bug preventing to use OpenAPI when using tuples. PR [#3874](https://github.com/khulnasoft/readyapi/pull/3874) by [@victorbenichoux](https://github.com/victorbenichoux).
* 🐛 Prefer custom encoder over defaults if specified in `jsonable_encoder`. PR [#2061](https://github.com/khulnasoft/readyapi/pull/2061) by [@viveksunder](https://github.com/viveksunder).
    * 💚 Duplicate PR to trigger CI. PR [#4467](https://github.com/khulnasoft/readyapi/pull/4467) by [@khulnasoft](https://github.com/khulnasoft).

### Internal

* 🐛 Fix docs dependencies cache, to get the latest Material for MkDocs. PR [#4466](https://github.com/khulnasoft/readyapi/pull/4466) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Add sponsor Dropbase. PR [#4465](https://github.com/khulnasoft/readyapi/pull/4465) by [@khulnasoft](https://github.com/khulnasoft).

## 0.72.0

### Features

* ✨ Enable configuring Swagger UI parameters. Original PR [#2568](https://github.com/khulnasoft/readyapi/pull/2568) by [@jmriebold](https://github.com/jmriebold). Here are the new docs: [Configuring Swagger UI](https://readyapi.github.io/advanced/extending-openapi/#configuring-swagger-ui).

### Docs

* 📝 Update Python Types docs, add missing 3.6 / 3.9 example. PR [#4434](https://github.com/khulnasoft/readyapi/pull/4434) by [@khulnasoft](https://github.com/khulnasoft).

### Translations

* 🌐 Update Chinese translation for `docs/help-readyapi.md`. PR [#3847](https://github.com/khulnasoft/readyapi/pull/3847) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Fix Korean translation for `docs/ko/docs/index.md`. PR [#4195](https://github.com/khulnasoft/readyapi/pull/4195) by [@kty4119](https://github.com/kty4119).
* 🌐 Add Polish translation for `docs/pl/docs/index.md`. PR [#4245](https://github.com/khulnasoft/readyapi/pull/4245) by [@MicroPanda123](https://github.com/MicroPanda123).
* 🌐 Add Chinese translation for `docs\tutorial\path-operation-configuration.md`. PR [#3312](https://github.com/khulnasoft/readyapi/pull/3312) by [@jaystone776](https://github.com/jaystone776).

### Internal

* 🔧 Enable MkDocs Material Insiders' `content.tabs.link`. PR [#4399](https://github.com/khulnasoft/readyapi/pull/4399) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✨ Add docs and tests for Python 3.9 and Python 3.10. PR [#3712](https://github.com/khulnasoft/readyapi/pull/3712) by [@khulnasoft](https://github.com/khulnasoft).
    * You can start with [Python Types Intro](https://readyapi.github.io/python-types/), it explains what changes between different Python versions, in Python 3.9 and in Python 3.10.
...
* 🐛 Fix JSON Schema for dataclasses, supporting the fixes in Pydantic 1.9. PR [#4272](https://github.com/khulnasoft/readyapi/pull/4272) by [@PrettyWood](https://github.com/PrettyWood).

### Translations

* 🌐 Add Korean translation for `docs/tutorial/request-forms-and-files.md`. PR [#3744](https://github.com/khulnasoft/readyapi/pull/3744) by [@NinaHwang](https://github.com/NinaHwang).
* 🌐 Add Korean translation for `docs/tutorial/request-files.md`. PR [#3743](https://github.com/khulnasoft/readyapi/pull/3743) by [@NinaHwang](https://github.com/NinaHwang).
* 🌐 Add portuguese translation for `docs/tutorial/query-params-str-validations.md`. PR [#3965](https://github.com/khulnasoft/readyapi/pull/3965) by [@leandrodesouzadev](https://github.com/leandrodesouzadev).
* 🌐 Add Korean translation for `docs/tutorial/response-status-code.md`. PR [#3742](https://github.com/khulnasoft/readyapi/pull/3742) by [@NinaHwang](https://github.com/NinaHwang).
* 🌐 Add Korean translation for Tutorial - JSON Compatible Encoder. PR [#3152](https://github.com/khulnasoft/readyapi/pull/3152) by [@NEONKID](https://github.com/NEONKID).
* 🌐 Add Korean translation for Tutorial - Path Parameters and Numeric Validations. PR [#2432](https://github.com/khulnasoft/readyapi/pull/2432) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Korean translation for `docs/ko/docs/deployment/versions.md`. PR [#4121](https://github.com/khulnasoft/readyapi/pull/4121) by [@DevDae](https://github.com/DevDae).
* 🌐 Fix Korean translation for `docs/ko/docs/tutorial/index.md`. PR [#4193](https://github.com/khulnasoft/readyapi/pull/4193) by [@kimjaeyoonn](https://github.com/kimjaeyoonn).
* 🔧 Add CryptAPI sponsor. PR [#4264](https://github.com/khulnasoft/readyapi/pull/4264) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Update `docs/tutorial/dependencies/classes-as-dependencies`: Add type of query parameters in a description of `Classes as dependencies`. PR [#4015](https://github.com/khulnasoft/readyapi/pull/4015) by [@0417taehyun](https://github.com/0417taehyun).
* 🌐 Add French translation for Tutorial - First steps. PR [#3455](https://github.com/khulnasoft/readyapi/pull/3455) by [@Smlep](https://github.com/Smlep).
* 🌐 Add French translation for `docs/tutorial/path-params.md`. PR [#3548](https://github.com/khulnasoft/readyapi/pull/3548) by [@Smlep](https://github.com/Smlep).
* 🌐 Add French translation for `docs/tutorial/query-params.md`. PR [#3556](https://github.com/khulnasoft/readyapi/pull/3556) by [@Smlep](https://github.com/Smlep).
* 🌐 Add Turkish translation for `docs/python-types.md`. PR [#3926](https://github.com/khulnasoft/readyapi/pull/3926) by [@BilalAlpaslan](https://github.com/BilalAlpaslan).
...
* ⬆️ Upgrade Starlette to 0.16.0. PR [#4016](https://github.com/khulnasoft/readyapi/pull/4016) by [@khulnasoft](https://github.com/khulnasoft).
...
You can read the docs about running [ReadyAPI with Trio using Hypercorn](https://readyapi.github.io/deployment/manually/#hypercorn-with-trio).

This release also removes `graphene` as an optional dependency for GraphQL. If you need to work with GraphQL, the recommended library now is [Strawberry](https://strawberry.rocks/). You can read the new [ReadyAPI with GraphQL docs](https://readyapi.github.io/advanced/graphql/).

### Features

* ✨ Add support for Trio via AnyIO, upgrading Starlette to `0.15.0`. PR [#3372](https://github.com/khulnasoft/readyapi/pull/3372) by [@graingert](https://github.com/graingert).
* ➖ Remove `graphene` as an optional dependency. PR [#4007](https://github.com/khulnasoft/readyapi/pull/4007) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✏ Fix typo in `docs/en/docs/help-readyapi.md`. PR [#3760](https://github.com/khulnasoft/readyapi/pull/3760) by [@jaystone776](https://github.com/jaystone776).
...
* 🌐 Initialize Azerbaijani translations. PR [#3941](https://github.com/khulnasoft/readyapi/pull/3941) by [@madatbay](https://github.com/madatbay).
* 🌐 Add Turkish translation for `docs/readyapi-people.md`. PR [#3848](https://github.com/khulnasoft/readyapi/pull/3848) by [@BilalAlpaslan](https://github.com/BilalAlpaslan).

### Internal

* 📝 Add supported Python versions badge. PR [#2794](https://github.com/khulnasoft/readyapi/pull/2794) by [@hramezani](https://github.com/hramezani).
* ✏ Fix link in Japanese docs for `docs/ja/docs/deployment/docker.md`. PR [#3245](https://github.com/khulnasoft/readyapi/pull/3245) by [@utamori](https://github.com/utamori).
* 🔧 Correct DeprecationWarning config and comment in pytest settings. PR [#4008](https://github.com/khulnasoft/readyapi/pull/4008) by [@graingert](https://github.com/graingert).
* 🔧 Swap light/dark theme button icon. PR [#3246](https://github.com/khulnasoft/readyapi/pull/3246) by [@eddsalkield](https://github.com/eddsalkield).
* 🔧 Lint only in Python 3.7 and above. PR [#4006](https://github.com/khulnasoft/readyapi/pull/4006) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Add GitHub Action notify-translations config for Azerbaijani. PR [#3995](https://github.com/khulnasoft/readyapi/pull/3995) by [@khulnasoft](https://github.com/khulnasoft).
...
* ⬆Increase supported version of aiofiles to suppress warnings. PR [#2899](https://github.com/khulnasoft/readyapi/pull/2899) by [@SnkSynthesis](https://github.com/SnkSynthesis).
* ➖ Do not require backports in Python >= 3.7. PR [#1880](https://github.com/khulnasoft/readyapi/pull/1880) by [@FFY00](https://github.com/FFY00).
* ⬆ Upgrade required Python version to >= 3.6.1, needed by typing.Deque, used by Pydantic. PR [#2733](https://github.com/khulnasoft/readyapi/pull/2733) by [@hukkin](https://github.com/hukkin).
* ⬆️ Bump Uvicorn max range to 0.15.0. PR [#3345](https://github.com/khulnasoft/readyapi/pull/3345) by [@Kludex](https://github.com/Kludex).

### Docs

* 📝 Update GraphQL docs, recommend Strawberry. PR [#3981](https://github.com/khulnasoft/readyapi/pull/3981) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Re-write and extend Deployment guide: Concepts, Uvicorn, Gunicorn, Docker, Containers, Kubernetes. PR [#3974](https://github.com/khulnasoft/readyapi/pull/3974) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Upgrade HTTPS guide with more explanations and diagrams. PR [#3950](https://github.com/khulnasoft/readyapi/pull/3950) by [@khulnasoft](https://github.com/khulnasoft).

### Translations

* 🌐 Add Turkish translation for `docs/features.md`. PR [#1950](https://github.com/khulnasoft/readyapi/pull/1950) by [@ycd](https://github.com/ycd).
* 🌐 Add Turkish translation for `docs/benchmarks.md`. PR [#2729](https://github.com/khulnasoft/readyapi/pull/2729) by [@Telomeraz](https://github.com/Telomeraz).
* 🌐 Add Turkish translation for `docs/index.md`. PR [#1908](https://github.com/khulnasoft/readyapi/pull/1908) by [@ycd](https://github.com/ycd).
* 🌐 Add French translation for `docs/tutorial/body.md`. PR [#3671](https://github.com/khulnasoft/readyapi/pull/3671) by [@Smlep](https://github.com/Smlep).
* 🌐 Add French translation for `deployment/docker.md`. PR [#3694](https://github.com/khulnasoft/readyapi/pull/3694) by [@rjNemo](https://github.com/rjNemo).
* 🌐 Add Portuguese translation for `docs/tutorial/path-params.md`. PR [#3664](https://github.com/khulnasoft/readyapi/pull/3664) by [@FelipeSilva93](https://github.com/FelipeSilva93).
* 🌐 Add Portuguese translation for `docs/deployment/https.md`. PR [#3754](https://github.com/khulnasoft/readyapi/pull/3754) by [@lsglucas](https://github.com/lsglucas).
* 🌐 Add German translation for `docs/features.md`. PR [#3699](https://github.com/khulnasoft/readyapi/pull/3699) by [@mawassk](https://github.com/mawassk).
...
* 🎨 Tweak CSS styles for shell animations. PR [#3888](https://github.com/khulnasoft/readyapi/pull/3888) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Add new Sponsor Calmcode.io. PR [#3777](https://github.com/khulnasoft/readyapi/pull/3777) by [@khulnasoft](https://github.com/khulnasoft).
...
* 🌐 Add Portuguese translation of `docs/readyapi-people.md`. PR [#3461](https://github.com/khulnasoft/readyapi/pull/3461) by [@ComicShrimp](https://github.com/ComicShrimp).
* 🌐 Add Chinese translation for `docs/tutorial/dependencies/dependencies-in-path-operation-decorators.md`. PR [#3492](https://github.com/khulnasoft/readyapi/pull/3492) by [@jaystone776](https://github.com/jaystone776).
* 🔧 Add new Translation tracking issues for German and Indonesian. PR [#3718](https://github.com/khulnasoft/readyapi/pull/3718) by [@khulnasoft](https://github.com/khulnasoft).
* 🌐 Add Chinese translation for `docs/tutorial/dependencies/sub-dependencies.md`. PR [#3491](https://github.com/khulnasoft/readyapi/pull/3491) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Portuguese translation for `docs/advanced/index.md`. PR [#3460](https://github.com/khulnasoft/readyapi/pull/3460) by [@ComicShrimp](https://github.com/ComicShrimp).
* 🌐 Portuguese translation of `docs/async.md`. PR [#1330](https://github.com/khulnasoft/readyapi/pull/1330) by [@Serrones](https://github.com/Serrones).
* 🌐 Add French translation for `docs/async.md`. PR [#3416](https://github.com/khulnasoft/readyapi/pull/3416) by [@Smlep](https://github.com/Smlep).
...
* ✨ Add support for extensions and updates to the OpenAPI schema in each *path operation*. New docs: [ReadyAPI Path Operation Advanced Configuration - OpenAPI Extra](https://readyapi.github.io/advanced/path-operation-advanced-configuration/#openapi-extra). Initial PR [#1922](https://github.com/khulnasoft/readyapi/pull/1922) by [@edouardlp](https://github.com/edouardlp).
* ✨ Add additional OpenAPI metadata parameters to `ReadyAPI` class, shown on the automatic API docs UI. New docs: [Metadata and Docs URLs](https://readyapi.github.io/tutorial/metadata/). Initial PR [#1812](https://github.com/khulnasoft/readyapi/pull/1812) by [@dkreeft](https://github.com/dkreeft).
...
* 📝 Update docs about async and response-model with more gender neutral language. PR [#1869](https://github.com/khulnasoft/readyapi/pull/1869) by [@Edward-Knight](https://github.com/Edward-Knight).

### Translations

* 🌐 Add Russian translation for `docs/python-types.md`. PR [#3039](https://github.com/khulnasoft/readyapi/pull/3039) by [@dukkee](https://github.com/dukkee).
* 🌐 Add Chinese translation for `docs/tutorial/dependencies/index.md`. PR [#3489](https://github.com/khulnasoft/readyapi/pull/3489) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Russian translation for `docs/external-links.md`. PR [#3036](https://github.com/khulnasoft/readyapi/pull/3036) by [@dukkee](https://github.com/dukkee).
* 🌐 Add Chinese translation for `docs/tutorial/dependencies/global-dependencies.md`. PR [#3493](https://github.com/khulnasoft/readyapi/pull/3493) by [@jaystone776](https://github.com/jaystone776).
* 🌐 Add Portuguese translation for `docs/deployment/versions.md`. PR [#3618](https://github.com/khulnasoft/readyapi/pull/3618) by [@lsglucas](https://github.com/lsglucas).
* 🌐 Add Japanese translation for `docs/tutorial/security/oauth2-jwt.md`. PR [#3526](https://github.com/khulnasoft/readyapi/pull/3526) by [@sattosan](https://github.com/sattosan).
...
* ✨ Add support for `dataclasses` in request bodies and `response_model`. New documentation: [Advanced User Guide - Using Dataclasses](https://readyapi.github.io/advanced/dataclasses/). PR [#3577](https://github.com/khulnasoft/readyapi/pull/3577) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Support `dataclasses` in responses. PR [#3576](https://github.com/khulnasoft/readyapi/pull/3576) by [@khulnasoft](https://github.com/khulnasoft), continuation from initial PR [#2722](https://github.com/khulnasoft/readyapi/pull/2722) by [@amitlissack](https://github.com/amitlissack).
...
* 🎨 Improve style for sponsors, add radius border. PR [#2388](https://github.com/khulnasoft/readyapi/pull/2388) by [@Kludex](https://github.com/Kludex).
* 👷 Update GitHub Action latest-changes. PR [#3574](https://github.com/khulnasoft/readyapi/pull/3574) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update GitHub Action latest-changes. PR [#3573](https://github.com/khulnasoft/readyapi/pull/3573) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Rename and clarify CI workflow job names. PR [#3570](https://github.com/khulnasoft/readyapi/pull/3570) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update GitHub Action latest-changes, strike 2 ⚾. PR [#3575](https://github.com/khulnasoft/readyapi/pull/3575) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Sort external links in docs to have the most recent at the top. PR [#3568](https://github.com/khulnasoft/readyapi/pull/3568) by [@khulnasoft](https://github.com/khulnasoft).

## 0.66.1

### Translations

* 🌐 Add basic setup for German translations. PR [#3522](https://github.com/khulnasoft/readyapi/pull/3522) by [@0x4Dark](https://github.com/0x4Dark).
* 🌐 Add Portuguese translation for `docs/tutorial/security/index.md`. PR [#3507](https://github.com/khulnasoft/readyapi/pull/3507) by [@oandersonmagalhaes](https://github.com/oandersonmagalhaes).
* 🌐 Add Portuguese translation for `docs/deployment/index.md`. PR [#3337](https://github.com/khulnasoft/readyapi/pull/3337) by [@lsglucas](https://github.com/lsglucas).

### Internal

* 🔧 Configure strict pytest options and update/refactor tests. Upgrade pytest to `>=6.2.4,<7.0.0` and pytest-cov to `>=2.12.0,<3.0.0`. Initial PR [#2790](https://github.com/khulnasoft/readyapi/pull/2790) by [@graingert](https://github.com/graingert).
* ⬆️ Upgrade python-jose dependency to `>=3.3.0,<4.0.0` for tests. PR [#3468](https://github.com/khulnasoft/readyapi/pull/3468) by [@khulnasoft](https://github.com/khulnasoft).

## 0.66.0

### Features

* ✨ Allow setting the `response_class` to `RedirectResponse` or `FileResponse` and returning the URL from the function. New and updated docs are in the tutorial section **Custom Response - HTML, Stream, File, others**, in [RedirectResponse](https://readyapi.github.io/advanced/custom-response/#redirectresponse) and in [FileResponse](https://readyapi.github.io/advanced/custom-response/#fileresponse). PR [#3457](https://github.com/khulnasoft/readyapi/pull/3457) by [@khulnasoft](https://github.com/khulnasoft).

### Fixes

* 🐛 Fix include/exclude for dicts in `jsonable_encoder`. PR [#2016](https://github.com/khulnasoft/readyapi/pull/2016) by [@Rubikoid](https://github.com/Rubikoid).
* 🐛 Support custom OpenAPI / JSON Schema fields in the generated output OpenAPI. PR [#1429](https://github.com/khulnasoft/readyapi/pull/1429) by [@jmagnusson](https://github.com/jmagnusson).

### Translations

* 🌐 Add Spanish translation for `tutorial/query-params.md`. PR [#2243](https://github.com/khulnasoft/readyapi/pull/2243) by [@mariacamilagl](https://github.com/mariacamilagl).
* 🌐 Add Spanish translation for `advanced/response-directly.md`. PR [#1253](https://github.com/khulnasoft/readyapi/pull/1253) by [@jfunez](https://github.com/jfunez).
* 🌐 Add Spanish translation for `advanced/additional-status-codes.md`. PR [#1252](https://github.com/khulnasoft/readyapi/pull/1252) by [@jfunez](https://github.com/jfunez).
* 🌐 Add Spanish translation for `advanced/path-operation-advanced-configuration.md`. PR [#1251](https://github.com/khulnasoft/readyapi/pull/1251) by [@jfunez](https://github.com/jfunez).
...
* 🌐 Initialize Indonesian translations. PR [#3014](https://github.com/khulnasoft/readyapi/pull/3014) by [@pace-noge](https://github.com/pace-noge).
* 🌐 Add Spanish translation of Tutorial - Path Parameters. PR [#2219](https://github.com/khulnasoft/readyapi/pull/2219) by [@mariacamilagl](https://github.com/mariacamilagl).
* 🌐 Add Spanish translation of Tutorial - First Steps. PR [#2208](https://github.com/khulnasoft/readyapi/pull/2208) by [@mariacamilagl](https://github.com/mariacamilagl).
* 🌐 Portuguese translation of Tutorial - Body - Fields. PR [#3420](https://github.com/khulnasoft/readyapi/pull/3420) by [@ComicShrimp](https://github.com/ComicShrimp).
* 🌐 Add Chinese translation for Tutorial - Request - Forms - and - Files. PR [#3249](https://github.com/khulnasoft/readyapi/pull/3249) by [@jaystone776](https://github.com/jaystone776).
...
* 🌐 Add French translation for Alternatives, Inspiration and Comparisons. PR [#3020](https://github.com/khulnasoft/readyapi/pull/3020) by [@rjNemo](https://github.com/rjNemo).
* 🌐 Fix Chinese translation code snippet mismatch in Tutorial - Python Types Intro. PR [#2573](https://github.com/khulnasoft/readyapi/pull/2573) by [@BoYanZh](https://github.com/BoYanZh).
* 🌐 Add Portuguese translation for Development Contributing. PR [#1364](https://github.com/khulnasoft/readyapi/pull/1364) by [@Serrones](https://github.com/Serrones).
* 🌐 Add Chinese translation for Tutorial - Request - Files. PR [#3244](https://github.com/khulnasoft/readyapi/pull/3244) by [@jaystone776](https://github.com/jaystone776).
...
* 🔒 Check Content-Type request header before assuming JSON. Initial PR [#2118](https://github.com/khulnasoft/readyapi/pull/2118) by [@patrickkwang](https://github.com/patrickkwang).
...
* 📌 Upgrade pydantic pin, to handle security vulnerability [CVE-2021-29510](https://github.com/pydantic/pydantic/security/advisories/GHSA-5jqp-qgf6-3pvh). PR [#3213](https://github.com/khulnasoft/readyapi/pull/3213) by [@khulnasoft](https://github.com/khulnasoft).

## 0.65.0

### Breaking Changes - Upgrade

* ⬆️  Upgrade Starlette to `0.14.2`, including internal `UJSONResponse` migrated from Starlette. This includes several bug fixes and features from Starlette. PR [#2335](https://github.com/khulnasoft/readyapi/pull/2335) by [@hanneskuettner](https://github.com/hanneskuettner).

### Translations

* 🌐 Initialize new language Polish for translations. PR [#3170](https://github.com/khulnasoft/readyapi/pull/3170) by [@neternefer](https://github.com/neternefer).

### Internal

* 👷 Add GitHub Action cache to speed up CI installs. PR [#3204](https://github.com/khulnasoft/readyapi/pull/3204) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✨ Add support for adding multiple `examples` in request bodies and path, query, cookie, and header params. New docs: [Declare Request Example Data](https://readyapi.github.io/tutorial/schema-extra-example/#body-with-multiple-examples). Initial PR [#1267](https://github.com/khulnasoft/readyapi/pull/1267) by [@austinorr](https://github.com/austinorr).

### Fixes

* 📌 Pin SQLAlchemy range for tests, as it doesn't use SemVer. PR [#3001](https://github.com/khulnasoft/readyapi/pull/3001) by [@khulnasoft](https://github.com/khulnasoft).
* 🎨 Add newly required type annotations for mypy. PR [#2882](https://github.com/khulnasoft/readyapi/pull/2882) by [@khulnasoft](https://github.com/khulnasoft).
* 🎨 Remove internal "type: ignore", now unnecessary. PR [#2424](https://github.com/khulnasoft/readyapi/pull/2424) by [@AsakuraMizu](https://github.com/AsakuraMizu).
...
* 🌐 Fix Chinese translation of Tutorial - Query Parameters, remove obsolete content. PR [#3051](https://github.com/khulnasoft/readyapi/pull/3051) by [@louis70109](https://github.com/louis70109).
...
* 🌐 Add Chinese translation for Tutorial - Metadata and Docs URLs. PR [#2559](https://github.com/khulnasoft/readyapi/pull/2559) by [@blt232018](https://github.com/blt232018).
* 🌐 Add Korean translation for Tutorial - First Steps. PR [#2323](https://github.com/khulnasoft/readyapi/pull/2323) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Chinese translation for Tutorial - CORS (Cross-Origin Resource Sharing). PR [#2540](https://github.com/khulnasoft/readyapi/pull/2540) by [@blt232018](https://github.com/blt232018).
* 🌐 Add Chinese translation for Tutorial - Middleware. PR [#2334](https://github.com/khulnasoft/readyapi/pull/2334) by [@lpdswing](https://github.com/lpdswing).
* 🌐 Add Korean translation for Tutorial - Intro. PR [#2317](https://github.com/khulnasoft/readyapi/pull/2317) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Chinese translation for Tutorial - Bigger Applications - Multiple Files. PR [#2453](https://github.com/khulnasoft/readyapi/pull/2453) by [@waynerv](https://github.com/waynerv).
* 🌐 Add Chinese translation for Tutorial - Security - Security Intro. PR [#2443](https://github.com/khulnasoft/readyapi/pull/2443) by [@waynerv](https://github.com/waynerv).
* 🌐 Add Chinese translation for Tutorial - Header Parameters. PR [#2412](https://github.com/khulnasoft/readyapi/pull/2412) by [@maoyibo](https://github.com/maoyibo).
* 🌐 Add Chinese translation for Tutorial - Extra Data Types. PR [#2410](https://github.com/khulnasoft/readyapi/pull/2410) by [@maoyibo](https://github.com/maoyibo).
* 🌐 Add Japanese translation for Deployment - Docker. PR [#2312](https://github.com/khulnasoft/readyapi/pull/2312) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for Deployment - Versions. PR [#2310](https://github.com/khulnasoft/readyapi/pull/2310) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Chinese translation for Tutorial - Cookie Parameters. PR [#2261](https://github.com/khulnasoft/readyapi/pull/2261) by [@alicrazy1947](https://github.com/alicrazy1947).
* 🌐 Add Japanese translation for Tutorial - Static files. PR [#2260](https://github.com/khulnasoft/readyapi/pull/2260) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for Tutorial - Testing. PR [#2259](https://github.com/khulnasoft/readyapi/pull/2259) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for Tutorial - Debugging. PR [#2256](https://github.com/khulnasoft/readyapi/pull/2256) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for Tutorial - Middleware. PR [#2255](https://github.com/khulnasoft/readyapi/pull/2255) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for Concurrency and async / await. PR [#2058](https://github.com/khulnasoft/readyapi/pull/2058) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Chinese translation for Tutorial - Security - Simple OAuth2 with Password and Bearer. PR [#2514](https://github.com/khulnasoft/readyapi/pull/2514) by [@waynerv](https://github.com/waynerv).
* 🌐 Add Japanese translation for Deployment - Deta. PR [#2314](https://github.com/khulnasoft/readyapi/pull/2314) by [@tokusumi](https://github.com/tokusumi).
...
* 🌐 Add Japanese translation for Tutorial - Form Data. PR [#1943](https://github.com/khulnasoft/readyapi/pull/1943) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Japanese translation for Tutorial - Cookie Parameters. PR [#1933](https://github.com/khulnasoft/readyapi/pull/1933) by [@SwftAlpc](https://github.com/SwftAlpc).
...
* ✨ Improve type annotations, add support for mypy --strict, internally and for external packages. PR [#2547](https://github.com/khulnasoft/readyapi/pull/2547) by [@khulnasoft](https://github.com/khulnasoft).

### Breaking changes

* ⬆️ Upgrade Uvicorn when installing `readyapi[all]` to the latest version including `uvloop`, the new range is `uvicorn[standard] >=0.12.0,<0.14.0`. PR [#2548](https://github.com/khulnasoft/readyapi/pull/2548) by [@khulnasoft](https://github.com/khulnasoft).

### Fixes

* 🐛 PR [#2547](https://github.com/khulnasoft/readyapi/pull/2547) (read above) also fixes some false-positive mypy errors with `callbacks` parameters and when using the `OAuth2` class.
...
* 🌐 Add docs lang selector widget. PR [#2542](https://github.com/khulnasoft/readyapi/pull/2542) by [@khulnasoft](https://github.com/khulnasoft).
* 🌐 Add Chinese translation for Tutorial - Response Status Code. PR [#2442](https://github.com/khulnasoft/readyapi/pull/2442) by [@waynerv](https://github.com/waynerv).
* 🌐 Start translation of the documentation for the Albanian language. PR [#2516](https://github.com/khulnasoft/readyapi/pull/2516) by [@vjanz](https://github.com/vjanz).
* 🌐 Add Chinese translation for Tutorial - Extra Models. PR [#2416](https://github.com/khulnasoft/readyapi/pull/2416) by [@waynerv](https://github.com/waynerv).
* 🌐 Add Chinese translation for Tutorial - Response Model. PR [#2414](https://github.com/khulnasoft/readyapi/pull/2414) by [@waynerv](https://github.com/waynerv).
* 🌐 Add Chinese translation for Tutorial - Schema Extra Example. PR [#2411](https://github.com/khulnasoft/readyapi/pull/2411) by [@maoyibo](https://github.com/maoyibo).
* 🌐 Add Korean translation for Index. PR [#2192](https://github.com/khulnasoft/readyapi/pull/2192) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Japanese translation for Advanced User Guide - Additional Status Codes. PR [#2145](https://github.com/khulnasoft/readyapi/pull/2145) by [@Attsun1031](https://github.com/Attsun1031).
...
* ✨ Add support for shared/top-level parameters (dependencies, tags, etc). PR [#2434](https://github.com/khulnasoft/readyapi/pull/2434) by [@khulnasoft](https://github.com/khulnasoft).
...
* `default_response_class`: updated to handle defaults in `APIRouter` and `include_router`. For example, it's not needed to set it explicitly when [creating callbacks](https://readyapi.github.io/advanced/openapi-callbacks/).
...
* PR [#2434](https://github.com/khulnasoft/readyapi/pull/2434) (above) includes new or updated docs:
    * <a href="https://readyapi.github.io/advanced/openapi-callbacks/" class="external-link" target="_blank">Advanced User Guide - OpenAPI Callbacks</a>.
    * <a href="https://readyapi.github.io/tutorial/bigger-applications/" class="external-link" target="_blank">Tutorial - Bigger Applications</a>.
    * <a href="https://readyapi.github.io/tutorial/dependencies/dependencies-in-path-operation-decorators/" class="external-link" target="_blank">Tutorial - Dependencies - Dependencies in path operation decorators</a>.
    * <a href="https://readyapi.github.io/tutorial/dependencies/global-dependencies/" class="external-link" target="_blank">Tutorial - Dependencies - Global Dependencies</a>.
...
* 🌐 Add Japanese translation for Advanced - Custom Response. PR [#2193](https://github.com/khulnasoft/readyapi/pull/2193) by [@Attsun1031](https://github.com/Attsun1031).
* 🌐 Add Chinese translation for Benchmarks. PR [#2119](https://github.com/khulnasoft/readyapi/pull/2119) by [@spaceack](https://github.com/spaceack).
* 🌐 Add Chinese translation for Tutorial - Body - Nested Models. PR [#1609](https://github.com/khulnasoft/readyapi/pull/1609) by [@waynerv](https://github.com/waynerv).
* 🌐 Add Chinese translation for Advanced - Custom Response. PR [#1459](https://github.com/khulnasoft/readyapi/pull/1459) by [@RunningIkkyu](https://github.com/RunningIkkyu).
* 🌐 Add Chinese translation for Advanced - Return a Response Directly. PR [#1452](https://github.com/khulnasoft/readyapi/pull/1452) by [@RunningIkkyu](https://github.com/RunningIkkyu).
* 🌐 Add Chinese translation for Advanced - Additional Status Codes. PR [#1451](https://github.com/khulnasoft/readyapi/pull/1451) by [@RunningIkkyu](https://github.com/RunningIkkyu).
* 🌐 Add Chinese translation for Advanced - Path Operation Advanced Configuration. PR [#1447](https://github.com/khulnasoft/readyapi/pull/1447) by [@RunningIkkyu](https://github.com/RunningIkkyu).
* 🌐 Add Chinese translation for Advanced User Guide - Intro. PR [#1445](https://github.com/khulnasoft/readyapi/pull/1445) by [@RunningIkkyu](https://github.com/RunningIkkyu).

### Internal

* 🔧 Update TestDriven link to course in sponsors section. PR [#2435](https://github.com/khulnasoft/readyapi/pull/2435) by [@khulnasoft](https://github.com/khulnasoft).
* 🍱 Update sponsor logos. PR [#2418](https://github.com/khulnasoft/readyapi/pull/2418) by [@khulnasoft](https://github.com/khulnasoft).
* 💚 Fix disabling install of Material for MkDocs Insiders in forks, strike 1 ⚾. PR [#2340](https://github.com/khulnasoft/readyapi/pull/2340) by [@khulnasoft](https://github.com/khulnasoft).
* 🐛 Fix disabling Material for MkDocs Insiders install in forks. PR [#2339](https://github.com/khulnasoft/readyapi/pull/2339) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Add silver sponsor WeTransfer. PR [#2338](https://github.com/khulnasoft/readyapi/pull/2338) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Set up and enable Material for MkDocs Insiders for the docs. PR [#2325](https://github.com/khulnasoft/readyapi/pull/2325) by [@khulnasoft](https://github.com/khulnasoft).

## 0.61.2

### Fixes

* 📌 Relax Swagger UI version pin. PR [#2089](https://github.com/khulnasoft/readyapi/pull/2089) by [@jmriebold](https://github.com/jmriebold).
* 🐛 Fix bug overriding custom HTTPException and RequestValidationError from exception_handlers. PR [#1924](https://github.com/khulnasoft/readyapi/pull/1924) by [@uriyyo](https://github.com/uriyyo).
* ✏️ Fix typo on dependencies utils and cleanup unused variable. PR [#1912](https://github.com/khulnasoft/readyapi/pull/1912) by [@Kludex](https://github.com/Kludex).

### Docs

* ✏️  Fix typo in Tutorial - Path Parameters. PR [#2231](https://github.com/khulnasoft/readyapi/pull/2231) by [@mariacamilagl](https://github.com/mariacamilagl).
* ✏ Fix a stylistic error in docs. PR [#2206](https://github.com/khulnasoft/readyapi/pull/2206) by [@ddobrinskiy](https://github.com/ddobrinskiy).
* ✏ Fix capitalizaiton typo in docs. PR [#2204](https://github.com/khulnasoft/readyapi/pull/2204) by [@imba-tjd](https://github.com/imba-tjd).
* ✏ Fix typo in docs. PR [#2179](https://github.com/khulnasoft/readyapi/pull/2179) by [@ammarasmro](https://github.com/ammarasmro).
* 📝 Update/fix links in docs to use HTTPS. PR [#2165](https://github.com/khulnasoft/readyapi/pull/2165) by [@imba-tjd](https://github.com/imba-tjd).
* ✏ Fix typos and add rewording in docs. PR [#2159](https://github.com/khulnasoft/readyapi/pull/2159) by [@nukopy](https://github.com/nukopy).
* 📝 Fix code consistency in examples for Tutorial - User Guide - Path Parameters. PR [#2158](https://github.com/khulnasoft/readyapi/pull/2158) by [@nukopy](https://github.com/nukopy).
* 📝 Fix renamed parameter `content_type` typo. PR [#2135](https://github.com/khulnasoft/readyapi/pull/2135) by [@TeoZosa](https://github.com/TeoZosa).
* ✏ Fix minor typos in docs. PR [#2122](https://github.com/khulnasoft/readyapi/pull/2122) by [@TeoZosa](https://github.com/TeoZosa).
* ✏ Fix typos in docs and source examples. PR [#2102](https://github.com/khulnasoft/readyapi/pull/2102) by [@AdrianDeAnda](https://github.com/AdrianDeAnda).
* ✏ Fix incorrect Celery URLs in docs. PR [#2100](https://github.com/khulnasoft/readyapi/pull/2100) by [@CircleOnCircles](https://github.com/CircleOnCircles).
* 📝 Simplify intro to Python Types, all currently supported Python versions include type hints 🎉. PR [#2085](https://github.com/khulnasoft/readyapi/pull/2085) by [@ninjaaron](https://github.com/ninjaaron).
* 📝 Fix example code with sets in Tutorial - Body - Nested Models 3. PR [#2054](https://github.com/khulnasoft/readyapi/pull/2054) by [@hitrust](https://github.com/hitrust).
* 📝 Fix example code with sets in Tutorial - Body - Nested Models 2. PR [#2053](https://github.com/khulnasoft/readyapi/pull/2053) by [@hitrust](https://github.com/hitrust).
* 📝 Fix example code with sets in Tutorial - Body - Nested Models. PR [#2052](https://github.com/khulnasoft/readyapi/pull/2052) by [@hitrust](https://github.com/hitrust).
...
* 🌐 Add Japanese translation for Advanced Tutorial - Response Directly. PR [#2191](https://github.com/khulnasoft/readyapi/pull/2191) by [@Attsun1031](https://github.com/Attsun1031).
* 📝 Add Japanese translation for Tutorial - Security - First Steps. PR [#2153](https://github.com/khulnasoft/readyapi/pull/2153) by [@komtaki](https://github.com/komtaki).
* 🌐 Add Japanese translation for Tutorial - Query Parameters and String Validations. PR [#1901](https://github.com/khulnasoft/readyapi/pull/1901) by [@SwftAlpc](https://github.com/SwftAlpc).
* 🌐 Add Portuguese translation for External Links. PR [#1443](https://github.com/khulnasoft/readyapi/pull/1443) by [@Serrones](https://github.com/Serrones).
* 🌐 Add Japanese translation for Tutorial - CORS. PR [#2125](https://github.com/khulnasoft/readyapi/pull/2125) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for Contributing. PR [#2067](https://github.com/khulnasoft/readyapi/pull/2067) by [@komtaki](https://github.com/komtaki).
* 🌐 Add Japanese translation for Project Generation. PR [#2050](https://github.com/khulnasoft/readyapi/pull/2050) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for Alternatives. PR [#2043](https://github.com/khulnasoft/readyapi/pull/2043) by [@Attsun1031](https://github.com/Attsun1031).
* 🌐 Add Japanese translation for History Design and Future. PR [#2002](https://github.com/khulnasoft/readyapi/pull/2002) by [@komtaki](https://github.com/komtaki).
* 🌐 Add Japanese translation for Benchmarks. PR [#1992](https://github.com/khulnasoft/readyapi/pull/1992) by [@komtaki](https://github.com/komtaki).
...
* 🌐 Add Japanese translation for tutorial/first-steps.md. PR [#1658](https://github.com/khulnasoft/readyapi/pull/1658) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add Japanese translation for tutorial/index.md. PR [#1656](https://github.com/khulnasoft/readyapi/pull/1656) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Add translation to Portuguese for Project Generation. PR [#1602](https://github.com/khulnasoft/readyapi/pull/1602) by [@Serrones](https://github.com/Serrones).
* 🌐 Add Japanese translation for Features. PR [#1625](https://github.com/khulnasoft/readyapi/pull/1625) by [@tokusumi](https://github.com/tokusumi).
* 🌐 Initialize new language Korean for translations. PR [#2018](https://github.com/khulnasoft/readyapi/pull/2018) by [@hard-coders](https://github.com/hard-coders).
* 🌐 Add Portuguese translation of Deployment. PR [#1374](https://github.com/khulnasoft/readyapi/pull/1374) by [@Serrones](https://github.com/Serrones).

### Internal

* 🔥 Cleanup after upgrade for Docs Previews GitHub Action. PR [#2248](https://github.com/khulnasoft/readyapi/pull/2248) by [@khulnasoft](https://github.com/khulnasoft).
* 🐛 Fix CI docs preview, unzip docs. PR [#2246](https://github.com/khulnasoft/readyapi/pull/2246) by [@khulnasoft](https://github.com/khulnasoft).
...
* 👷 Upgrade GitHub Action Latest Changes. PR [#2184](https://github.com/khulnasoft/readyapi/pull/2184) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Set GitHub Action Label Approved to run daily, not every minute. PR [#2163](https://github.com/khulnasoft/readyapi/pull/2163) by [@khulnasoft](https://github.com/khulnasoft).
* 🔥 Remove pr-approvals GitHub Action as it's not compatible with forks. Use the new one. PR [#2162](https://github.com/khulnasoft/readyapi/pull/2162) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add GitHub Action Latest Changes. PR [#2160](https://github.com/khulnasoft/readyapi/pull/2160).
* 👷 Add GitHub Action Label Approved. PR [#2161](https://github.com/khulnasoft/readyapi/pull/2161).

## 0.61.1

### Fixes

* Fix issues using `jsonable_encoder` with SQLAlchemy models directly. PR [#1987](https://github.com/khulnasoft/readyapi/pull/1987).

### Docs

* Fix typo in NoSQL docs. PR [#1980](https://github.com/khulnasoft/readyapi/pull/1980) by [@facundojmaero](https://github.com/facundojmaero).

### Translations

* Add translation for [main page to Japanese](https://readyapi.github.io/ja/) PR [#1571](https://github.com/khulnasoft/readyapi/pull/1571) by [@ryuckel](https://github.com/ryuckel).
* Initialize French translations. PR [#1975](https://github.com/khulnasoft/readyapi/pull/1975) by [@JulianMaurin-BM](https://github.com/JulianMaurin-BM).
* Initialize Turkish translations. PR [#1905](https://github.com/khulnasoft/readyapi/pull/1905) by [@ycd](https://github.com/ycd).

### Internal

* Improve docs maintainability by updating `hl_lines` syntax to use ranges. PR [#1863](https://github.com/khulnasoft/readyapi/pull/1863) by [@la-mar](https://github.com/la-mar).

## 0.61.0

### Features

* Add support for injecting `HTTPConnection` (as `Request` and `WebSocket`). Useful for sharing app state in dependencies. PR [#1827](https://github.com/khulnasoft/readyapi/pull/1827) by [@nsidnev](https://github.com/nsidnev).
* Export `WebSocketDisconnect` and add example handling WebSocket disconnections to docs. PR [#1822](https://github.com/khulnasoft/readyapi/pull/1822) by [@rkbeatss](https://github.com/rkbeatss).
...
* Require Pydantic > `1.0.0`.
    ...
    * PR [#1862](https://github.com/khulnasoft/readyapi/pull/1862).
* In `encoders.jsonable_encoder` remove parameter `sqlalchemy_safe`.
    * It was an early hack to allow returning SQLAlchemy models, but it was never documented, and the recommended way is using Pydantic's `orm_mode` as described in the tutorial: [SQL (Relational) Databases](https://readyapi.github.io/tutorial/sql-databases/).
    * PR [#1864](https://github.com/khulnasoft/readyapi/pull/1864).
...
* Add Flake8 linting. Original PR [#1774](https://github.com/khulnasoft/readyapi/pull/1774) by [@MashhadiNima](https://github.com/MashhadiNima).
* Disable Gitter bot, as it's currently broken, and Gitter's response doesn't show the problem. PR [#1853](https://github.com/khulnasoft/readyapi/pull/1853).

## 0.60.2

* Fix typo in docs for query parameters. PR [#1832](https://github.com/khulnasoft/readyapi/pull/1832) by [@ycd](https://github.com/ycd).
* Add docs about [Async Tests](https://readyapi.github.io/advanced/async-tests/). PR [#1619](https://github.com/khulnasoft/readyapi/pull/1619) by [@empicano](https://github.com/empicano).
* Raise an exception when using form data (`Form`, `File`) without having `python-multipart` installed.
    ...
    * PR [#1851](https://github.com/khulnasoft/readyapi/pull/1851) based on original PR [#1627](https://github.com/khulnasoft/readyapi/pull/1627) by [@chrisngyn](https://github.com/chrisngyn), [@YKo20010](https://github.com/YKo20010), [@kx-chen](https://github.com/kx-chen).
* Re-enable Gitter releases bot. PR [#1831](https://github.com/khulnasoft/readyapi/pull/1831).
* Add link to async SQL databases tutorial from main SQL tutorial. PR [#1813](https://github.com/khulnasoft/readyapi/pull/1813) by [@short2strings](https://github.com/short2strings).
...
* Add debugging logs for GitHub actions to introspect GitHub hidden context. PR [#1764](https://github.com/khulnasoft/readyapi/pull/1764).
* Use OS preference theme for online docs. PR [#1760](https://github.com/khulnasoft/readyapi/pull/1760) by [@adriencaccia](https://github.com/adriencaccia).
* Upgrade Starlette to version `0.13.6` to handle a vulnerability when using static files in Windows. PR [#1759](https://github.com/khulnasoft/readyapi/pull/1759) by [@jamesag26](https://github.com/jamesag26).
* Pin Swagger UI temporarily, waiting for a fix for [swagger-api/swagger-ui#6249](https://github.com/swagger-api/swagger-ui/issues/6249). PR [#1763](https://github.com/khulnasoft/readyapi/pull/1763).
* Update GitHub Actions, use commit from PR for docs preview, not commit from pre-merge. PR [#1761](https://github.com/khulnasoft/readyapi/pull/1761).
* Update GitHub Actions, refactor Gitter bot. PR [#1746](https://github.com/khulnasoft/readyapi/pull/1746).

## 0.60.0

* Add GitHub Action to watch for missing preview docs and trigger a preview deploy. PR [#1740](https://github.com/khulnasoft/readyapi/pull/1740).
* Add custom GitHub Action to get artifact with docs preview. PR [#1739](https://github.com/khulnasoft/readyapi/pull/1739).
* Add new GitHub Actions to preview docs from PRs. PR [#1738](https://github.com/khulnasoft/readyapi/pull/1738).
* Add XML test coverage to support GitHub Actions. PR [#1737](https://github.com/khulnasoft/readyapi/pull/1737).
* Update badges and remove Travis now that GitHub Actions is the main CI. PR [#1736](https://github.com/khulnasoft/readyapi/pull/1736).
* Add GitHub Actions for CI, move from Travis. PR [#1735](https://github.com/khulnasoft/readyapi/pull/1735).
* Add support for adding OpenAPI schema for GET requests with a body. PR [#1626](https://github.com/khulnasoft/readyapi/pull/1626) by [@victorphoenix3](https://github.com/victorphoenix3).

## 0.59.0

* Fix typo in docstring for OAuth2 utils. PR [#1621](https://github.com/khulnasoft/readyapi/pull/1621) by [@tomarv2](https://github.com/tomarv2).
...
* Auto-generate a "server" in OpenAPI `servers` when there's a `root_path` instead of prefixing all the `paths`:
    ...
    * New docs about `root_path` and `servers` in [Additional Servers](https://readyapi.github.io/advanced/behind-a-proxy/#additional-servers).
...
* Update handling of [External Links](https://readyapi.github.io/external-links/) to use a data file and allow translating the headers without becoming obsolete quickly when new links are added. PR [#https://github.com/khulnasoft/readyapi/pull/1701](https://github.com/khulnasoft/readyapi/pull/1701).
...
* Update isort to version 5.x.x. PR [#1670](https://github.com/khulnasoft/readyapi/pull/1670) by [@asheux](https://github.com/asheux).

## 0.58.1

* Add link in docs to Pydantic data types. PR [#1612](https://github.com/khulnasoft/readyapi/pull/1612) by [@tayoogunbiyi](https://github.com/tayoogunbiyi).
* Fix link in warning logs for `openapi_prefix`. PR [#1611](https://github.com/khulnasoft/readyapi/pull/1611) by [@bavaria95](https://github.com/bavaria95).
* Fix bad link in docs. PR [#1603](https://github.com/khulnasoft/readyapi/pull/1603) by [@molto0504](https://github.com/molto0504).
* Add Vim temporary files to `.gitignore` for contributors using Vim. PR [#1590](https://github.com/khulnasoft/readyapi/pull/1590) by [@asheux](https://github.com/asheux).
* Fix typo in docs for sub-applications. PR [#1578](https://github.com/khulnasoft/readyapi/pull/1578) by [@schlpbch](https://github.com/schlpbch).
* Use `Optional` in all the examples in the docs. Original PR [#1574](https://github.com/khulnasoft/readyapi/pull/1574) by [@chrisngyn](https://github.com/chrisngyn), [@kx-chen](https://github.com/kx-chen), [@YKo20010](https://github.com/YKo20010). Updated and merged PR [#1644](https://github.com/khulnasoft/readyapi/pull/1644).
* Update tests and handling of `response_model_by_alias`. PR [#1642](https://github.com/khulnasoft/readyapi/pull/1642).
* Add translation to Chinese for [Body - Fields - 请求体 - 字段](https://readyapi.github.io/zh/tutorial/body-fields/). PR [#1569](https://github.com/khulnasoft/readyapi/pull/1569) by [@waynerv](https://github.com/waynerv).
* Update Chinese translation of main page. PR [#1564](https://github.com/khulnasoft/readyapi/pull/1564) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Body - Multiple Parameters - 请求体 - 多个参数](https://readyapi.github.io/zh/tutorial/body-multiple-params/). PR [#1532](https://github.com/khulnasoft/readyapi/pull/1532) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Path Parameters and Numeric Validations - 路径参数和数值校验](https://readyapi.github.io/zh/tutorial/path-params-numeric-validations/). PR [#1506](https://github.com/khulnasoft/readyapi/pull/1506) by [@waynerv](https://github.com/waynerv).
* Add GitHub action to auto-label approved PRs (mainly for translations). PR [#1638](https://github.com/khulnasoft/readyapi/pull/1638).

## 0.58.0

* Deep merge OpenAPI responses to preserve all the additional metadata. PR [#1577](https://github.com/khulnasoft/readyapi/pull/1577).
* Mention in docs that only main app events are run (not sub-apps). PR [#1554](https://github.com/khulnasoft/readyapi/pull/1554) by [@amacfie](https://github.com/amacfie).
* Fix body validation error response, do not include body variable when it is not embedded. PR [#1553](https://github.com/khulnasoft/readyapi/pull/1553) by [@amacfie](https://github.com/amacfie).
* Fix testing OAuth2 security scopes when using dependency overrides. PR [#1549](https://github.com/khulnasoft/readyapi/pull/1549) by [@amacfie](https://github.com/amacfie).
* Fix Model for JSON Schema keyword `not` as a JSON Schema instead of a list. PR [#1548](https://github.com/khulnasoft/readyapi/pull/1548) by [@v-do](https://github.com/v-do).
* Add support for OpenAPI `servers`. PR [#1547](https://github.com/khulnasoft/readyapi/pull/1547) by [@mikaello](https://github.com/mikaello).

## 0.57.0

* Remove broken link from "External Links". PR [#1565](https://github.com/khulnasoft/readyapi/pull/1565) by [@victorphoenix3](https://github.com/victorphoenix3).
* Update/fix docs for [WebSockets with dependencies](https://readyapi.github.io/advanced/websockets/#using-depends-and-others). Original PR [#1540](https://github.com/khulnasoft/readyapi/pull/1540) by [@ChihSeanHsu](https://github.com/ChihSeanHsu).
* Add support for Python's `http.HTTPStatus` in `status_code` parameters. PR [#1534](https://github.com/khulnasoft/readyapi/pull/1534) by [@retnikt](https://github.com/retnikt).
* When using Pydantic models with `__root__`, use the internal value in `jsonable_encoder`. PR [#1524](https://github.com/khulnasoft/readyapi/pull/1524) by [@patrickkwang](https://github.com/patrickkwang).
* Update docs for path parameters. PR [#1521](https://github.com/khulnasoft/readyapi/pull/1521) by [@yankeexe](https://github.com/yankeexe).
* Update docs for first steps, links and rewording. PR [#1518](https://github.com/khulnasoft/readyapi/pull/1518) by [@yankeexe](https://github.com/yankeexe).
* Enable `showCommonExtensions` in Swagger UI to show additional validations like `maxLength`, etc. PR [#1466](https://github.com/khulnasoft/readyapi/pull/1466) by [@TiewKH](https://github.com/TiewKH).
* Make `OAuth2PasswordRequestFormStrict` importable directly from `readyapi.security`. PR [#1462](https://github.com/khulnasoft/readyapi/pull/1462) by [@RichardHoekstra](https://github.com/RichardHoekstra).
* Add docs about [Default response class](https://readyapi.github.io/advanced/custom-response/#default-response-class). PR [#1455](https://github.com/khulnasoft/readyapi/pull/1455) by [@TezRomacH](https://github.com/TezRomacH).
* Add note in docs about additional parameters `response_model_exclude_defaults` and `response_model_exclude_none` in [Response Model](https://readyapi.github.io/tutorial/response-model/#use-the-response_model_exclude_unset-parameter). PR [#1427](https://github.com/khulnasoft/readyapi/pull/1427) by [@wshayes](https://github.com/wshayes).
* Add note about [PyCharm Pydantic plugin](https://github.com/koxudaxi/pydantic-pycharm-plugin) to docs. PR [#1420](https://github.com/khulnasoft/readyapi/pull/1420) by [@koxudaxi](https://github.com/koxudaxi).
* Update and clarify testing function name. PR [#1395](https://github.com/khulnasoft/readyapi/pull/1395) by [@chenl](https://github.com/chenl).
* Fix duplicated headers created by indirect dependencies that use the request directly. PR [#1386](https://github.com/khulnasoft/readyapi/pull/1386) by [@obataku](https://github.com/obataku) from tests by [@scottsmith2gmail](https://github.com/scottsmith2gmail).
* Upgrade Starlette version to `0.13.4`. PR [#1361](https://github.com/khulnasoft/readyapi/pull/1361) by [@rushton](https://github.com/rushton).
* Improve error handling and feedback for requests with invalid JSON. PR [#1354](https://github.com/khulnasoft/readyapi/pull/1354) by [@aviramha](https://github.com/aviramha).
* Add support for declaring metadata for tags in OpenAPI. New docs at [Tutorial - Metadata and Docs URLs - Metadata for tags](https://readyapi.github.io/tutorial/metadata/#metadata-for-tags). PR [#1348](https://github.com/khulnasoft/readyapi/pull/1348) by [@thomas-maschler](https://github.com/thomas-maschler).
* Add basic setup for Russian translations. PR [#1566](https://github.com/khulnasoft/readyapi/pull/1566).
* Remove obsolete Chinese articles after adding official community translations. PR [#1510](https://github.com/khulnasoft/readyapi/pull/1510) by [@waynerv](https://github.com/waynerv).
* Add `__repr__` for *path operation function* parameter helpers (like `Query`, `Depends`, etc) to simplify debugging. PR [#1560](https://github.com/khulnasoft/readyapi/pull/1560) by [@rkbeatss](https://github.com/rkbeatss) and [@victorphoenix3](https://github.com/victorphoenix3).

## 0.56.1

* Add link to advanced docs from tutorial. PR [#1512](https://github.com/khulnasoft/readyapi/pull/1512) by [@kx-chen](https://github.com/kx-chen).
...
* Add translation to Chinese for [Query Parameters and String Validations - 查询参数和字符串校验](https://readyapi.github.io/zh/tutorial/query-params-str-validations/). PR [#1500](https://github.com/khulnasoft/readyapi/pull/1500) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Request Body - 请求体](https://readyapi.github.io/zh/tutorial/body/). PR [#1492](https://github.com/khulnasoft/readyapi/pull/1492) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Help ReadyAPI - Get Help - 帮助 ReadyAPI - 获取帮助](https://readyapi.github.io/zh/help-readyapi/). PR [#1465](https://github.com/khulnasoft/readyapi/pull/1465) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Query Parameters - 查询参数](https://readyapi.github.io/zh/tutorial/query-params/). PR [#1454](https://github.com/khulnasoft/readyapi/pull/1454) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Contributing - 开发 - 贡献](https://readyapi.github.io/zh/contributing/). PR [#1460](https://github.com/khulnasoft/readyapi/pull/1460) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Path Parameters - 路径参数](https://readyapi.github.io/zh/tutorial/path-params/). PR [#1453](https://github.com/khulnasoft/readyapi/pull/1453) by [@waynerv](https://github.com/waynerv).
* Add official Microsoft project generator for [serving spaCy with ReadyAPI and Azure Cognitive Skills](https://github.com/microsoft/cookiecutter-spacy-readyapi) to [Project Generators](https://readyapi.github.io/project-generation/). PR [#1390](https://github.com/khulnasoft/readyapi/pull/1390) by [@kabirkhan](https://github.com/kabirkhan).
* Update docs in [Python Types Intro](https://readyapi.github.io/python-types/) to include info about `Optional`. Original PR [#1377](https://github.com/khulnasoft/readyapi/pull/1377) by [@yaegassy](https://github.com/yaegassy).
...
* Add translation to Chinese for [First Steps - 第一步](https://readyapi.github.io/zh/tutorial/first-steps/). PR [#1323](https://github.com/khulnasoft/readyapi/pull/1323) by [@waynerv](https://github.com/waynerv).
* Fix generating OpenAPI for apps using callbacks with routers including Pydantic models. PR [#1322](https://github.com/khulnasoft/readyapi/pull/1322) by [@nsidnev](https://github.com/nsidnev).
* Optimize internal regex performance in `get_path_param_names()`. PR [#1243](https://github.com/khulnasoft/readyapi/pull/1243) by [@heckad](https://github.com/heckad).
* Remove `*,` from functions in docs where it's not needed. PR [#1239](https://github.com/khulnasoft/readyapi/pull/1239) by [@pankaj-giri](https://github.com/pankaj-giri).
* Start translations for Italian. PR [#1557](https://github.com/khulnasoft/readyapi/pull/1557) by [@csr](https://github.com/csr).
...
* Add support for ASGI `root_path`:
    ...
    * Add new/updated docs for [Sub Applications - Mounts](https://readyapi.github.io/advanced/sub-applications/), without `openapi_prefix` (as it is now handled automatically).
    * Add new/updated docs for [Behind a Proxy](https://readyapi.github.io/advanced/behind-a-proxy/), including how to setup a local testing proxy with Traefik and using `root_path`.
    * Update docs for [Extending OpenAPI](https://readyapi.github.io/advanced/extending-openapi/) with the new `openapi_prefix` parameter passed (internally generated from `root_path`).
    * Original PR [#1199](https://github.com/khulnasoft/readyapi/pull/1199) by [@iksteen](https://github.com/iksteen).
* Update new issue templates and docs: [Help ReadyAPI - Get Help](https://readyapi.github.io/help-readyapi/). PR [#1531](https://github.com/khulnasoft/readyapi/pull/1531).
...
* Add translation to Chinese for [Python Types Intro - Python 类型提示简介](https://readyapi.github.io/zh/python-types/). PR [#1197](https://github.com/khulnasoft/readyapi/pull/1197) by [@waynerv](https://github.com/waynerv).
...
* Fix typo. PR [#1326](https://github.com/khulnasoft/readyapi/pull/1326) by [@chenl](https://github.com/chenl).
* Add translation to Portuguese for [Alternatives, Inspiration and Comparisons - Alternativas, Inspiração e Comparações](https://readyapi.github.io/pt/alternatives/). PR [#1325](https://github.com/khulnasoft/readyapi/pull/1325) by [@Serrones](https://github.com/Serrones).
* Fix 2 typos in docs. PR [#1324](https://github.com/khulnasoft/readyapi/pull/1324) by [@waynerv](https://github.com/waynerv).
* Update CORS docs, fix correct default of `max_age=600`. PR [#1301](https://github.com/khulnasoft/readyapi/pull/1301) by [@derekbekoe](https://github.com/derekbekoe).
* Add translation of [main page to Portuguese](https://readyapi.github.io/pt/). PR [#1300](https://github.com/khulnasoft/readyapi/pull/1300) by [@Serrones](https://github.com/Serrones).
* Re-word and clarify docs for extra info in fields. PR [#1299](https://github.com/khulnasoft/readyapi/pull/1299) by [@chris-allnutt](https://github.com/chris-allnutt).
* Make sure the `*` in short features in the docs is consistent (after `.`) in all languages. PR [#1424](https://github.com/khulnasoft/readyapi/pull/1424).
* Update order of execution for `get_db` in SQLAlchemy tutorial. PR [#1293](https://github.com/khulnasoft/readyapi/pull/1293) by [@bcb](https://github.com/bcb).
* Fix typos in Async docs. PR [#1423](https://github.com/khulnasoft/readyapi/pull/1423).

## 0.54.2

* Add translation to Spanish for [Concurrency and async / await - Concurrencia y async / await](https://readyapi.github.io/es/async/). PR [#1290](https://github.com/khulnasoft/readyapi/pull/1290) by [@alvaropernas](https://github.com/alvaropernas).
* Remove obsolete vote link. PR [#1289](https://github.com/khulnasoft/readyapi/pull/1289) by [@donhui](https://github.com/donhui).
* Allow disabling docs UIs by just disabling OpenAPI with `openapi_url=None`. New example in docs: [Advanced: Conditional OpenAPI](https://readyapi.github.io/advanced/conditional-openapi/). PR [#1421](https://github.com/khulnasoft/readyapi/pull/1421).
* Add translation to Portuguese for [Benchmarks - Comparações](https://readyapi.github.io/pt/benchmarks/). PR [#1274](https://github.com/khulnasoft/readyapi/pull/1274) by [@Serrones](https://github.com/Serrones).
* Add translation to Portuguese for [Tutorial - User Guide - Intro - Tutorial - Guia de Usuário - Introdução](https://readyapi.github.io/pt/tutorial/). PR [#1259](https://github.com/khulnasoft/readyapi/pull/1259) by [@marcosmmb](https://github.com/marcosmmb).
* Allow using Unicode in MkDocs for translations. PR [#1419](https://github.com/khulnasoft/readyapi/pull/1419).
* Add translation to Spanish for [Advanced User Guide - Intro - Guía de Usuario Avanzada - Introducción](https://readyapi.github.io/es/advanced/). PR [#1250](https://github.com/khulnasoft/readyapi/pull/1250) by [@jfunez](https://github.com/jfunez).
* Add translation to Portuguese for [History, Design and Future - História, Design e Futuro](https://readyapi.github.io/pt/history-design-future/). PR [#1249](https://github.com/khulnasoft/readyapi/pull/1249) by [@marcosmmb](https://github.com/marcosmmb).
* Add translation to Portuguese for [Features - Recursos](https://readyapi.github.io/pt/features/). PR [#1248](https://github.com/khulnasoft/readyapi/pull/1248) by [@marcosmmb](https://github.com/marcosmmb).
* Add translation to Spanish for [Tutorial - User Guide - Intro - Tutorial - Guía de Usuario - Introducción](https://readyapi.github.io/es/tutorial/). PR [#1244](https://github.com/khulnasoft/readyapi/pull/1244) by [@MartinEliasQ](https://github.com/MartinEliasQ).
* Add translation to Chinese for [Deployment - 部署](https://readyapi.github.io/zh/deployment/). PR [#1203](https://github.com/khulnasoft/readyapi/pull/1203) by [@RunningIkkyu](https://github.com/RunningIkkyu).
* Add translation to Chinese for [Tutorial - User Guide - Intro - 教程 - 用户指南 - 简介](https://readyapi.github.io/zh/tutorial/). PR [#1202](https://github.com/khulnasoft/readyapi/pull/1202) by [@waynerv](https://github.com/waynerv).
* Add translation to Chinese for [Features - 特性](https://readyapi.github.io/zh/features/). PR [#1192](https://github.com/khulnasoft/readyapi/pull/1192) by [@Dustyposa](https://github.com/Dustyposa).
* Add translation for [main page to Chinese](https://readyapi.github.io/zh/) PR [#1191](https://github.com/khulnasoft/readyapi/pull/1191) by [@waynerv](https://github.com/waynerv).
* Update docs for project generation. PR [#1287](https://github.com/khulnasoft/readyapi/pull/1287).
* Add Spanish translation for [Introducción a los Tipos de Python (Python Types Intro)](https://readyapi.github.io/es/python-types/). PR [#1237](https://github.com/khulnasoft/readyapi/pull/1237) by [@mariacamilagl](https://github.com/mariacamilagl).
* Add Spanish translation for [Características (Features)](https://readyapi.github.io/es/features/). PR [#1220](https://github.com/khulnasoft/readyapi/pull/1220) by [@mariacamilagl](https://github.com/mariacamilagl).

## 0.54.1

* Update database test setup. PR [#1226](https://github.com/khulnasoft/readyapi/pull/1226).
* Improve test debugging by showing response text in failing tests. PR [#1222](https://github.com/khulnasoft/readyapi/pull/1222) by [@samuelcolvin](https://github.com/samuelcolvin).

## 0.54.0

* Fix grammatical mistakes in async docs. PR [#1188](https://github.com/khulnasoft/readyapi/pull/1188) by [@mickeypash](https://github.com/mickeypash).
* Add support for `response_model_exclude_defaults` and `response_model_exclude_none`:
    ...
    * PR [#1166](https://github.com/khulnasoft/readyapi/pull/1166) by [@voegtlel](https://github.com/voegtlel).
* Add example about [Testing a Database](https://readyapi.github.io/advanced/testing-database/). Initial PR [#1144](https://github.com/khulnasoft/readyapi/pull/1144) by [@duganchen](https://github.com/duganchen).
* Update docs for [Development - Contributing: Translations](https://readyapi.github.io/contributing/#translations) including note about reviewing translation PRs. [#1215](https://github.com/khulnasoft/readyapi/pull/1215).
* Update log style in README.md for GitHub Markdown compatibility. PR [#1200](https://github.com/khulnasoft/readyapi/pull/1200) by [#geekgao](https://github.com/geekgao).
...
* Add first translation to Spanish [ReadyAPI](https://readyapi.github.io/es/). PR [#1201](https://github.com/khulnasoft/readyapi/pull/1201) by [@mariacamilagl](https://github.com/mariacamilagl).
* Add docs about [Settings and Environment Variables](https://readyapi.github.io/advanced/settings/). Initial PR [1118](https://github.com/khulnasoft/readyapi/pull/1118) by [@alexmitelman](https://github.com/alexmitelman).

## 0.53.2

* Fix automatic embedding of body fields for dependencies and sub-dependencies. Original PR [#1079](https://github.com/khulnasoft/readyapi/pull/1079) by [@Toad2186](https://github.com/Toad2186).
* Fix dependency overrides in WebSocket testing. PR [#1122](https://github.com/khulnasoft/readyapi/pull/1122) by [@amitlissack](https://github.com/amitlissack).
* Fix docs script to ensure languages are always sorted. PR [#1189](https://github.com/khulnasoft/readyapi/pull/1189).
* Start translations for Chinese. PR [#1187](https://github.com/khulnasoft/readyapi/pull/1187) by [@RunningIkkyu](https://github.com/RunningIkkyu).
* Add docs for [Schema Extra - Example](https://readyapi.github.io/tutorial/schema-extra-example/). PR [#1185](https://github.com/khulnasoft/readyapi/pull/1185).

## 0.53.1

* Fix included example after translations refactor. PR [#1182](https://github.com/khulnasoft/readyapi/pull/1182).
* Add docs example for `example` in `Field`. Docs at [Body - Fields: JSON Schema extras](https://readyapi.github.io/tutorial/body-fields/#json-schema-extras). PR [#1106](https://github.com/khulnasoft/readyapi/pull/1106) by [@JohnPaton](https://github.com/JohnPaton).
* Fix using recursive models in `response_model`. PR [#1164](https://github.com/khulnasoft/readyapi/pull/1164) by [@voegtlel](https://github.com/voegtlel).
* Add docs for [Pycharm Debugging](https://readyapi.github.io/tutorial/debugging/). PR [#1096](https://github.com/khulnasoft/readyapi/pull/1096) by [@youngquan](https://github.com/youngquan).
* Fix typo in docs. PR [#1148](https://github.com/khulnasoft/readyapi/pull/1148) by [@PLNech](https://github.com/PLNech).
* Update Windows development environment instructions. PR [#1179](https://github.com/khulnasoft/readyapi/pull/1179).

## 0.53.0

* Update test coverage badge. PR [#1175](https://github.com/khulnasoft/readyapi/pull/1175).
* Add `orjson` to `pip install readyapi[all]`. PR [#1161](https://github.com/khulnasoft/readyapi/pull/1161) by [@michael0liver](https://github.com/michael0liver).
...
* Add support for docs translations. New docs: [Development - Contributing: Docs: Translations](https://readyapi.github.io/contributing/#translations). PR [#1168](https://github.com/khulnasoft/readyapi/pull/1168).
...
* Add new high-performance JSON response class using `orjson`. New docs: [Custom Response - HTML, Stream, File, others: `ORJSONResponse`](https://readyapi.github.io/advanced/custom-response/#use-orjsonresponse). PR [#1065](https://github.com/khulnasoft/readyapi/pull/1065).

## 0.51.0

* Re-export utils from Starlette:
    * This allows using things like `from readyapi.responses import JSONResponse` instead of `from starlette.responses import JSONResponse`.
    * It's mainly syntax sugar, a convenience for developer experience.
    * Now `Request`, `Response`, `WebSocket`, `status` can be imported directly from `readyapi` as in `from readyapi import Response`. This is because those are frequently used, to use the request directly, to set headers and cookies, to get status codes, etc.
    * Documentation changes in many places, but new docs and noticeable improvements:
        * [Custom Response - HTML, Stream, File, others](https://readyapi.github.io/advanced/custom-response/).
        * [Advanced Middleware](https://readyapi.github.io/advanced/middleware/).
        * [Including WSGI - Flask, Django, others](https://readyapi.github.io/advanced/wsgi/).
    * PR [#1064](https://github.com/khulnasoft/readyapi/pull/1064).

## 0.50.0

* Add link to Release Notes from docs about pinning versions for deployment. PR [#1058](https://github.com/khulnasoft/readyapi/pull/1058).
...
* Add docs about pinning ReadyAPI versions for deployment: [Deployment: ReadyAPI versions](https://readyapi.github.io/deployment/#readyapi-versions). PR [#1056](https://github.com/khulnasoft/readyapi/pull/1056).

## 0.49.2

* Fix links in release notes. PR [#1052](https://github.com/khulnasoft/readyapi/pull/1052) by [@sattosan](https://github.com/sattosan).
* Fix typo in release notes. PR [#1051](https://github.com/khulnasoft/readyapi/pull/1051) by [@sattosan](https://github.com/sattosan).
* Refactor/clarify `serialize_response` parameter name to avoid confusion. PR [#1031](https://github.com/khulnasoft/readyapi/pull/1031) by [@patrickmckenna](https://github.com/patrickmckenna).
* Refactor calling each a path operation's handler function in an isolated function, to simplify profiling. PR [#1027](https://github.com/khulnasoft/readyapi/pull/1027) by [@sm-Fifteen](https://github.com/sm-Fifteen).
* Add missing dependencies for testing. PR [#1026](https://github.com/khulnasoft/readyapi/pull/1026) by [@sm-Fifteen](https://github.com/sm-Fifteen).
* Fix accepting valid types for response models, including Python types like `List[int]`. PR [#1017](https://github.com/khulnasoft/readyapi/pull/1017) by [@patrickmckenna](https://github.com/patrickmckenna).
* Fix format in SQL tutorial. PR [#1015](https://github.com/khulnasoft/readyapi/pull/1015) by [@vegarsti](https://github.com/vegarsti).

## 0.49.1

* Fix path operation duplicated parameters when used in dependencies and the path operation function. PR [#994](https://github.com/khulnasoft/readyapi/pull/994) by [@merowinger92](https://github.com/merowinger92).
* Update Netlify previews deployment GitHub action as the fix is already merged and there's a new release. PR [#1047](https://github.com/khulnasoft/readyapi/pull/1047).
* Move mypy configurations to config file. PR [#987](https://github.com/khulnasoft/readyapi/pull/987) by [@hukkinj1](https://github.com/hukkinj1).
* Temporary fix to Netlify previews not deployable from PRs from forks. PR [#1046](https://github.com/khulnasoft/readyapi/pull/1046) by [@mariacamilagl](https://github.com/mariacamilagl).
...
* Add articles to [External Links](https://readyapi.github.io/external-links/): [PythonのWeb frameworkのパフォーマンス比較 (Django, Flask, responder, ReadyAPI, japronto)](https://qiita.com/bee2/items/0ad260ab9835a2087dae) and [[ReadyAPI] Python製のASGI Web フレームワーク ReadyAPIに入門する](https://qiita.com/bee2/items/75d9c0d7ba20e7a4a0e9). PR [#974](https://github.com/khulnasoft/readyapi/pull/974) by [@tokusumi](https://github.com/tokusumi).
...
* Add Mermaid JS support for diagrams in docs. Add first diagrams to [Dependencies: First Steps](https://readyapi.github.io/tutorial/dependencies/) and [Dependencies with `yield` and `HTTPException`](https://readyapi.github.io/tutorial/dependencies/dependencies-with-yield/#dependencies-with-yield-and-httpexception). PR [#985](https://github.com/khulnasoft/readyapi/pull/985).
* Update CI to run docs deployment in GitHub actions. PR [#983](https://github.com/khulnasoft/readyapi/pull/983).
* Allow `callable`s in *path operation functions*, like functions modified with `functools.partial`. PR [#977](https://github.com/khulnasoft/readyapi/pull/977).
...
* Simplify [Peewee docs](https://readyapi.github.io/advanced/sql-databases-peewee/) with double dependency with `yield`. PR [#947](https://github.com/khulnasoft/readyapi/pull/947).
* Add article [External Links](https://readyapi.github.io/external-links/): [Create and Deploy ReadyAPI app to Heroku](https://www.tutlinks.com/create-and-deploy-readyapi-app-to-heroku/). PR [#942](https://github.com/khulnasoft/readyapi/pull/942) by [@windson](https://github.com/windson).
...
* Add article to [External Links](https://readyapi.github.io/external-links/): [How to continuously deploy a ReadyAPI to AWS Lambda with AWS SAM](https://iwpnd.pw/articles/2020-01/deploy-readyapi-to-aws-lambda). PR [#901](https://github.com/khulnasoft/readyapi/pull/901) by [@iwpnd](https://github.com/iwpnd).
...
* Refactor documentation to make a simpler and shorter [Tutorial - User Guide](https://readyapi.github.io/tutorial/) and an additional [Advanced User Guide](https://readyapi.github.io/advanced/) with all the additional docs. PR [#887](https://github.com/khulnasoft/readyapi/pull/887).
* Tweak external links, Markdown format, typos. PR [#881](https://github.com/khulnasoft/readyapi/pull/881).
* Fix bug in tutorial handling HTTP Basic Auth `username` and `password`. PR [#865](https://github.com/khulnasoft/readyapi/pull/865) by [@isaevpd](https://github.com/isaevpd).
* Fix handling form *path operation* parameters declared with pure classes like `list`, `tuple`, etc. PR [#856](https://github.com/khulnasoft/readyapi/pull/856) by [@nsidnev](https://github.com/nsidnev).
* Add request `body` to `RequestValidationError`, new docs: [Use the `RequestValidationError` body](https://readyapi.github.io/tutorial/handling-errors/#use-the-requestvalidationerror-body). Initial PR [#853](https://github.com/khulnasoft/readyapi/pull/853) by [@aviramha](https://github.com/aviramha).
* Update [External Links](https://readyapi.github.io/external-links/) with new links and dynamic GitHub projects with `readyapi` topic. PR [#850](https://github.com/khulnasoft/readyapi/pull/850).
* Fix Peewee `contextvars` handling in docs: [SQL (Relational) Databases with Peewee](https://readyapi.github.io/advanced/sql-databases-peewee/). PR [#879](https://github.com/khulnasoft/readyapi/pull/879).
* Setup development environment with Python's Venv and Flit, instead of requiring the extra Pipenv duplicating dependencies. Updated docs: [Development - Contributing](https://readyapi.github.io/contributing/). PR [#877](https://github.com/khulnasoft/readyapi/pull/877).
* Update docs for [HTTP Basic Auth](https://readyapi.github.io/advanced/security/http-basic-auth/) to improve security against timing attacks. Initial PR [#807](https://github.com/khulnasoft/readyapi/pull/807) by [@zwass](https://github.com/zwass).

## 0.46.0

* Fix typos and tweak configs. PR [#837](https://github.com/khulnasoft/readyapi/pull/837).
* Add link to Chinese article in [External Links](https://readyapi.github.io/external-links/). PR [810](https://github.com/khulnasoft/readyapi/pull/810) by [@wxq0309](https://github.com/wxq0309).
* Implement `OAuth2AuthorizationCodeBearer` class. PR [#797](https://github.com/khulnasoft/readyapi/pull/797) by [@kuwv](https://github.com/kuwv).
* Update example upgrade in docs main page. PR [#795](https://github.com/khulnasoft/readyapi/pull/795) by [@cdeil](https://github.com/cdeil).
* Fix callback handling for sub-routers. PR [#792](https://github.com/khulnasoft/readyapi/pull/792) by [@jekirl](https://github.com/jekirl).
* Fix typos. PR [#784](https://github.com/khulnasoft/readyapi/pull/784) by [@kkinder](https://github.com/kkinder).
* Add 4 Japanese articles to [External Links](https://readyapi.github.io/external-links/). PR [#783](https://github.com/khulnasoft/readyapi/pull/783) by [@HymanZHAN](https://github.com/HymanZHAN).
...
* Add docs for correctly [using ReadyAPI with Peewee ORM](https://readyapi.github.io/advanced/sql-databases-peewee/). Including how to overwrite parts of Peewee to correctly handle async threads. PR [#789](https://github.com/khulnasoft/readyapi/pull/789).

## 0.45.0

* Add support for OpenAPI Callbacks:
    * New docs: [OpenAPI Callbacks](https://readyapi.github.io/advanced/openapi-callbacks/).
...
* Add article to [External Links](https://readyapi.github.io/external-links/): [Почему Вы должны попробовать ReadyAPI?](https://habr.com/ru/post/478620/). PR [#766](https://github.com/khulnasoft/readyapi/pull/766) by [@prostomarkeloff](https://github.com/prostomarkeloff).
...
* Add GitHub social preview images to git. PR [#752](https://github.com/khulnasoft/readyapi/pull/752).
* Update PyPI "trove classifiers". PR [#751](https://github.com/khulnasoft/readyapi/pull/751).
* Add full support for Python 3.8. Enable Python 3.8 in full in Travis. PR [749](https://github.com/khulnasoft/readyapi/pull/749).
* Update "new issue" templates. PR [#749](https://github.com/khulnasoft/readyapi/pull/749).
* Fix serialization of errors for exotic Pydantic types. PR [#748](https://github.com/khulnasoft/readyapi/pull/748) by [@dmontagu](https://github.com/dmontagu).

## 0.44.0

* Add GitHub action [Issue Manager](https://github.com/khulnasoft/issue-manager). PR [#742](https://github.com/khulnasoft/readyapi/pull/742).
* Fix typos in docs. PR [734](https://github.com/khulnasoft/readyapi/pull/734) by [@bundabrg](https://github.com/bundabrg).
* Fix usage of `custom_encoder` in `jsonable_encoder`. PR [#715](https://github.com/khulnasoft/readyapi/pull/715) by [@matrixise](https://github.com/matrixise).
* Fix invalid XML example. PR [710](https://github.com/khulnasoft/readyapi/pull/710) by [@OcasoProtal](https://github.com/OcasoProtal).
...
* Update docs to reduce gender bias. PR [#645](https://github.com/khulnasoft/readyapi/pull/645) by [@ticosax](https://github.com/ticosax).
* Add docs about [overriding the `operationId` for all the *path operations*](https://readyapi.github.io/advanced/path-operation-advanced-configuration/#using-the-path-operation-function-name-as-the-operationid) based on their function name. PR [#642](https://github.com/khulnasoft/readyapi/pull/642) by [@SKalt](https://github.com/SKalt).
* Fix validators in models generating an incorrect key order. PR [#637](https://github.com/khulnasoft/readyapi/pull/637) by [@jaddison](https://github.com/jaddison).
* Generate correct OpenAPI docs for responses with no content. PR [#621](https://github.com/khulnasoft/readyapi/pull/621) by [@brotskydotcom](https://github.com/brotskydotcom).
* Remove `$` from Bash code blocks in docs for consistency. PR [#613](https://github.com/khulnasoft/readyapi/pull/613) by [@nstapelbroek](https://github.com/nstapelbroek).
* Add docs for [self-serving docs' (Swagger UI) static assets](https://readyapi.github.io/advanced/extending-openapi/#self-hosting-javascript-and-css-for-docs), e.g. to use the docs offline, or without Internet. Initial PR [#557](https://github.com/khulnasoft/readyapi/pull/557) by [@svalouch](https://github.com/svalouch).
* Fix `black` linting after upgrade. PR [#682](https://github.com/khulnasoft/readyapi/pull/682) by [@frankie567](https://github.com/frankie567).
...
* Add dependencies with `yield`, a.k.a. exit steps, context managers, cleanup, teardown, ...
    ...
    * It works by default in Python 3.7 or above. For Python 3.6, it requires the extra backport dependencies:
        * `async-exit-stack`
        * `async-generator`
    * New docs at [Dependencies with `yield`](https://readyapi.github.io/tutorial/dependencies/dependencies-with-yield/).
    * Updated database docs [SQL (Relational) Databases: Main **ReadyAPI** app](https://readyapi.github.io/tutorial/sql-databases/#main-readyapi-app).
...
* Improve handling of custom classes for `Request`s and `APIRoute`s.
    ...
    * New docs section: [Custom Request and APIRoute class](https://readyapi.github.io/advanced/custom-request-and-route/).
    * PR [#589](https://github.com/khulnasoft/readyapi/pull/589) by [@dmontagu](https://github.com/dmontagu).
* Fix preserving custom route class in routers when including other sub-routers. PR [#538](https://github.com/khulnasoft/readyapi/pull/538) by [@dmontagu](https://github.com/dmontagu).

## 0.40.0

* Add notes to docs about installing `python-multipart` when using forms. PR [#574](https://github.com/khulnasoft/readyapi/pull/574) by [@sliptonic](https://github.com/sliptonic).
* Generate OpenAPI schemas in alphabetical order. PR [#554](https://github.com/khulnasoft/readyapi/pull/554) by [@dmontagu](https://github.com/dmontagu).
* Add support for truncating docstrings from *path operation functions*.
    * New docs at [Advanced description from docstring](https://readyapi.github.io/advanced/path-operation-advanced-configuration/#advanced-description-from-docstring).
    * PR [#556](https://github.com/khulnasoft/readyapi/pull/556) by [@svalouch](https://github.com/svalouch).
* Fix `DOCTYPE` in HTML files generated for Swagger UI and ReDoc. PR [#537](https://github.com/khulnasoft/readyapi/pull/537) by [@Trim21](https://github.com/Trim21).
* Fix handling `4XX` responses overriding default `422` validation error responses. PR [#517](https://github.com/khulnasoft/readyapi/pull/517) by [@tsouvarev](https://github.com/tsouvarev).
* Fix typo in documentation for [Simple HTTP Basic Auth](https://readyapi.github.io/advanced/security/http-basic-auth/#simple-http-basic-auth). PR [#514](https://github.com/khulnasoft/readyapi/pull/514) by [@prostomarkeloff](https://github.com/prostomarkeloff).
* Fix incorrect documentation example in [first steps](https://readyapi.github.io/tutorial/first-steps/). PR [#511](https://github.com/khulnasoft/readyapi/pull/511) by [@IgnatovFedor](https://github.com/IgnatovFedor).
* Add support for Swagger UI [initOauth](https://github.com/swagger-api/swagger-ui/blob/master/docs/usage/oauth2.md) settings with the parameter `swagger_ui_init_oauth`. PR [#499](https://github.com/khulnasoft/readyapi/pull/499) by [@zamiramir](https://github.com/zamiramir).
...
* Fix incorrect `Request` class import. PR [#493](https://github.com/khulnasoft/readyapi/pull/493) by [@kamalgill](https://github.com/kamalgill).

## 0.38.0

* Add recent articles to [External Links](https://readyapi.github.io/external-links/) and recent opinions. PR [#490](https://github.com/khulnasoft/readyapi/pull/490).
* Upgrade support range for Starlette to include `0.12.8`. The new range is `>=0.11.1,<=0.12.8"`. PR [#477](https://github.com/khulnasoft/readyapi/pull/477) by [@dmontagu](https://github.com/dmontagu).
* Upgrade support to Pydantic version 0.32.2 and update internal code to use it (breaking change). PR [#463](https://github.com/khulnasoft/readyapi/pull/463) by [@dmontagu](https://github.com/dmontagu).

## 0.37.0

* Add support for custom route classes for advanced use cases. PR [#468](https://github.com/khulnasoft/readyapi/pull/468) by [@dmontagu](https://github.com/dmontagu).
* Allow disabling Google fonts in ReDoc. PR [#481](https://github.com/khulnasoft/readyapi/pull/481) by [@b1-luettje](https://github.com/b1-luettje).
* Fix security issue: when returning a sub-class of a response model and using `skip_defaults` it could leak information. PR [#485](https://github.com/khulnasoft/readyapi/pull/485) by [@dmontagu](https://github.com/dmontagu).
* Enable tests for Python 3.8-dev. PR [#465](https://github.com/khulnasoft/readyapi/pull/465) by [@Jamim](https://github.com/Jamim).
...
* Fix using `"default"` extra response with status codes at the same time. PR [#489](https://github.com/khulnasoft/readyapi/pull/489).
* Allow additional responses to use status code ranges (like `5XX` and `4XX`) and `"default"`. PR [#435](https://github.com/khulnasoft/readyapi/pull/435) by [@divums](https://github.com/divums).

## 0.36.0

* Fix implementation for `skip_defaults` when returning a Pydantic model. PR [#422](https://github.com/khulnasoft/readyapi/pull/422) by [@dmontagu](https://github.com/dmontagu).
* Fix OpenAPI generation when using the same dependency in multiple places for the same *path operation*. PR [#417](https://github.com/khulnasoft/readyapi/pull/417) by [@dmontagu](https://github.com/dmontagu).
* Allow having empty paths in *path operations* used with `include_router` and a `prefix`.
    ...
    * PR [#415](https://github.com/khulnasoft/readyapi/pull/415) by [@vitalik](https://github.com/vitalik).
* Fix mypy error after merging PR #415. PR [#462](https://github.com/khulnasoft/readyapi/pull/462).

## 0.35.0

* Fix typo in routing `assert`. PR [#419](https://github.com/khulnasoft/readyapi/pull/419) by [@pablogamboa](https://github.com/pablogamboa).
* Fix typo in docs. PR [#411](https://github.com/khulnasoft/readyapi/pull/411) by [@bronsen](https://github.com/bronsen).
* Fix parsing a body type declared with `Union`. PR [#400](https://github.com/khulnasoft/readyapi/pull/400) by [@koxudaxi](https://github.com/koxudaxi).

## 0.34.0

* Upgrade Starlette supported range to include the latest `0.12.7`. The new range is `0.11.1,<=0.12.7`. PR [#367](https://github.com/khulnasoft/readyapi/pull/367) by [@dedsm](https://github.com/dedsm).

* Add test for OpenAPI schema with duplicate models from PR [#333](https://github.com/khulnasoft/readyapi/pull/333) by [@dmontagu](https://github.com/dmontagu). PR [#385](https://github.com/khulnasoft/readyapi/pull/385).

## 0.33.0

* Upgrade Pydantic version to `0.30.0`. PR [#384](https://github.com/khulnasoft/readyapi/pull/384) by [@jekirl](https://github.com/jekirl).

## 0.32.0

* Fix typo in docs for features. PR [#380](https://github.com/khulnasoft/readyapi/pull/380) by [@MartinoMensio](https://github.com/MartinoMensio).

* Fix source code `limit` for example in [Query Parameters](https://readyapi.github.io/tutorial/query-params/). PR [#366](https://github.com/khulnasoft/readyapi/pull/366) by [@Smashman](https://github.com/Smashman).

* Update wording in docs about [OAuth2 scopes](https://readyapi.github.io/advanced/security/oauth2-scopes/). PR [#371](https://github.com/khulnasoft/readyapi/pull/371) by [@cjw296](https://github.com/cjw296).

* Update docs for `Enum`s to inherit from `str` and improve Swagger UI rendering. PR [#351](https://github.com/khulnasoft/readyapi/pull/351).

* Fix regression, add Swagger UI deep linking again. PR [#350](https://github.com/khulnasoft/readyapi/pull/350).

* Add test for having path templates in `prefix` of `.include_router`. PR [#349](https://github.com/khulnasoft/readyapi/pull/349).

* Add note to docs: [Include the same router multiple times with different `prefix`](https://readyapi.github.io/tutorial/bigger-applications/#include-the-same-router-multiple-times-with-different-prefix). PR [#348](https://github.com/khulnasoft/readyapi/pull/348).
...
* Fix OpenAPI/JSON Schema generation for two functions with the same name (in different modules) with the same composite bodies.
    ...
    * PR [#347](https://github.com/khulnasoft/readyapi/pull/347).
...
* Upgrade Pydantic supported version to `0.29.0`.
    ...
    * PR [#344](https://github.com/khulnasoft/readyapi/pull/344).

## 0.30.1

* Add section in docs about [External Links and Articles](https://readyapi.github.io/external-links/). PR [#341](https://github.com/khulnasoft/readyapi/pull/341).
...
* Update section about [Help ReadyAPI - Get Help](https://readyapi.github.io/help-readyapi/). PR [#339](https://github.com/khulnasoft/readyapi/pull/339).
...
* Update and clarify [SQL tutorial with SQLAlchemy](https://readyapi.github.io/tutorial/sql-databases/). PR [#331](https://github.com/khulnasoft/readyapi/pull/331) by [@mariacamilagl](https://github.com/mariacamilagl).

* Add SQLite [online viewers to the docs](https://readyapi.github.io/tutorial/sql-databases/#interact-with-the-database-directly). PR [#330](https://github.com/khulnasoft/readyapi/pull/330) by [@cyrilbois](https://github.com/cyrilbois).

## 0.30.0

* Add support for Pydantic's ORM mode:
    * Updated documentation about SQL with SQLAlchemy, using Pydantic models with ORM mode, SQLAlchemy models with relations, separation of files, simplification of code and other changes. New docs: [SQL (Relational) Databases](https://readyapi.github.io/tutorial/sql-databases/).
    ...
    * New documentation about receiving plain `dict`s as request bodies: [Bodies of arbitrary `dict`s](https://readyapi.github.io/tutorial/body-nested-models/#bodies-of-arbitrary-dicts).
    * New documentation about returning arbitrary `dict`s in responses: [Response with arbitrary `dict`](https://readyapi.github.io/tutorial/extra-models/#response-with-arbitrary-dict).
    * **Technical Details**:
    ...
    * PR [#322](https://github.com/khulnasoft/readyapi/pull/322).

* Remove/clean unused RegEx code in routing. PR [#314](https://github.com/khulnasoft/readyapi/pull/314) by [@dmontagu](https://github.com/dmontagu).

* Use default response status code descriptions for additional responses. PR [#313](https://github.com/khulnasoft/readyapi/pull/313) by [@duxiaoyao](https://github.com/duxiaoyao).

* Upgrade Pydantic support to `0.28`. PR [#320](https://github.com/khulnasoft/readyapi/pull/320) by [@jekirl](https://github.com/jekirl).

## 0.29.1

* Fix handling an empty-body request with a required body param. PR [#311](https://github.com/khulnasoft/readyapi/pull/311).

* Fix broken link in docs: [Return a Response directly](https://readyapi.github.io/advanced/response-directly/). PR [#306](https://github.com/khulnasoft/readyapi/pull/306) by [@dmontagu](https://github.com/dmontagu).

* Fix docs discrepancy in docs for [Response Model](https://readyapi.github.io/tutorial/response-model/). PR [#288](https://github.com/khulnasoft/readyapi/pull/288) by [@awiddersheim](https://github.com/awiddersheim).

## 0.29.0

* Add support for declaring a `Response` parameter:
    * This allows declaring:
        * [Response Cookies](https://readyapi.github.io/advanced/response-cookies/).
        * [Response Headers](https://readyapi.github.io/advanced/response-headers/).
        * An HTTP Status Code different than the default: [Response - Change Status Code](https://readyapi.github.io/advanced/response-change-status-code/).
    ...
    * PR [#294](https://github.com/khulnasoft/readyapi/pull/294).
...
* Implement dependency cache per request.
    ...
    * Updated docs at: [Using the same dependency multiple times](https://readyapi.github.io/tutorial/dependencies/sub-dependencies/#using-the-same-dependency-multiple-times).
    * PR [#292](https://github.com/khulnasoft/readyapi/pull/292).

* Implement dependency overrides for testing.
    * This allows using overrides/mocks of dependencies during tests.
    * New docs: [Testing Dependencies with Overrides](https://readyapi.github.io/advanced/testing-dependencies/).
    * PR [#291](https://github.com/khulnasoft/readyapi/pull/291).

## 0.27.2

* Fix path and query parameters receiving `dict` as a valid type. It should be mapped to a body payload. PR [#287](https://github.com/khulnasoft/readyapi/pull/287). Updated docs at: [Query parameter list / multiple values with defaults: Using `list`](https://readyapi.github.io/tutorial/query-params-str-validations/#using-list).

## 0.27.1

* Fix `auto_error=False` handling in `HTTPBearer` security scheme. Do not `raise` when there's an incorrect `Authorization` header if `auto_error=False`. PR [#282](https://github.com/khulnasoft/readyapi/pull/282).

* Fix type declaration of `HTTPException`. PR [#279](https://github.com/khulnasoft/readyapi/pull/279).

## 0.27.0

* Fix broken link in docs about OAuth 2.0 with scopes. PR [#275](https://github.com/khulnasoft/readyapi/pull/275) by [@dmontagu](https://github.com/dmontagu).
...
* Refactor param extraction using Pydantic `Field`:
    ...
    * Fix/add support for list *query parameters* with list defaults. New documentation: [Query parameter list / multiple values with defaults](https://readyapi.github.io/tutorial/query-params-str-validations/#query-parameter-list-multiple-values-with-defaults).
    * Add support for enumerations in *path operation* parameters. New documentation: [Path Parameters: Predefined values](https://readyapi.github.io/tutorial/path-params/#predefined-values).
    * Add support for type annotations using `Optional` as in `param: Optional[str] = None`. New documentation: [Optional type declarations](https://readyapi.github.io/tutorial/query-params/#optional-type-declarations).
    * PR [#278](https://github.com/khulnasoft/readyapi/pull/278).
...
* Separate error handling for validation errors.
    ...
    * New documentation about exceptions handlers:
        * [Install custom exception handlers](https://readyapi.github.io/tutorial/handling-errors/#install-custom-exception-handlers).
        * [Override the default exception handlers](https://readyapi.github.io/tutorial/handling-errors/#override-the-default-exception-handlers).
        * [Reuse **ReadyAPI's** exception handlers](https://readyapi.github.io/tutorial/handling-errors/#reuse-readyapis-exception-handlers).
...
* Fix support for *paths* in *path parameters* without needing explicit `Path(...)`.
    * PR [#256](https://github.com/khulnasoft/readyapi/pull/256).
    * Documented in PR [#272](https://github.com/khulnasoft/readyapi/pull/272) by [@wshayes](https://github.com/wshayes).
    * New documentation at: [Path Parameters containing paths](https://readyapi.github.io/tutorial/path-params/#path-parameters-containing-paths).

* Update docs for testing ReadyAPI. Include using `POST`, sending JSON, testing headers, etc. New documentation: [Testing](https://readyapi.github.io/tutorial/testing/#testing-extended-example). PR [#271](https://github.com/khulnasoft/readyapi/pull/271).
...
* Add support for Pydantic's `include`, `exclude`, `by_alias`.
    * Update documentation: [Response Model](https://readyapi.github.io/tutorial/response-model/#response_model_include-and-response_model_exclude).
    * Add docs for: [Body - updates](https://readyapi.github.io/tutorial/body-updates/), using Pydantic's `skip_defaults`.
    * Add method consistency tests.
    * PR [#264](https://github.com/khulnasoft/readyapi/pull/264).

* Add `CONTRIBUTING.md` file to GitHub, to help new contributors. PR [#255](https://github.com/khulnasoft/readyapi/pull/255) by [@wshayes](https://github.com/wshayes).
...
* Add support for Pydantic's `skip_defaults`:
    ...
    * New [documentation section about using `response_model_skip_defaults`](https://readyapi.github.io/tutorial/response-model/#response-model-encoding-parameters).
    * PR [#248](https://github.com/khulnasoft/readyapi/pull/248) by [@wshayes](https://github.com/wshayes).
...
* Add support for WebSockets with dependencies and parameters.
    ...
    * [Updated documentation for WebSockets](https://readyapi.github.io/advanced/websockets/).
    * PR [#178](https://github.com/khulnasoft/readyapi/pull/178) by [@jekirl](https://github.com/jekirl).
...
* Upgrade the compatible version of Pydantic to `0.26.0`.
    ...
    * PR [#247](https://github.com/khulnasoft/readyapi/pull/247) by [@euri10](https://github.com/euri10).
...
* Upgrade the compatible version of Starlette to `0.12.0`.
    ...
    * PR [#243](https://github.com/khulnasoft/readyapi/pull/243).
...
* Add OAuth2 redirect page for Swagger UI. This allows having delegated authentication in the Swagger UI docs. For this to work, you need to add `{your_origin}/docs/oauth2-redirect` to the allowed callbacks in your OAuth2 provider (in Auth0, Facebook, Google, etc).
    ...
    * PR [#198](https://github.com/khulnasoft/readyapi/pull/198) by [@steinitzu](https://github.com/steinitzu).

* Make Swagger UI and ReDoc route handlers (*path operations*) be `async` functions instead of lambdas to improve performance. PR [#241](https://github.com/khulnasoft/readyapi/pull/241) by [@Trim21](https://github.com/Trim21).

* Make Swagger UI and ReDoc URLs parameterizable, allowing to host and serve local versions of them and have offline docs. PR [#112](https://github.com/khulnasoft/readyapi/pull/112) by [@euri10](https://github.com/euri10).
...
* Add support for `dependencies` parameter:
    ...
    * New documentation about [dependencies in *path operation decorators*](https://readyapi.github.io/tutorial/dependencies/dependencies-in-path-operation-decorators/).
    * New documentation about [dependencies in the `include_router()` method](https://readyapi.github.io/tutorial/bigger-applications/#include-an-apirouter-with-a-prefix-tags-responses-and-dependencies).
    * PR [#235](https://github.com/khulnasoft/readyapi/pull/235).
...
* Re-enable `black` formatting checks for Python 3.7. PR [#229](https://github.com/khulnasoft/readyapi/pull/229) by [@zamiramir](https://github.com/zamiramir).

## 0.21.0

* On body parsing errors, raise `from` previous exception, to allow better introspection in logging code. PR [#192](https://github.com/khulnasoft/readyapi/pull/195) by [@ricardomomm](https://github.com/ricardomomm).

* Use Python logger named "`readyapi`" instead of root logger. PR [#222](https://github.com/khulnasoft/readyapi/pull/222) by [@euri10](https://github.com/euri10).

* Upgrade Pydantic to version 0.25. PR [#225](https://github.com/khulnasoft/readyapi/pull/225) by [@euri10](https://github.com/euri10).

* Fix typo in routing. PR [#221](https://github.com/khulnasoft/readyapi/pull/221) by [@djlambert](https://github.com/djlambert).
...
* Upgrade OAuth2:
    ...
    * Update, simplify, and improve all the [security docs](https://readyapi.github.io/advanced/security/).
    * Add new `scope_str` to `SecurityScopes` and update docs: [OAuth2 scopes](https://readyapi.github.io/advanced/security/oauth2-scopes/).
    * Update docs, images, tests.
    * PR [#188](https://github.com/khulnasoft/readyapi/pull/188).

* Include [Hypercorn](https://gitlab.com/pgjones/hypercorn) as an alternative ASGI server in the docs. PR [#187](https://github.com/khulnasoft/readyapi/pull/187).

* Add docs for [Static Files](https://readyapi.github.io/tutorial/static-files/) and [Templates](https://readyapi.github.io/advanced/templates/). PR [#186](https://github.com/khulnasoft/readyapi/pull/186).

* Add docs for handling [Response Cookies](https://readyapi.github.io/advanced/response-cookies/) and [Response Headers](https://readyapi.github.io/advanced/response-headers/). PR [#185](https://github.com/khulnasoft/readyapi/pull/185).

* Fix typos in docs. PR [#176](https://github.com/khulnasoft/readyapi/pull/176) by [@chdsbd](https://github.com/chdsbd).

## 0.19.0

* Rename *path operation decorator* parameter `content_type` to `response_class`. PR [#183](https://github.com/khulnasoft/readyapi/pull/183).

* Add docs:
    * How to use the `jsonable_encoder` in [JSON compatible encoder](https://readyapi.github.io/tutorial/encoder/).
    * How to [Return a Response directly](https://readyapi.github.io/advanced/response-directly/).
    * Update how to use a [Custom Response Class](https://readyapi.github.io/advanced/custom-response/).
    * PR [#184](https://github.com/khulnasoft/readyapi/pull/184).

## 0.18.0

* Add docs for [HTTP Basic Auth](https://readyapi.github.io/advanced/custom-response/). PR [#177](https://github.com/khulnasoft/readyapi/pull/177).

* Upgrade HTTP Basic Auth handling with automatic headers (automatic browser login prompt). PR [#175](https://github.com/khulnasoft/readyapi/pull/175).

* Update dependencies for security. PR [#174](https://github.com/khulnasoft/readyapi/pull/174).

* Add docs for [Middleware](https://readyapi.github.io/tutorial/middleware/). PR [#173](https://github.com/khulnasoft/readyapi/pull/173).

## 0.17.0

* Make Flit publish from CI. PR [#170](https://github.com/khulnasoft/readyapi/pull/170).

* Add documentation about handling [CORS (Cross-Origin Resource Sharing)](https://readyapi.github.io/tutorial/cors/). PR [#169](https://github.com/khulnasoft/readyapi/pull/169).

* By default, encode by alias. This allows using Pydantic `alias` parameters working by default. PR [#168](https://github.com/khulnasoft/readyapi/pull/168).

## 0.16.0

* Upgrade *path operation* `docstring` parsing to support proper Markdown descriptions. New documentation at [Path Operation Configuration](https://readyapi.github.io/tutorial/path-operation-configuration/#description-from-docstring). PR [#163](https://github.com/khulnasoft/readyapi/pull/163).

* Refactor internal usage of Pydantic to use correct data types. PR [#164](https://github.com/khulnasoft/readyapi/pull/164).

* Upgrade Pydantic to version `0.23`. PR [#160](https://github.com/khulnasoft/readyapi/pull/160) by [@euri10](https://github.com/euri10).

* Fix typo in Tutorial about Extra Models. PR [#159](https://github.com/khulnasoft/readyapi/pull/159) by [@danielmichaels](https://github.com/danielmichaels).

* Fix [Query Parameters](https://readyapi.github.io/tutorial/query-params/) URL examples in docs. PR [#157](https://github.com/khulnasoft/readyapi/pull/157) by [@hayata-yamamoto](https://github.com/hayata-yamamoto).

## 0.15.0

* Add support for multiple file uploads (as a single form field). New docs at: [Multiple file uploads](https://readyapi.github.io/tutorial/request-files/#multiple-file-uploads). PR [#158](https://github.com/khulnasoft/readyapi/pull/158).

* Add docs for: [Additional Status Codes](https://readyapi.github.io/advanced/additional-status-codes/). PR [#156](https://github.com/khulnasoft/readyapi/pull/156).
...
* Add docs for: [Testing **ReadyAPI**](https://readyapi.github.io/tutorial/testing/). PR [#151](https://github.com/khulnasoft/readyapi/pull/151).
...
* Update development dependencies, `Pipfile.lock`. PR [#150](https://github.com/khulnasoft/readyapi/pull/150).

* Include Falcon and Hug in: [Alternatives, Inspiration and Comparisons](https://readyapi.github.io/alternatives/).
...
* Improve/upgrade OAuth2 scopes support with `SecurityScopes`:
    ...
    * Updated docs about: [OAuth2 with Password (and hashing), Bearer with JWT tokens](https://readyapi.github.io/tutorial/security/oauth2-jwt/).
    * New docs about: [OAuth2 scopes](https://readyapi.github.io/advanced/security/oauth2-scopes/).
    * PR [#141](https://github.com/khulnasoft/readyapi/pull/141).

## 0.12.1

* Fix bug: handling additional `responses` in `APIRouter.include_router()`. PR [#140](https://github.com/khulnasoft/readyapi/pull/140).

* Fix typo in SQL tutorial. PR [#138](https://github.com/khulnasoft/readyapi/pull/138) by [@mostaphaRoudsari](https://github.com/mostaphaRoudsari).

* Fix typos in section about nested models and OAuth2 with JWT. PR [#127](https://github.com/khulnasoft/readyapi/pull/127) by [@mmcloud](https://github.com/mmcloud).
...
* Add additional `responses` parameter to *path operation decorators* to extend responses in OpenAPI (and API docs).
    ...
    * The new documentation is here: [Additional Responses](https://readyapi.github.io/advanced/additional-responses/).
    * `responses` can also be added to `.include_router()`, the updated docs are here: [Bigger Applications](https://readyapi.github.io/tutorial/bigger-applications/#add-some-custom-tags-and-responses).
    * PR [#97](https://github.com/khulnasoft/readyapi/pull/97) originally initiated by [@barsi](https://github.com/barsi).
* Update `scripts/test-cov-html.sh` to allow passing extra parameters like `-vv`, for development.

## 0.11.0

* Add `auto_error` parameter to security utility functions. Allowing them to be optional. Also allowing to have multiple alternative security schemes that are then checked in a single dependency instead of each one verifying and returning the error to the client automatically when not satisfied. PR [#134](https://github.com/khulnasoft/readyapi/pull/134).

* Update [SQL Tutorial](https://readyapi.github.io/tutorial/sql-databases/#create-a-middleware-to-handle-sessions) to close database sessions even when there are exceptions. PR [#89](https://github.com/khulnasoft/readyapi/pull/89) by [@alexiri](https://github.com/alexiri).

* Fix duplicate dependency in `pyproject.toml`. PR [#128](https://github.com/khulnasoft/readyapi/pull/128) by [@zxalif](https://github.com/zxalif).

## 0.10.3

* Add Gitter chat, badge, links, etc. [https://gitter.im/khulnasoft/readyapi](https://gitter.im/khulnasoft/readyapi) . PR [#117](https://github.com/khulnasoft/readyapi/pull/117).

* Add docs about [Extending OpenAPI](https://readyapi.github.io/advanced/extending-openapi/). PR [#126](https://github.com/khulnasoft/readyapi/pull/126).

* Make Travis run Ubuntu Xenial (newer version) and Python 3.7 instead of Python 3.7-dev. PR [#92](https://github.com/khulnasoft/readyapi/pull/92) by [@blueyed](https://github.com/blueyed).

* Fix duplicated param variable creation. PR [#123](https://github.com/khulnasoft/readyapi/pull/123) by [@yihuang](https://github.com/yihuang).

* Add note in [Response Model docs](https://readyapi.github.io/tutorial/response-model/) about why using a function parameter instead of a function return type annotation. PR [#109](https://github.com/khulnasoft/readyapi/pull/109) by [@JHSaunders](https://github.com/JHSaunders).

* Fix event docs (startup/shutdown) function name. PR [#105](https://github.com/khulnasoft/readyapi/pull/105) by [@stratosgear](https://github.com/stratosgear).

## 0.10.2

* Fix OpenAPI (JSON Schema) for declarations of Python `Union` (JSON Schema `additionalProperties`). PR [#121](https://github.com/khulnasoft/readyapi/pull/121).

* Update [Background Tasks](https://readyapi.github.io/tutorial/background-tasks/) with a note on Celery.

* Document response models using unions and lists, updated at: [Extra Models](https://readyapi.github.io/tutorial/extra-models/). PR [#108](https://github.com/khulnasoft/readyapi/pull/108).

## 0.10.1

* Add docs and tests for [encode/databases](https://github.com/encode/databases). New docs at: [Async SQL (Relational) Databases](https://readyapi.github.io/advanced/async-sql-databases/). PR [#107](https://github.com/khulnasoft/readyapi/pull/107).

## 0.10.0

* Add support for Background Tasks in *path operation functions* and dependencies. New documentation about [Background Tasks is here](https://readyapi.github.io/tutorial/background-tasks/). PR [#103](https://github.com/khulnasoft/readyapi/pull/103).

* Add support for `.websocket_route()` in `APIRouter`. PR [#100](https://github.com/khulnasoft/readyapi/pull/100) by [@euri10](https://github.com/euri10).

* New docs section about [Events: startup - shutdown](https://readyapi.github.io/advanced/events/). PR [#99](https://github.com/khulnasoft/readyapi/pull/99).

## 0.9.1

* Document receiving [Multiple values with the same query parameter](https://readyapi.github.io/tutorial/query-params-str-validations/#query-parameter-list-multiple-values) and [Duplicate headers](https://readyapi.github.io/tutorial/header-params/#duplicate-headers). PR [#95](https://github.com/khulnasoft/readyapi/pull/95).

## 0.9.0

* Upgrade compatible Pydantic version to `0.21.0`. PR [#90](https://github.com/khulnasoft/readyapi/pull/90).

* Add documentation for: [Application Configuration](https://readyapi.github.io/tutorial/application-configuration/).

* Fix typo in docs. PR [#76](https://github.com/khulnasoft/readyapi/pull/76) by [@matthewhegarty](https://github.com/matthewhegarty).

* Fix link in "Deployment" to "Bigger Applications".

## 0.8.0

* Make development scripts executable. PR [#76](https://github.com/khulnasoft/readyapi/pull/76) by [@euri10](https://github.com/euri10).

* Add support for adding `tags` in `app.include_router()`. PR [#55](https://github.com/khulnasoft/readyapi/pull/55) by [@euri10](https://github.com/euri10). Documentation updated in the section: [Bigger Applications](https://readyapi.github.io/tutorial/bigger-applications/).

* Update docs related to Uvicorn to use new `--reload` option from version `0.5.x`. PR [#74](https://github.com/khulnasoft/readyapi/pull/74).

* Update `isort` imports and scripts to be compatible with newer versions. PR [#75](https://github.com/khulnasoft/readyapi/pull/75).

## 0.7.1

* Update [technical details about `async def` handling](https://readyapi.github.io/async/#path-operation-functions) with respect to previous frameworks. PR [#64](https://github.com/khulnasoft/readyapi/pull/64) by [@haizaar](https://github.com/haizaar).

* Add [deployment documentation for Docker in Raspberry Pi](https://readyapi.github.io/deployment/#raspberry-pi-and-other-architectures) and other architectures.

* Trigger Docker images build on Travis CI automatically. PR [#65](https://github.com/khulnasoft/readyapi/pull/65).

## 0.7.0

* Add support for `UploadFile` in `File` parameter annotations.
    * This includes a file-like interface.
    * Here's the updated documentation for declaring [`File` parameters with `UploadFile`](https://readyapi.github.io/tutorial/request-files/#file-parameters-with-uploadfile).
    * And here's the updated documentation for using [`Form` parameters mixed with `File` parameters, supporting `bytes` and `UploadFile`](https://readyapi.github.io/tutorial/request-forms-and-files/) at the same time.
    * PR [#63](https://github.com/khulnasoft/readyapi/pull/63).

## 0.6.4

* Add [technical details about `async def` handling to docs](https://readyapi.github.io/async/#very-technical-details). PR [#61](https://github.com/khulnasoft/readyapi/pull/61).

* Add docs for [Debugging ReadyAPI applications in editors](https://readyapi.github.io/tutorial/debugging/).

* Clarify [Bigger Applications deployed with Docker](https://readyapi.github.io/deployment/#bigger-applications).

* Fix typos in docs.

* Add section about [History, Design and Future](https://readyapi.github.io/history-design-future/).

* Add docs for using [WebSockets with **ReadyAPI**](https://readyapi.github.io/advanced/websockets/). PR [#62](https://github.com/khulnasoft/readyapi/pull/62).

## 0.6.3

* Add Favicons to docs. PR [#53](https://github.com/khulnasoft/readyapi/pull/53).
...
* Update [SQL tutorial with SQLAlchemy, using `Depends` to improve editor support and reduce code repetition](https://readyapi.github.io/tutorial/sql-databases/). PR [#52](https://github.com/khulnasoft/readyapi/pull/52).

* Improve middleware naming in tutorial for SQL with SQLAlchemy [https://readyapi.github.io/tutorial/sql-databases/](https://readyapi.github.io/tutorial/sql-databases/).

## 0.6.1

* Add docs for GraphQL: [https://readyapi.github.io/advanced/graphql/](https://readyapi.github.io/advanced/graphql/). PR [#48](https://github.com/khulnasoft/readyapi/pull/48).

## 0.6.0

* Update SQL with SQLAlchemy tutorial at [https://readyapi.github.io/tutorial/sql-databases/](https://readyapi.github.io/tutorial/sql-databases/) using the new official `request.state`. PR [#45](https://github.com/khulnasoft/readyapi/pull/45).

* Upgrade Starlette to version `0.11.1` and add required compatibility changes. PR [#44](https://github.com/khulnasoft/readyapi/pull/44).

## 0.5.1

* Add section about [helping and getting help with **ReadyAPI**](https://readyapi.github.io/help-readyapi/).

* Add note about [path operations order in docs](https://readyapi.github.io/tutorial/path-params/#order-matters).

* Update [section about error handling](https://readyapi.github.io/tutorial/handling-errors/) with more information and make relation with Starlette error handling utilities more explicit. PR [#41](https://github.com/khulnasoft/readyapi/pull/41).

* Add <a href="" target="_blank">Development - Contributing section to the docs</a>. PR [#42](https://github.com/khulnasoft/readyapi/pull/42).

## 0.5.0

* Add new `HTTPException` with support for custom headers. With new documentation for handling errors at: [https://readyapi.github.io/tutorial/handling-errors/](https://readyapi.github.io/tutorial/handling-errors/). PR [#35](https://github.com/khulnasoft/readyapi/pull/35).

* Add [documentation to use Starlette `Request` object](https://readyapi.github.io/advanced/using-request-directly/) directly. Check [#25](https://github.com/khulnasoft/readyapi/pull/25) by [@euri10](https://github.com/euri10).

* Add issue templates to simplify reporting bugs, getting help, etc: [#34](https://github.com/khulnasoft/readyapi/pull/34).

* Update example for the SQLAlchemy tutorial at [https://readyapi.github.io/tutorial/sql-databases/](https://readyapi.github.io/tutorial/sql-databases/) using middleware and database session attached to request.

## 0.4.0

* Add `openapi_prefix`, support for reverse proxy and mounting sub-applications. See the docs at [https://readyapi.github.io/advanced/sub-applications-proxy/](https://readyapi.github.io/advanced/sub-applications-proxy/): [#26](https://github.com/khulnasoft/readyapi/pull/26) by [@kabirkhan](https://github.com/kabirkhan).

* Update [docs/tutorial for SQLAlchemy](https://readyapi.github.io/tutorial/sql-databases/) including note about _DB Browser for SQLite_.

## 0.3.0

* Fix/add SQLAlchemy support, including ORM, and update [docs for SQLAlchemy](https://readyapi.github.io/tutorial/sql-databases/): [#30](https://github.com/khulnasoft/readyapi/pull/30).

## 0.2.1

* Fix `jsonable_encoder` for Pydantic models with `Config` but without `json_encoders`: [#29](https://github.com/khulnasoft/readyapi/pull/29).

## 0.2.0

* Fix typos in Security section: [#24](https://github.com/khulnasoft/readyapi/pull/24) by [@kkinder](https://github.com/kkinder).

* Add support for Pydantic custom JSON encoders: [#21](https://github.com/khulnasoft/readyapi/pull/21) by [@euri10](https://github.com/euri10).

## 0.1.19

* Upgrade Starlette version to the current latest `0.10.1`: [#17](https://github.com/khulnasoft/readyapi/pull/17) by [@euri10](https://github.com/euri10).
